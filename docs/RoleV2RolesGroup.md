...
|------------ | ------------- | ------------- | -------------|
|**applications** | **Map&lt;String, RoleV2ApplicationDetails&gt;** | A map of the link between the Application, campaign, or draft campaign-related permission set and the Application ID the permissions apply to. |  [optional] |
