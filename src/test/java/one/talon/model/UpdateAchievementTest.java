...
/**
 * Model tests for UpdateAchievement
 */
public class UpdateAchievementTest {
    private final UpdateAchievement model = new UpdateAchievement();
