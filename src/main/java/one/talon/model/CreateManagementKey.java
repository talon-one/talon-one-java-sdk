...
public class CreateManagementKey {
   ...
   * @return the CreateManagementKey instance itself
   */
  public CreateManagementKey putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createManagementKey.name) &&
        ...
        Objects.equals(this.additionalProperties, createManagementKey.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, expiryDate, endpoints, allowedApplicationIds, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateManagementKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateManagementKey is not found in the empty JSON string", CreateManagementKey.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateManagementKey>() {
           ...
           public CreateManagementKey read(JsonReader in) throws IOException {
             ...
             CreateManagementKey instance = thisAdapter.fromJsonTree(jsonObj);
