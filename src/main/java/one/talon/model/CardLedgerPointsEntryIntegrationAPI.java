...
public class CardLedgerPointsEntryIntegrationAPI {
  ...
  public CardLedgerPointsEntryIntegrationAPI id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public CardLedgerPointsEntryIntegrationAPI transactionUUID(@javax.annotation.Nonnull String transactionUUID) {
  ...
  public CardLedgerPointsEntryIntegrationAPI created(@javax.annotation.Nonnull OffsetDateTime created) {
  ...
  public CardLedgerPointsEntryIntegrationAPI programId(@javax.annotation.Nonnull Long programId) {
  ...
  public CardLedgerPointsEntryIntegrationAPI customerProfileID(@javax.annotation.Nullable String customerProfileID) {
  ...
  public CardLedgerPointsEntryIntegrationAPI customerSessionId(@javax.annotation.Nullable String customerSessionId) {
  ...
  public CardLedgerPointsEntryIntegrationAPI name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CardLedgerPointsEntryIntegrationAPI startDate(@javax.annotation.Nonnull String startDate) {
  ...
  public CardLedgerPointsEntryIntegrationAPI expiryDate(@javax.annotation.Nonnull String expiryDate) {
  ...
  public CardLedgerPointsEntryIntegrationAPI subledgerId(@javax.annotation.Nonnull String subledgerId) {
  ...
  public CardLedgerPointsEntryIntegrationAPI amount(@javax.annotation.Nonnull BigDecimal amount) {
    this.amount = amount;
    return this;
  }
   ...
   * @return the CardLedgerPointsEntryIntegrationAPI instance itself
   */
  public CardLedgerPointsEntryIntegrationAPI putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, cardLedgerPointsEntryIntegrationAPI.id) &&
        ...
        Objects.equals(this.additionalProperties, cardLedgerPointsEntryIntegrationAPI.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, transactionUUID, created, programId, customerProfileID, customerSessionId, name, startDate, expiryDate, subledgerId, amount, validityDuration, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CardLedgerPointsEntryIntegrationAPI
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CardLedgerPointsEntryIntegrationAPI.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CardLedgerPointsEntryIntegrationAPI is not found in the empty JSON string", CardLedgerPointsEntryIntegrationAPI.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CardLedgerPointsEntryIntegrationAPI.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CardLedgerPointsEntryIntegrationAPI.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CardLedgerPointsEntryIntegrationAPI' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CardLedgerPointsEntryIntegrationAPI> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CardLedgerPointsEntryIntegrationAPI.class));

       return (TypeAdapter<T>) new TypeAdapter<CardLedgerPointsEntryIntegrationAPI>() {
           @Override
           public void write(JsonWriter out, CardLedgerPointsEntryIntegrationAPI value) throws IOException {
           ...
           @Override
           public CardLedgerPointsEntryIntegrationAPI read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CardLedgerPointsEntryIntegrationAPI instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CardLedgerPointsEntryIntegrationAPI given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CardLedgerPointsEntryIntegrationAPI
   * @throws IOException if the JSON string is invalid with respect to CardLedgerPointsEntryIntegrationAPI
   */
  public static CardLedgerPointsEntryIntegrationAPI fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CardLedgerPointsEntryIntegrationAPI.class);
  }

  /**
   * Convert an instance of CardLedgerPointsEntryIntegrationAPI to an JSON string
   *
   * @return JSON string
   */
