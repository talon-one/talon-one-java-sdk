...
public class BaseCampaign {
   ...
   * @return the BaseCampaign instance itself
   */
  public BaseCampaign putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, baseCampaign.name) &&
        ...
        Objects.equals(this.additionalProperties, baseCampaign.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, startTime, endTime, attributes, state, activeRulesetId, tags, reevaluateOnReturn, features, couponSettings, referralSettings, limits, campaignGroups, type, linkedStoreIds, couponAttributes, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BaseCampaign>() {
           ...
           public BaseCampaign read(JsonReader in) throws IOException {
             ...
             BaseCampaign instance = thisAdapter.fromJsonTree(jsonObj);
