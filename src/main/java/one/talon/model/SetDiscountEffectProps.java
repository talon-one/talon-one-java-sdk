...
public class SetDiscountEffectProps {
   ...
   * @return the SetDiscountEffectProps instance itself
   */
  public SetDiscountEffectProps putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, setDiscountEffectProps.name) &&
        ...
        Objects.equals(this.additionalProperties, setDiscountEffectProps.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, value, scope, desiredValue, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "value", "scope", "desiredValue"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetDiscountEffectProps.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SetDiscountEffectProps is not found in the empty JSON string", SetDiscountEffectProps.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SetDiscountEffectProps>() {
           ...
           public SetDiscountEffectProps read(JsonReader in) throws IOException {
             ...
             SetDiscountEffectProps instance = thisAdapter.fromJsonTree(jsonObj);
