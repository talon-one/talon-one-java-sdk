...
public class EffectReserveCoupon {
  ...
  @javax.annotation.Nonnull
  private ReserveCouponEffectProps props;

  public EffectReserveCoupon() {
  }

  public EffectReserveCoupon experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectReserveCoupon campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectReserveCoupon rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectReserveCoupon ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectReserveCoupon ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectReserveCoupon effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectReserveCoupon triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectReserveCoupon triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectReserveCoupon conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectReserveCoupon evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectReserveCoupon evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectReserveCoupon campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectReserveCoupon campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectReserveCoupon selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectReserveCoupon selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectReserveCoupon adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectReserveCoupon rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectReserveCoupon props(@javax.annotation.Nonnull ReserveCouponEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public ReserveCouponEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull ReserveCouponEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectReserveCoupon instance itself
   */
  public EffectReserveCoupon putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectReserveCoupon effectReserveCoupon = (EffectReserveCoupon) o;
    return Objects.equals(this.experimentId, effectReserveCoupon.experimentId) &&
        Objects.equals(this.campaignId, effectReserveCoupon.campaignId) &&
        Objects.equals(this.rulesetId, effectReserveCoupon.rulesetId) &&
        Objects.equals(this.ruleIndex, effectReserveCoupon.ruleIndex) &&
        Objects.equals(this.ruleName, effectReserveCoupon.ruleName) &&
        Objects.equals(this.effectType, effectReserveCoupon.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectReserveCoupon.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectReserveCoupon.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectReserveCoupon.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectReserveCoupon.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectReserveCoupon.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectReserveCoupon.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectReserveCoupon.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectReserveCoupon.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectReserveCoupon.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectReserveCoupon.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectReserveCoupon.rewardId) &&
        Objects.equals(this.props, effectReserveCoupon.props)&&
        Objects.equals(this.additionalProperties, effectReserveCoupon.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectReserveCoupon {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectReserveCoupon
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectReserveCoupon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectReserveCoupon is not found in the empty JSON string", EffectReserveCoupon.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectReserveCoupon.openapiRequiredFields) {
      ...
      ReserveCouponEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectReserveCoupon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectReserveCoupon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectReserveCoupon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectReserveCoupon.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectReserveCoupon>() {
           @Override
           public void write(JsonWriter out, EffectReserveCoupon value) throws IOException {
           ...
           @Override
           public EffectReserveCoupon read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectReserveCoupon instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectReserveCoupon given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectReserveCoupon
   * @throws IOException if the JSON string is invalid with respect to EffectReserveCoupon
   */
  public static EffectReserveCoupon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectReserveCoupon.class);
  }

  /**
   * Convert an instance of EffectReserveCoupon to an JSON string
   *
   * @return JSON string
   */
