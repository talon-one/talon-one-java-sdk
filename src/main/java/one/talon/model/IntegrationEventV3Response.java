...
public class IntegrationEventV3Response {
  ...
  public IntegrationEventV3Response customerProfile(@javax.annotation.Nullable CustomerProfile customerProfile) {
  ...
  public IntegrationEventV3Response triggeredCampaigns(@javax.annotation.Nullable List<Campaign> triggeredCampaigns) {
    this.triggeredCampaigns = triggeredCampaigns;
    return this;
  }

  public IntegrationEventV3Response addTriggeredCampaignsItem(Campaign triggeredCampaignsItem) {
  ...
  public IntegrationEventV3Response effects(@javax.annotation.Nonnull List<Effect> effects) {
    this.effects = effects;
    return this;
  }

  public IntegrationEventV3Response addEffectsItem(Effect effectsItem) {
  ...
  public IntegrationEventV3Response addCreatedCouponsItem(Coupon createdCouponsItem) {
  ...
  public IntegrationEventV3Response createdReferrals(@javax.annotation.Nonnull List<Referral> createdReferrals) {
    this.createdReferrals = createdReferrals;
    return this;
  }

  public IntegrationEventV3Response addCreatedReferralsItem(Referral createdReferralsItem) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntegrationEventV3Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationEventV3Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IntegrationEventV3Response is not found in the empty JSON string", IntegrationEventV3Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntegrationEventV3Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IntegrationEventV3Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IntegrationEventV3Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntegrationEventV3Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntegrationEventV3Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntegrationEventV3Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntegrationEventV3Response.class));

       return (TypeAdapter<T>) new TypeAdapter<IntegrationEventV3Response>() {
           @Override
           public void write(JsonWriter out, IntegrationEventV3Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IntegrationEventV3Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IntegrationEventV3Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntegrationEventV3Response
   * @throws IOException if the JSON string is invalid with respect to IntegrationEventV3Response
   */
  public static IntegrationEventV3Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntegrationEventV3Response.class);
  }

  /**
   * Convert an instance of IntegrationEventV3Response to an JSON string
   *
   * @return JSON string
   */
