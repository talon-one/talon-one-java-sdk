...
public class IntegrationEventV3Response {
  ...
  public IntegrationEventV3Response campaignEligibility(@javax.annotation.Nullable List<CampaignEligibility> campaignEligibility) {
    this.campaignEligibility = campaignEligibility;
    return this;
  }

  public IntegrationEventV3Response addCampaignEligibilityItem(CampaignEligibility campaignEligibilityItem) {
   ...
   * @return the IntegrationEventV3Response instance itself
   */
  public IntegrationEventV3Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customerProfile, integrationEventV3Response.customerProfile) &&
        ...
        Objects.equals(this.campaignEligibility, integrationEventV3Response.campaignEligibility) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("customerProfile", "loyalty", "triggeredCampaigns", "campaignEligibility", "effects", "ruleFailureReasons", "createdCoupons", "createdReferrals", "awardedGiveaways", "advancedEvent"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationEventV3Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntegrationEventV3Response is not found in the empty JSON string", IntegrationEventV3Response.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IntegrationEventV3Response>() {
           ...
           public IntegrationEventV3Response read(JsonReader in) throws IOException {
             ...
             IntegrationEventV3Response instance = thisAdapter.fromJsonTree(jsonObj);
