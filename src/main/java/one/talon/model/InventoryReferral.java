  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InventoryReferral.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in InventoryReferral is not found in the empty JSON string", InventoryReferral.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InventoryReferral.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `InventoryReferral` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("advocateProfileIntegrationId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `advocateProfileIntegrationId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("advocateProfileIntegrationId").toString()));
      }
      ...
      if (jsonObj.get("referredCustomers") == null) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `referredCustomers` to be an array in the JSON string but got `%s`", jsonObj.get("referredCustomers").toString()));
      }
  }
