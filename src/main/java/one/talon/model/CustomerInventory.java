...
public class CustomerInventory {
   ...
   * @return the CustomerInventory instance itself
   */
  public CustomerInventory putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerInventory>() {
           ...
           public CustomerInventory read(JsonReader in) throws IOException {
             ...
             CustomerInventory instance = thisAdapter.fromJsonTree(jsonObj);
