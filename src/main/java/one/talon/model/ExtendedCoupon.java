...
public class ExtendedCoupon {
   ...
   * @return the ExtendedCoupon instance itself
   */
  public ExtendedCoupon putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, extendedCoupon.id) &&
        ...
        Objects.equals(this.additionalProperties, extendedCoupon.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, created, campaignId, value, usageLimit, discountLimit, reservationLimit, startDate, expiryDate, limits, usageCounter, discountCounter, discountRemainder, reservationCounter, attributes, referralId, recipientIntegrationId, importId, reservation, batchId, isReservationMandatory, implicitlyReserved, applicationId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ExtendedCoupon>() {
           ...
           public ExtendedCoupon read(JsonReader in) throws IOException {
             ...
             ExtendedCoupon instance = thisAdapter.fromJsonTree(jsonObj);
