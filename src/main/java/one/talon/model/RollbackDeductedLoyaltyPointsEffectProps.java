...
public class RollbackDeductedLoyaltyPointsEffectProps {
   ...
   * @return the RollbackDeductedLoyaltyPointsEffectProps instance itself
   */
  public RollbackDeductedLoyaltyPointsEffectProps putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.programId, rollbackDeductedLoyaltyPointsEffectProps.programId) &&
        ...
        Objects.equals(this.additionalProperties, rollbackDeductedLoyaltyPointsEffectProps.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(programId, subLedgerId, value, recipientIntegrationId, startDate, expiryDate, transactionUUID, cardIdentifier, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RollbackDeductedLoyaltyPointsEffectProps.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RollbackDeductedLoyaltyPointsEffectProps is not found in the empty JSON string", RollbackDeductedLoyaltyPointsEffectProps.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RollbackDeductedLoyaltyPointsEffectProps>() {
           ...
           public RollbackDeductedLoyaltyPointsEffectProps read(JsonReader in) throws IOException {
             ...
             RollbackDeductedLoyaltyPointsEffectProps instance = thisAdapter.fromJsonTree(jsonObj);
