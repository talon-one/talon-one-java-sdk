...
public class LoyaltyBalanceWithTier {
   ...
   * @return the LoyaltyBalanceWithTier instance itself
   */
  public LoyaltyBalanceWithTier putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activePoints, loyaltyBalanceWithTier.activePoints) &&
        ...
        Objects.equals(this.additionalProperties, loyaltyBalanceWithTier.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(activePoints, pendingPoints, spentPoints, expiredPoints, negativePoints, currentTier, projectedTier, pointsToNextTier, nextTierName, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoyaltyBalanceWithTier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LoyaltyBalanceWithTier is not found in the empty JSON string", LoyaltyBalanceWithTier.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltyBalanceWithTier>() {
           ...
           public LoyaltyBalanceWithTier read(JsonReader in) throws IOException {
             ...
             LoyaltyBalanceWithTier instance = thisAdapter.fromJsonTree(jsonObj);
