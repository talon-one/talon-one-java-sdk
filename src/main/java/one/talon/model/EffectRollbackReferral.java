...
public class EffectRollbackReferral {
  ...
  @javax.annotation.Nonnull
  private RollbackReferralEffectProps props;

  public EffectRollbackReferral() {
  }

  public EffectRollbackReferral experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectRollbackReferral campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectRollbackReferral rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectRollbackReferral ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectRollbackReferral ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectRollbackReferral effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectRollbackReferral triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectRollbackReferral triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectRollbackReferral conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectRollbackReferral evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectRollbackReferral evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectRollbackReferral campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectRollbackReferral campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectRollbackReferral selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectRollbackReferral selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectRollbackReferral adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectRollbackReferral rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectRollbackReferral props(@javax.annotation.Nonnull RollbackReferralEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RollbackReferralEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull RollbackReferralEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectRollbackReferral instance itself
   */
  public EffectRollbackReferral putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectRollbackReferral effectRollbackReferral = (EffectRollbackReferral) o;
    return Objects.equals(this.experimentId, effectRollbackReferral.experimentId) &&
        Objects.equals(this.campaignId, effectRollbackReferral.campaignId) &&
        Objects.equals(this.rulesetId, effectRollbackReferral.rulesetId) &&
        Objects.equals(this.ruleIndex, effectRollbackReferral.ruleIndex) &&
        Objects.equals(this.ruleName, effectRollbackReferral.ruleName) &&
        Objects.equals(this.effectType, effectRollbackReferral.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectRollbackReferral.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectRollbackReferral.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectRollbackReferral.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectRollbackReferral.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectRollbackReferral.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectRollbackReferral.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectRollbackReferral.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectRollbackReferral.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectRollbackReferral.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectRollbackReferral.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectRollbackReferral.rewardId) &&
        Objects.equals(this.props, effectRollbackReferral.props)&&
        Objects.equals(this.additionalProperties, effectRollbackReferral.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectRollbackReferral {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectRollbackReferral
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectRollbackReferral.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectRollbackReferral is not found in the empty JSON string", EffectRollbackReferral.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectRollbackReferral.openapiRequiredFields) {
      ...
      RollbackReferralEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectRollbackReferral.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectRollbackReferral' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectRollbackReferral> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectRollbackReferral.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectRollbackReferral>() {
           @Override
           public void write(JsonWriter out, EffectRollbackReferral value) throws IOException {
           ...
           @Override
           public EffectRollbackReferral read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectRollbackReferral instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectRollbackReferral given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectRollbackReferral
   * @throws IOException if the JSON string is invalid with respect to EffectRollbackReferral
   */
  public static EffectRollbackReferral fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectRollbackReferral.class);
  }

  /**
   * Convert an instance of EffectRollbackReferral to an JSON string
   *
   * @return JSON string
   */
