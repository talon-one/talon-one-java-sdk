...
import one.talon.model.JoinLoyaltyProgramEffectProps;
...
public class EffectJoinLoyaltyProgram {
  ...
  @javax.annotation.Nonnull
  private JoinLoyaltyProgramEffectProps props;

  public EffectJoinLoyaltyProgram() {
  }

  public EffectJoinLoyaltyProgram experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectJoinLoyaltyProgram campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectJoinLoyaltyProgram rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectJoinLoyaltyProgram ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectJoinLoyaltyProgram ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectJoinLoyaltyProgram effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectJoinLoyaltyProgram triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectJoinLoyaltyProgram triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectJoinLoyaltyProgram conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectJoinLoyaltyProgram evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectJoinLoyaltyProgram evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectJoinLoyaltyProgram campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectJoinLoyaltyProgram campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectJoinLoyaltyProgram selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectJoinLoyaltyProgram selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectJoinLoyaltyProgram adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectJoinLoyaltyProgram rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectJoinLoyaltyProgram props(@javax.annotation.Nonnull JoinLoyaltyProgramEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public JoinLoyaltyProgramEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull JoinLoyaltyProgramEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectJoinLoyaltyProgram instance itself
   */
  public EffectJoinLoyaltyProgram putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectJoinLoyaltyProgram effectJoinLoyaltyProgram = (EffectJoinLoyaltyProgram) o;
    return Objects.equals(this.experimentId, effectJoinLoyaltyProgram.experimentId) &&
        Objects.equals(this.campaignId, effectJoinLoyaltyProgram.campaignId) &&
        Objects.equals(this.rulesetId, effectJoinLoyaltyProgram.rulesetId) &&
        Objects.equals(this.ruleIndex, effectJoinLoyaltyProgram.ruleIndex) &&
        Objects.equals(this.ruleName, effectJoinLoyaltyProgram.ruleName) &&
        Objects.equals(this.effectType, effectJoinLoyaltyProgram.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectJoinLoyaltyProgram.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectJoinLoyaltyProgram.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectJoinLoyaltyProgram.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectJoinLoyaltyProgram.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectJoinLoyaltyProgram.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectJoinLoyaltyProgram.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectJoinLoyaltyProgram.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectJoinLoyaltyProgram.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectJoinLoyaltyProgram.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectJoinLoyaltyProgram.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectJoinLoyaltyProgram.rewardId) &&
        Objects.equals(this.props, effectJoinLoyaltyProgram.props)&&
        Objects.equals(this.additionalProperties, effectJoinLoyaltyProgram.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectJoinLoyaltyProgram {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectJoinLoyaltyProgram
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectJoinLoyaltyProgram.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectJoinLoyaltyProgram is not found in the empty JSON string", EffectJoinLoyaltyProgram.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectJoinLoyaltyProgram.openapiRequiredFields) {
      ...
      JoinLoyaltyProgramEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectJoinLoyaltyProgram.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectJoinLoyaltyProgram' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectJoinLoyaltyProgram> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectJoinLoyaltyProgram.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectJoinLoyaltyProgram>() {
           @Override
           public void write(JsonWriter out, EffectJoinLoyaltyProgram value) throws IOException {
           ...
           @Override
           public EffectJoinLoyaltyProgram read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectJoinLoyaltyProgram instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectJoinLoyaltyProgram given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectJoinLoyaltyProgram
   * @throws IOException if the JSON string is invalid with respect to EffectJoinLoyaltyProgram
   */
  public static EffectJoinLoyaltyProgram fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectJoinLoyaltyProgram.class);
  }

  /**
   * Convert an instance of EffectJoinLoyaltyProgram to an JSON string
   *
   * @return JSON string
   */
