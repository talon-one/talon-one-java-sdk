...
public class IntegrationHubFlowConfig {
   ...
   * @return the IntegrationHubFlowConfig instance itself
   */
  public IntegrationHubFlowConfig putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IntegrationHubFlowConfig>() {
           ...
           public IntegrationHubFlowConfig read(JsonReader in) throws IOException {
             ...
             IntegrationHubFlowConfig instance = thisAdapter.fromJsonTree(jsonObj);
