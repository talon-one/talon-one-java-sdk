...
public class LoyaltyProgramBalance {
   ...
   * @return the LoyaltyProgramBalance instance itself
   */
  public LoyaltyProgramBalance putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentBalance, loyaltyProgramBalance.currentBalance) &&
        ...
        Objects.equals(this.additionalProperties, loyaltyProgramBalance.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currentBalance, pendingBalance, negativeBalance, expiredBalance, spentBalance, tentativeCurrentBalance, tentativePendingBalance, tentativeNegativeBalance, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoyaltyProgramBalance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LoyaltyProgramBalance is not found in the empty JSON string", LoyaltyProgramBalance.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltyProgramBalance>() {
           ...
           public LoyaltyProgramBalance read(JsonReader in) throws IOException {
             ...
             LoyaltyProgramBalance instance = thisAdapter.fromJsonTree(jsonObj);
