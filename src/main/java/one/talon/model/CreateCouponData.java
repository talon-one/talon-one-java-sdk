...
public class CreateCouponData {
  ...
  public CreateCouponData() {
  }

  public CreateCouponData data(@javax.annotation.Nullable List<ExtendedCoupon> data) {
    this.data = data;
    return this;
  }
  ...
  public CreateCouponData totalResultSize(@javax.annotation.Nullable Long totalResultSize) {
  ...
  public CreateCouponData batchID(@javax.annotation.Nullable String batchID) {
  ...
  public CreateCouponData typeOfChange(@javax.annotation.Nonnull String typeOfChange) {
  ...
  public CreateCouponData operation(@javax.annotation.Nonnull String operation) {
  ...
  public CreateCouponData employeeName(@javax.annotation.Nonnull String employeeName) {
  ...
  public CreateCouponData notificationType(@javax.annotation.Nonnull NotificationTypeEnum notificationType) {
   ...
   * @return the CreateCouponData instance itself
   */
  public CreateCouponData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createCouponData.data) &&
        ...
        Objects.equals(this.additionalProperties, createCouponData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, totalResultSize, batchID, typeOfChange, operation, employeeName, notificationType, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("data", "totalResultSize", "BatchID", "TypeOfChange", "Operation", "EmployeeName", "NotificationType"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCouponData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCouponData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateCouponData is not found in the empty JSON string", CreateCouponData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCouponData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCouponData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCouponData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCouponData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCouponData.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCouponData>() {
           @Override
           public void write(JsonWriter out, CreateCouponData value) throws IOException {
           ...
           @Override
           public CreateCouponData read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateCouponData instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CreateCouponData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCouponData
   * @throws IOException if the JSON string is invalid with respect to CreateCouponData
   */
  public static CreateCouponData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCouponData.class);
  }

  /**
   * Convert an instance of CreateCouponData to an JSON string
   *
   * @return JSON string
   */
