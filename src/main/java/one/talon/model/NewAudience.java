...
public class NewAudience {
  ...
  public NewAudience subscribedApplicationsIds(@javax.annotation.Nullable Set<Long> subscribedApplicationsIds) {
    this.subscribedApplicationsIds = subscribedApplicationsIds;
    return this;
  }

  public NewAudience addSubscribedApplicationsIdsItem(Long subscribedApplicationsIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, newAudience.name) &&
        ...
        Objects.equals(this.subscribedApplicationsIds, newAudience.subscribedApplicationsIds) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, sandbox, description, subscribedApplicationsIds, integration, integrationId, createdIn3rdParty, lastUpdate, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "sandbox", "description", "subscribedApplicationsIds", "integration", "integrationId", "createdIn3rdParty", "lastUpdate"));
