...
public class LedgerTransactionLogEntryIntegrationAPI {
   ...
   * @return the LedgerTransactionLogEntryIntegrationAPI instance itself
   */
  public LedgerTransactionLogEntryIntegrationAPI putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transactionUUID, ledgerTransactionLogEntryIntegrationAPI.transactionUUID) &&
        ...
        Objects.equals(this.additionalProperties, ledgerTransactionLogEntryIntegrationAPI.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LedgerTransactionLogEntryIntegrationAPI.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LedgerTransactionLogEntryIntegrationAPI is not found in the empty JSON string", LedgerTransactionLogEntryIntegrationAPI.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LedgerTransactionLogEntryIntegrationAPI>() {
           ...
           public LedgerTransactionLogEntryIntegrationAPI read(JsonReader in) throws IOException {
             ...
             LedgerTransactionLogEntryIntegrationAPI instance = thisAdapter.fromJsonTree(jsonObj);
