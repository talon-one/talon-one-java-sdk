...
public class EffectAddToAudience {
  ...
  @javax.annotation.Nonnull
  private AddToAudienceEffectProps props;

  public EffectAddToAudience() {
  }

  public EffectAddToAudience experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectAddToAudience campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectAddToAudience rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectAddToAudience ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectAddToAudience ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectAddToAudience effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectAddToAudience triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectAddToAudience triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectAddToAudience conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectAddToAudience evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectAddToAudience evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectAddToAudience campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectAddToAudience campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectAddToAudience selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectAddToAudience selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectAddToAudience adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectAddToAudience rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectAddToAudience props(@javax.annotation.Nonnull AddToAudienceEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AddToAudienceEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull AddToAudienceEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectAddToAudience instance itself
   */
  public EffectAddToAudience putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectAddToAudience effectAddToAudience = (EffectAddToAudience) o;
    return Objects.equals(this.experimentId, effectAddToAudience.experimentId) &&
        Objects.equals(this.campaignId, effectAddToAudience.campaignId) &&
        Objects.equals(this.rulesetId, effectAddToAudience.rulesetId) &&
        Objects.equals(this.ruleIndex, effectAddToAudience.ruleIndex) &&
        Objects.equals(this.ruleName, effectAddToAudience.ruleName) &&
        Objects.equals(this.effectType, effectAddToAudience.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectAddToAudience.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectAddToAudience.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectAddToAudience.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectAddToAudience.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectAddToAudience.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectAddToAudience.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectAddToAudience.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectAddToAudience.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectAddToAudience.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectAddToAudience.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectAddToAudience.rewardId) &&
        Objects.equals(this.props, effectAddToAudience.props)&&
        Objects.equals(this.additionalProperties, effectAddToAudience.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectAddToAudience {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectAddToAudience
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectAddToAudience.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectAddToAudience is not found in the empty JSON string", EffectAddToAudience.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectAddToAudience.openapiRequiredFields) {
      ...
      AddToAudienceEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectAddToAudience.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectAddToAudience' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectAddToAudience> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectAddToAudience.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectAddToAudience>() {
           @Override
           public void write(JsonWriter out, EffectAddToAudience value) throws IOException {
           ...
           @Override
           public EffectAddToAudience read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectAddToAudience instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectAddToAudience given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectAddToAudience
   * @throws IOException if the JSON string is invalid with respect to EffectAddToAudience
   */
  public static EffectAddToAudience fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectAddToAudience.class);
  }

  /**
   * Convert an instance of EffectAddToAudience to an JSON string
   *
   * @return JSON string
   */
