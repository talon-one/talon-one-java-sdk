...
public class CardLedgerTransactionLogEntryIntegrationAPI {
   ...
   * @return the CardLedgerTransactionLogEntryIntegrationAPI instance itself
   */
  public CardLedgerTransactionLogEntryIntegrationAPI putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transactionUUID, cardLedgerTransactionLogEntryIntegrationAPI.transactionUUID) &&
        ...
        Objects.equals(this.additionalProperties, cardLedgerTransactionLogEntryIntegrationAPI.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transactionUUID, created, programId, cardIdentifier, customerSessionId, type, name, startDate, expiryDate, subledgerId, amount, id, rulesetId, ruleName, validityDuration, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CardLedgerTransactionLogEntryIntegrationAPI.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CardLedgerTransactionLogEntryIntegrationAPI is not found in the empty JSON string", CardLedgerTransactionLogEntryIntegrationAPI.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CardLedgerTransactionLogEntryIntegrationAPI>() {
           ...
           public CardLedgerTransactionLogEntryIntegrationAPI read(JsonReader in) throws IOException {
             ...
             CardLedgerTransactionLogEntryIntegrationAPI instance = thisAdapter.fromJsonTree(jsonObj);
