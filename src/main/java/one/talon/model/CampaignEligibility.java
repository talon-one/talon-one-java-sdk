...
public class CampaignEligibility {
  ...
  public CampaignEligibility name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CampaignEligibility description(@javax.annotation.Nullable String description) {
  ...
  public CampaignEligibility startTime(@javax.annotation.Nullable OffsetDateTime startTime) {
  ...
  public CampaignEligibility endTime(@javax.annotation.Nullable OffsetDateTime endTime) {
  ...
  public CampaignEligibility attributes(@javax.annotation.Nullable Object attributes) {
  ...
  public CampaignEligibility state(@javax.annotation.Nonnull StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public CampaignEligibility tags(@javax.annotation.Nonnull List<String> tags) {
    this.tags = tags;
    return this;
  }

  public CampaignEligibility addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public CampaignEligibility features(@javax.annotation.Nonnull List<FeaturesEnum> features) {
    this.features = features;
    return this;
  }

  public CampaignEligibility addFeaturesItem(FeaturesEnum featuresItem) {
   ...
   * @return the CampaignEligibility instance itself
   */
  public CampaignEligibility putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, campaignEligibility.id) &&
        ...
        Objects.equals(this.endTime, campaignEligibility.endTime) &&
        Objects.equals(this.attributes, campaignEligibility.attributes) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to CampaignEligibility
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignEligibility.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CampaignEligibility is not found in the empty JSON string", CampaignEligibility.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CampaignEligibility.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignEligibility.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignEligibility' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignEligibility> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignEligibility.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignEligibility>() {
           @Override
           public void write(JsonWriter out, CampaignEligibility value) throws IOException {
           ...
           @Override
           public CampaignEligibility read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CampaignEligibility instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CampaignEligibility given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CampaignEligibility
   * @throws IOException if the JSON string is invalid with respect to CampaignEligibility
   */
  public static CampaignEligibility fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignEligibility.class);
  }

  /**
   * Convert an instance of CampaignEligibility to an JSON string
   *
   * @return JSON string
   */
