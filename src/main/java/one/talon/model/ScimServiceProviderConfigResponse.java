...
public class ScimServiceProviderConfigResponse {
   ...
   * @return the ScimServiceProviderConfigResponse instance itself
   */
  public ScimServiceProviderConfigResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bulk, scimServiceProviderConfigResponse.bulk) &&
        ...
        Objects.equals(this.additionalProperties, scimServiceProviderConfigResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bulk, changePassword, documentationUri, filter, patch, schemas, sort, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScimServiceProviderConfigResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ScimServiceProviderConfigResponse is not found in the empty JSON string", ScimServiceProviderConfigResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ScimServiceProviderConfigResponse>() {
           ...
           public ScimServiceProviderConfigResponse read(JsonReader in) throws IOException {
             ...
             ScimServiceProviderConfigResponse instance = thisAdapter.fromJsonTree(jsonObj);
