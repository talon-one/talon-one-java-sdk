...
public class NewRevisionVersion {
   ...
   * @return the NewRevisionVersion instance itself
   */
  public NewRevisionVersion putAdditionalProperty(String key, Object value) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, startTime, endTime, attributes, description, activeRulesetId, tags, couponSettings, referralSettings, limits, reevaluateOnReturn, features, couponAttributes, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewRevisionVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NewRevisionVersion is not found in the empty JSON string", NewRevisionVersion.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NewRevisionVersion>() {
           ...
           public NewRevisionVersion read(JsonReader in) throws IOException {
             ...
             NewRevisionVersion instance = thisAdapter.fromJsonTree(jsonObj);
