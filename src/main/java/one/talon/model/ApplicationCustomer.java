...
public class ApplicationCustomer {
  ...
  static {
    ...
    openapiFields.add("closedSessions");
    openapiFields.add("totalSales");
    openapiFields.add("loyaltyMemberships");
    openapiFields.add("audienceMemberships");
    openapiFields.add("lastActivity");
    openapiFields.add("sandbox");
    openapiFields.add("advocateIntegrationId");
    ...
    openapiRequiredFields.add("closedSessions");
    openapiRequiredFields.add("totalSales");
    openapiRequiredFields.add("lastActivity");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationCustomer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicationCustomer is not found in the empty JSON string", ApplicationCustomer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplicationCustomer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationCustomer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("loyaltyMemberships") != null && !jsonObj.get("loyaltyMemberships").isJsonNull()) {
        ...
        if (jsonArrayloyaltyMemberships != null) {
          ...
          if (!jsonObj.get("loyaltyMemberships").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `loyaltyMemberships` to be an array in the JSON string but got `%s`", jsonObj.get("loyaltyMemberships").toString()));
          }
      ...
      if (jsonObj.get("audienceMemberships") != null && !jsonObj.get("audienceMemberships").isJsonNull()) {
        ...
        if (jsonArrayaudienceMemberships != null) {
          ...
          if (!jsonObj.get("audienceMemberships").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `audienceMemberships` to be an array in the JSON string but got `%s`", jsonObj.get("audienceMemberships").toString()));
          }
      ...
      if ((jsonObj.get("advocateIntegrationId") != null && !jsonObj.get("advocateIntegrationId").isJsonNull()) && !jsonObj.get("advocateIntegrationId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `advocateIntegrationId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("advocateIntegrationId").toString()));
      }
  }
