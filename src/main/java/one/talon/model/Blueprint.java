...
public class Blueprint {
   ...
   * @return the Blueprint instance itself
   */
  public Blueprint putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, blueprint.id) &&
        ...
        Objects.equals(this.additionalProperties, blueprint.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, accountId, applicationId, title, description, category, source, rules, cartItemFilters, created, createdBy, modified, modifiedBy, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Blueprint>() {
           ...
           public Blueprint read(JsonReader in) throws IOException {
             ...
             Blueprint instance = thisAdapter.fromJsonTree(jsonObj);
