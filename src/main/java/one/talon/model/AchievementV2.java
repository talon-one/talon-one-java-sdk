...
public class AchievementV2 {
  ...
  @Deprecated
  public AchievementV2 periodEndOverride(@javax.annotation.Nullable TimePoint periodEndOverride) {
   ...
   * @return the AchievementV2 instance itself
   */
  public AchievementV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, achievementV2.id) &&
        ...
        Objects.equals(this.periodEndOverride, achievementV2.periodEndOverride) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AchievementV2>() {
           ...
           public AchievementV2 read(JsonReader in) throws IOException {
             ...
             AchievementV2 instance = thisAdapter.fromJsonTree(jsonObj);
