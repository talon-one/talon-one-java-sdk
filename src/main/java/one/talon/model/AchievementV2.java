...
public class AchievementV2 {
  ...
  public AchievementV2 id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public AchievementV2 created(@javax.annotation.Nonnull OffsetDateTime created) {
  ...
  public AchievementV2 period(@javax.annotation.Nullable String period) {
    this.period = period;
    return this;
  }
  ...
  public AchievementV2 fixedStartDate(@javax.annotation.Nullable OffsetDateTime fixedStartDate) {
  ...
  public AchievementV2 endDate(@javax.annotation.Nullable OffsetDateTime endDate) {
  ...
  public AchievementV2 allowRollbackAfterCompletion(@javax.annotation.Nullable Boolean allowRollbackAfterCompletion) {
  ...
  public AchievementV2 addSubscribedApplicationsItem(Long subscribedApplicationsItem) {
  ...
  public AchievementV2 createdBy(@javax.annotation.Nullable String createdBy) {
  ...
  public AchievementV2 hasProgress(@javax.annotation.Nullable Boolean hasProgress) {
  ...
  public AchievementV2 status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AchievementV2 achievementV2 = (AchievementV2) o;
    return Objects.equals(this.id, achievementV2.id) &&
        Objects.equals(this.created, achievementV2.created) &&
        Objects.equals(this.name, achievementV2.name) &&
        Objects.equals(this.title, achievementV2.title) &&
        Objects.equals(this.description, achievementV2.description) &&
        Objects.equals(this.target, achievementV2.target) &&
        Objects.equals(this.period, achievementV2.period) &&
        Objects.equals(this.recurrencePolicy, achievementV2.recurrencePolicy) &&
        Objects.equals(this.activationPolicy, achievementV2.activationPolicy) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, created, name, title, description, target, period, recurrencePolicy, activationPolicy, fixedStartDate, endDate, allowRollbackAfterCompletion, sandbox, subscribedApplications, timezone, userId, createdBy, hasProgress, status);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AchievementV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AchievementV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AchievementV2 is not found in the empty JSON string", AchievementV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AchievementV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AchievementV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AchievementV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AchievementV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AchievementV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AchievementV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AchievementV2.class));

       return (TypeAdapter<T>) new TypeAdapter<AchievementV2>() {
           @Override
           public void write(JsonWriter out, AchievementV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AchievementV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AchievementV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AchievementV2
   * @throws IOException if the JSON string is invalid with respect to AchievementV2
   */
  public static AchievementV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AchievementV2.class);
  }

  /**
   * Convert an instance of AchievementV2 to an JSON string
   *
   * @return JSON string
   */
