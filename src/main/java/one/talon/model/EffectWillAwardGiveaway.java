...
public class EffectWillAwardGiveaway {
  ...
  @javax.annotation.Nonnull
  private WillAwardGiveawayEffectProps props;

  public EffectWillAwardGiveaway() {
  }

  public EffectWillAwardGiveaway experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectWillAwardGiveaway campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectWillAwardGiveaway rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectWillAwardGiveaway ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectWillAwardGiveaway ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectWillAwardGiveaway effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectWillAwardGiveaway triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectWillAwardGiveaway triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectWillAwardGiveaway conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectWillAwardGiveaway evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectWillAwardGiveaway evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectWillAwardGiveaway campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectWillAwardGiveaway campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectWillAwardGiveaway selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectWillAwardGiveaway selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectWillAwardGiveaway adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectWillAwardGiveaway rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectWillAwardGiveaway props(@javax.annotation.Nonnull WillAwardGiveawayEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public WillAwardGiveawayEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull WillAwardGiveawayEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectWillAwardGiveaway instance itself
   */
  public EffectWillAwardGiveaway putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectWillAwardGiveaway effectWillAwardGiveaway = (EffectWillAwardGiveaway) o;
    return Objects.equals(this.experimentId, effectWillAwardGiveaway.experimentId) &&
        Objects.equals(this.campaignId, effectWillAwardGiveaway.campaignId) &&
        Objects.equals(this.rulesetId, effectWillAwardGiveaway.rulesetId) &&
        Objects.equals(this.ruleIndex, effectWillAwardGiveaway.ruleIndex) &&
        Objects.equals(this.ruleName, effectWillAwardGiveaway.ruleName) &&
        Objects.equals(this.effectType, effectWillAwardGiveaway.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectWillAwardGiveaway.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectWillAwardGiveaway.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectWillAwardGiveaway.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectWillAwardGiveaway.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectWillAwardGiveaway.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectWillAwardGiveaway.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectWillAwardGiveaway.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectWillAwardGiveaway.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectWillAwardGiveaway.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectWillAwardGiveaway.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectWillAwardGiveaway.rewardId) &&
        Objects.equals(this.props, effectWillAwardGiveaway.props)&&
        Objects.equals(this.additionalProperties, effectWillAwardGiveaway.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectWillAwardGiveaway {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectWillAwardGiveaway
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectWillAwardGiveaway.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectWillAwardGiveaway is not found in the empty JSON string", EffectWillAwardGiveaway.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectWillAwardGiveaway.openapiRequiredFields) {
      ...
      WillAwardGiveawayEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectWillAwardGiveaway.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectWillAwardGiveaway' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectWillAwardGiveaway> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectWillAwardGiveaway.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectWillAwardGiveaway>() {
           @Override
           public void write(JsonWriter out, EffectWillAwardGiveaway value) throws IOException {
           ...
           @Override
           public EffectWillAwardGiveaway read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectWillAwardGiveaway instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectWillAwardGiveaway given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectWillAwardGiveaway
   * @throws IOException if the JSON string is invalid with respect to EffectWillAwardGiveaway
   */
  public static EffectWillAwardGiveaway fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectWillAwardGiveaway.class);
  }

  /**
   * Convert an instance of EffectWillAwardGiveaway to an JSON string
   *
   * @return JSON string
   */
