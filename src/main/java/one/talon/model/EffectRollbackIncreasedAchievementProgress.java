...
public class EffectRollbackIncreasedAchievementProgress {
  ...
  @javax.annotation.Nonnull
  private RollbackIncreasedAchievementProgressEffectProps props;

  public EffectRollbackIncreasedAchievementProgress() {
  }

  public EffectRollbackIncreasedAchievementProgress experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectRollbackIncreasedAchievementProgress campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectRollbackIncreasedAchievementProgress rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectRollbackIncreasedAchievementProgress ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectRollbackIncreasedAchievementProgress ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectRollbackIncreasedAchievementProgress effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectRollbackIncreasedAchievementProgress triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectRollbackIncreasedAchievementProgress triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectRollbackIncreasedAchievementProgress conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectRollbackIncreasedAchievementProgress evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectRollbackIncreasedAchievementProgress evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectRollbackIncreasedAchievementProgress campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectRollbackIncreasedAchievementProgress campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectRollbackIncreasedAchievementProgress selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectRollbackIncreasedAchievementProgress selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectRollbackIncreasedAchievementProgress adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectRollbackIncreasedAchievementProgress rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectRollbackIncreasedAchievementProgress props(@javax.annotation.Nonnull RollbackIncreasedAchievementProgressEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RollbackIncreasedAchievementProgressEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull RollbackIncreasedAchievementProgressEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectRollbackIncreasedAchievementProgress instance itself
   */
  public EffectRollbackIncreasedAchievementProgress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectRollbackIncreasedAchievementProgress effectRollbackIncreasedAchievementProgress = (EffectRollbackIncreasedAchievementProgress) o;
    return Objects.equals(this.experimentId, effectRollbackIncreasedAchievementProgress.experimentId) &&
        Objects.equals(this.campaignId, effectRollbackIncreasedAchievementProgress.campaignId) &&
        Objects.equals(this.rulesetId, effectRollbackIncreasedAchievementProgress.rulesetId) &&
        Objects.equals(this.ruleIndex, effectRollbackIncreasedAchievementProgress.ruleIndex) &&
        Objects.equals(this.ruleName, effectRollbackIncreasedAchievementProgress.ruleName) &&
        Objects.equals(this.effectType, effectRollbackIncreasedAchievementProgress.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectRollbackIncreasedAchievementProgress.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectRollbackIncreasedAchievementProgress.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectRollbackIncreasedAchievementProgress.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectRollbackIncreasedAchievementProgress.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectRollbackIncreasedAchievementProgress.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectRollbackIncreasedAchievementProgress.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectRollbackIncreasedAchievementProgress.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectRollbackIncreasedAchievementProgress.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectRollbackIncreasedAchievementProgress.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectRollbackIncreasedAchievementProgress.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectRollbackIncreasedAchievementProgress.rewardId) &&
        Objects.equals(this.props, effectRollbackIncreasedAchievementProgress.props)&&
        Objects.equals(this.additionalProperties, effectRollbackIncreasedAchievementProgress.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectRollbackIncreasedAchievementProgress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectRollbackIncreasedAchievementProgress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectRollbackIncreasedAchievementProgress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectRollbackIncreasedAchievementProgress is not found in the empty JSON string", EffectRollbackIncreasedAchievementProgress.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectRollbackIncreasedAchievementProgress.openapiRequiredFields) {
      ...
      RollbackIncreasedAchievementProgressEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectRollbackIncreasedAchievementProgress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectRollbackIncreasedAchievementProgress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectRollbackIncreasedAchievementProgress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectRollbackIncreasedAchievementProgress.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectRollbackIncreasedAchievementProgress>() {
           @Override
           public void write(JsonWriter out, EffectRollbackIncreasedAchievementProgress value) throws IOException {
           ...
           @Override
           public EffectRollbackIncreasedAchievementProgress read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectRollbackIncreasedAchievementProgress instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectRollbackIncreasedAchievementProgress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectRollbackIncreasedAchievementProgress
   * @throws IOException if the JSON string is invalid with respect to EffectRollbackIncreasedAchievementProgress
   */
  public static EffectRollbackIncreasedAchievementProgress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectRollbackIncreasedAchievementProgress.class);
  }

  /**
   * Convert an instance of EffectRollbackIncreasedAchievementProgress to an JSON string
   *
   * @return JSON string
   */
