...
public class Entity {
  ...
  public Entity id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public Entity created(@javax.annotation.Nonnull OffsetDateTime created) {
   ...
   */
  public Entity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, entity.id) &&
        ...
        Objects.equals(this.additionalProperties, entity.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Entity>() {
           ...
           public Entity read(JsonReader in) throws IOException {
             ...
             Entity instance = thisAdapter.fromJsonTree(jsonObj);
