...
public class Achievement {
  ...
  public Achievement id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public Achievement created(@javax.annotation.Nonnull OffsetDateTime created) {
  ...
  public Achievement name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public Achievement title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public Achievement description(@javax.annotation.Nonnull String description) {
  ...
  public Achievement target(@javax.annotation.Nonnull BigDecimal target) {
    this.target = target;
    return this;
  }
  ...
  public Achievement period(@javax.annotation.Nullable String period) {
    this.period = period;
    return this;
  }
  ...
  public Achievement periodEndOverride(@javax.annotation.Nullable TimePoint periodEndOverride) {
  ...
  public Achievement recurrencePolicy(@javax.annotation.Nullable RecurrencePolicyEnum recurrencePolicy) {
  ...
  public Achievement activationPolicy(@javax.annotation.Nullable ActivationPolicyEnum activationPolicy) {
  ...
  public Achievement fixedStartDate(@javax.annotation.Nullable OffsetDateTime fixedStartDate) {
  ...
  public Achievement endDate(@javax.annotation.Nullable OffsetDateTime endDate) {
  ...
  public Achievement allowRollbackAfterCompletion(@javax.annotation.Nullable Boolean allowRollbackAfterCompletion) {
  ...
  public Achievement campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public Achievement userId(@javax.annotation.Nonnull Long userId) {
    this.userId = userId;
    return this;
  }
  ...
  public Achievement createdBy(@javax.annotation.Nullable String createdBy) {
  ...
  public Achievement hasProgress(@javax.annotation.Nullable Boolean hasProgress) {
  ...
  public Achievement status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created", "name", "title", "description", "target", "period", "periodEndOverride", "recurrencePolicy", "activationPolicy", "fixedStartDate", "endDate", "allowRollbackAfterCompletion", "campaignId", "userId", "createdBy", "hasProgress", "status"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "created", "name", "title", "description", "target", "campaignId", "userId"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Achievement
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Achievement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Achievement is not found in the empty JSON string", Achievement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Achievement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Achievement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Achievement.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Achievement' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Achievement> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Achievement.class));

       return (TypeAdapter<T>) new TypeAdapter<Achievement>() {
           @Override
  ...
  /**
   * Create an instance of Achievement given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Achievement
   * @throws IOException if the JSON string is invalid with respect to Achievement
   */
  public static Achievement fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Achievement.class);
  }

  /**
   * Convert an instance of Achievement to an JSON string
   *
   * @return JSON string
   */
