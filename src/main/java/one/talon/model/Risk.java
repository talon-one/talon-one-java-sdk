...
public class Risk {
  ...
  public Risk id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public Risk created(@javax.annotation.Nonnull OffsetDateTime created) {
  ...
  public Risk notificationId(@javax.annotation.Nonnull Long notificationId) {
  ...
  public Risk groupKey(@javax.annotation.Nonnull String groupKey) {
  ...
  public Risk applicationId(@javax.annotation.Nullable Long applicationId) {
  ...
  public Risk status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public Risk criticality(@javax.annotation.Nonnull CriticalityEnum criticality) {
  ...
  public Risk entity(@javax.annotation.Nonnull EntityEnum entity) {
    this.entity = entity;
    return this;
  }
  ...
  public Risk activity(@javax.annotation.Nonnull ActivityEnum activity) {
  ...
  public Risk timeFrame(@javax.annotation.Nonnull TimeFrameEnum timeFrame) {
  ...
  public Risk reportedDate(@javax.annotation.Nonnull OffsetDateTime reportedDate) {
  ...
  public Risk affectedEntityCount(@javax.annotation.Nonnull Long affectedEntityCount) {
  ...
  public Risk description(@javax.annotation.Nullable String description) {
   ...
   * @return the Risk instance itself
   */
  public Risk putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, risk.id) &&
        ...
        Objects.equals(this.criticality, risk.criticality) &&
        Objects.equals(this.entity, risk.entity) &&
        Objects.equals(this.activity, risk.activity) &&
        Objects.equals(this.timeFrame, risk.timeFrame) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to Risk
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Risk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Risk is not found in the empty JSON string", Risk.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Risk.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Risk.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Risk' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Risk> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Risk.class));

       return (TypeAdapter<T>) new TypeAdapter<Risk>() {
           @Override
           public void write(JsonWriter out, Risk value) throws IOException {
           ...
           @Override
           public Risk read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             Risk instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of Risk given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Risk
   * @throws IOException if the JSON string is invalid with respect to Risk
   */
  public static Risk fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Risk.class);
  }

  /**
   * Convert an instance of Risk to an JSON string
   *
   * @return JSON string
   */
