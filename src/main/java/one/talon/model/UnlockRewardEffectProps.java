...
public class UnlockRewardEffectProps {
  ...
  public UnlockRewardEffectProps integrationId(@javax.annotation.Nonnull String integrationId) {
  ...
  public UnlockRewardEffectProps rewardId(@javax.annotation.Nonnull Long rewardId) {
  ...
  public UnlockRewardEffectProps applicationId(@javax.annotation.Nonnull Long applicationId) {
  ...
  public UnlockRewardEffectProps profileIntegrationId(@javax.annotation.Nonnull String profileIntegrationId) {
  ...
  public UnlockRewardEffectProps unlockedAt(@javax.annotation.Nonnull OffsetDateTime unlockedAt) {
   ...
   * @return the UnlockRewardEffectProps instance itself
   */
  public UnlockRewardEffectProps putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UnlockRewardEffectProps unlockRewardEffectProps = (UnlockRewardEffectProps) o;
    return Objects.equals(this.integrationId, unlockRewardEffectProps.integrationId) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnlockRewardEffectProps
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnlockRewardEffectProps.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UnlockRewardEffectProps is not found in the empty JSON string", UnlockRewardEffectProps.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UnlockRewardEffectProps.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnlockRewardEffectProps.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnlockRewardEffectProps' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnlockRewardEffectProps> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnlockRewardEffectProps.class));

       return (TypeAdapter<T>) new TypeAdapter<UnlockRewardEffectProps>() {
           @Override
           public void write(JsonWriter out, UnlockRewardEffectProps value) throws IOException {
           ...
           @Override
           public UnlockRewardEffectProps read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UnlockRewardEffectProps instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UnlockRewardEffectProps given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnlockRewardEffectProps
   * @throws IOException if the JSON string is invalid with respect to UnlockRewardEffectProps
   */
  public static UnlockRewardEffectProps fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnlockRewardEffectProps.class);
  }

  /**
   * Convert an instance of UnlockRewardEffectProps to an JSON string
   *
   * @return JSON string
   */
