  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BestPriorPriceMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in BestPriorPriceMetadata is not found in the empty JSON string", BestPriorPriceMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BestPriorPriceMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BestPriorPriceMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("influencingCampaignIDs") != null && !jsonObj.get("influencingCampaignIDs").isJsonNull() && !jsonObj.get("influencingCampaignIDs").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `influencingCampaignIDs` to be an array in the JSON string but got `%s`", jsonObj.get("influencingCampaignIDs").toString()));
      }
