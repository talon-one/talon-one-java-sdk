...
public class NewEvent {
   ...
   * @return the NewEvent instance itself
   */
  public NewEvent putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.profileId, newEvent.profileId) &&
        ...
        Objects.equals(this.additionalProperties, newEvent.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(profileId, storeIntegrationId, type, attributes, sessionId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NewEvent>() {
           ...
           public NewEvent read(JsonReader in) throws IOException {
             ...
             NewEvent instance = thisAdapter.fromJsonTree(jsonObj);
