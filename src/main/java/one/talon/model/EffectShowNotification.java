...
public class EffectShowNotification {
  ...
  @javax.annotation.Nonnull
  private ShowNotificationEffectProps props;

  public EffectShowNotification() {
  }

  public EffectShowNotification experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectShowNotification campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectShowNotification rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectShowNotification ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectShowNotification ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectShowNotification effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectShowNotification triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectShowNotification triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectShowNotification conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectShowNotification evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectShowNotification evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectShowNotification campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectShowNotification campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectShowNotification selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectShowNotification selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectShowNotification adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectShowNotification rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectShowNotification props(@javax.annotation.Nonnull ShowNotificationEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public ShowNotificationEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull ShowNotificationEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectShowNotification instance itself
   */
  public EffectShowNotification putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectShowNotification effectShowNotification = (EffectShowNotification) o;
    return Objects.equals(this.experimentId, effectShowNotification.experimentId) &&
        Objects.equals(this.campaignId, effectShowNotification.campaignId) &&
        Objects.equals(this.rulesetId, effectShowNotification.rulesetId) &&
        Objects.equals(this.ruleIndex, effectShowNotification.ruleIndex) &&
        Objects.equals(this.ruleName, effectShowNotification.ruleName) &&
        Objects.equals(this.effectType, effectShowNotification.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectShowNotification.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectShowNotification.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectShowNotification.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectShowNotification.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectShowNotification.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectShowNotification.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectShowNotification.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectShowNotification.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectShowNotification.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectShowNotification.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectShowNotification.rewardId) &&
        Objects.equals(this.props, effectShowNotification.props)&&
        Objects.equals(this.additionalProperties, effectShowNotification.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectShowNotification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectShowNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectShowNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectShowNotification is not found in the empty JSON string", EffectShowNotification.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectShowNotification.openapiRequiredFields) {
      ...
      ShowNotificationEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectShowNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectShowNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectShowNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectShowNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectShowNotification>() {
           @Override
           public void write(JsonWriter out, EffectShowNotification value) throws IOException {
           ...
           @Override
           public EffectShowNotification read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectShowNotification instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectShowNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectShowNotification
   * @throws IOException if the JSON string is invalid with respect to EffectShowNotification
   */
  public static EffectShowNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectShowNotification.class);
  }

  /**
   * Convert an instance of EffectShowNotification to an JSON string
   *
   * @return JSON string
   */
