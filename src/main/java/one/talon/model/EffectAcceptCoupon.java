...
public class EffectAcceptCoupon {
  ...
  @javax.annotation.Nonnull
  private AcceptCouponEffectProps props;

  public EffectAcceptCoupon() {
  }

  public EffectAcceptCoupon experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectAcceptCoupon campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectAcceptCoupon rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectAcceptCoupon ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectAcceptCoupon ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectAcceptCoupon effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectAcceptCoupon triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectAcceptCoupon triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectAcceptCoupon conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectAcceptCoupon evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectAcceptCoupon evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectAcceptCoupon campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectAcceptCoupon campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectAcceptCoupon selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectAcceptCoupon selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectAcceptCoupon adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectAcceptCoupon rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectAcceptCoupon props(@javax.annotation.Nonnull AcceptCouponEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AcceptCouponEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull AcceptCouponEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectAcceptCoupon instance itself
   */
  public EffectAcceptCoupon putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectAcceptCoupon effectAcceptCoupon = (EffectAcceptCoupon) o;
    return Objects.equals(this.experimentId, effectAcceptCoupon.experimentId) &&
        Objects.equals(this.campaignId, effectAcceptCoupon.campaignId) &&
        Objects.equals(this.rulesetId, effectAcceptCoupon.rulesetId) &&
        Objects.equals(this.ruleIndex, effectAcceptCoupon.ruleIndex) &&
        Objects.equals(this.ruleName, effectAcceptCoupon.ruleName) &&
        Objects.equals(this.effectType, effectAcceptCoupon.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectAcceptCoupon.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectAcceptCoupon.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectAcceptCoupon.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectAcceptCoupon.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectAcceptCoupon.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectAcceptCoupon.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectAcceptCoupon.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectAcceptCoupon.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectAcceptCoupon.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectAcceptCoupon.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectAcceptCoupon.rewardId) &&
        Objects.equals(this.props, effectAcceptCoupon.props)&&
        Objects.equals(this.additionalProperties, effectAcceptCoupon.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectAcceptCoupon {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectAcceptCoupon
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectAcceptCoupon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectAcceptCoupon is not found in the empty JSON string", EffectAcceptCoupon.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectAcceptCoupon.openapiRequiredFields) {
      ...
      AcceptCouponEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectAcceptCoupon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectAcceptCoupon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectAcceptCoupon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectAcceptCoupon.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectAcceptCoupon>() {
           @Override
           public void write(JsonWriter out, EffectAcceptCoupon value) throws IOException {
           ...
           @Override
           public EffectAcceptCoupon read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectAcceptCoupon instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectAcceptCoupon given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectAcceptCoupon
   * @throws IOException if the JSON string is invalid with respect to EffectAcceptCoupon
   */
  public static EffectAcceptCoupon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectAcceptCoupon.class);
  }

  /**
   * Convert an instance of EffectAcceptCoupon to an JSON string
   *
   * @return JSON string
   */
