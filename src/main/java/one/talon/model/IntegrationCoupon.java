...
public class IntegrationCoupon {
  ...
  public IntegrationCoupon() {
  }

  public IntegrationCoupon id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public IntegrationCoupon created(@javax.annotation.Nonnull OffsetDateTime created) {
  ...
  public IntegrationCoupon campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public IntegrationCoupon value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public IntegrationCoupon usageLimit(@javax.annotation.Nullable Long usageLimit) {
  ...
  public IntegrationCoupon discountLimit(@javax.annotation.Nullable BigDecimal discountLimit) {
  ...
  public IntegrationCoupon reservationLimit(@javax.annotation.Nullable Long reservationLimit) {
  ...
  public IntegrationCoupon startDate(@javax.annotation.Nullable OffsetDateTime startDate) {
  ...
  public IntegrationCoupon expiryDate(@javax.annotation.Nullable OffsetDateTime expiryDate) {
  ...
  public IntegrationCoupon limits(@javax.annotation.Nullable List<LimitConfig> limits) {
    this.limits = limits;
    return this;
  }
  ...
  public IntegrationCoupon usageCounter(@javax.annotation.Nonnull Long usageCounter) {
  ...
  public IntegrationCoupon discountCounter(@javax.annotation.Nullable BigDecimal discountCounter) {
  ...
  public IntegrationCoupon discountRemainder(@javax.annotation.Nullable BigDecimal discountRemainder) {
  ...
  public IntegrationCoupon reservationCounter(@javax.annotation.Nullable BigDecimal reservationCounter) {
  ...
  public IntegrationCoupon attributes(@javax.annotation.Nullable Object attributes) {
  ...
  public IntegrationCoupon referralId(@javax.annotation.Nullable Long referralId) {
  ...
  public IntegrationCoupon recipientIntegrationId(@javax.annotation.Nullable String recipientIntegrationId) {
  ...
  public IntegrationCoupon importId(@javax.annotation.Nullable Long importId) {
  ...
  public IntegrationCoupon reservation(@javax.annotation.Nullable Boolean reservation) {
  ...
  public IntegrationCoupon batchId(@javax.annotation.Nullable String batchId) {
  ...
  public IntegrationCoupon isReservationMandatory(@javax.annotation.Nullable Boolean isReservationMandatory) {
  ...
  public IntegrationCoupon implicitlyReserved(@javax.annotation.Nullable Boolean implicitlyReserved) {
  ...
  public IntegrationCoupon profileRedemptionCount(@javax.annotation.Nonnull Long profileRedemptionCount) {
  ...
  public void setProfileRedemptionCount(@javax.annotation.Nonnull Long profileRedemptionCount) {
    this.profileRedemptionCount = profileRedemptionCount;
  }
   ...
   * @return the IntegrationCoupon instance itself
   */
  public IntegrationCoupon putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, integrationCoupon.id) &&
        ...
        Objects.equals(this.additionalProperties, integrationCoupon.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, created, campaignId, value, usageLimit, discountLimit, reservationLimit, startDate, expiryDate, limits, usageCounter, discountCounter, discountRemainder, reservationCounter, attributes, referralId, recipientIntegrationId, importId, reservation, batchId, isReservationMandatory, implicitlyReserved, profileRedemptionCount, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "created", "campaignId", "usageCounter", "profileRedemptionCount"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntegrationCoupon
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationCoupon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntegrationCoupon is not found in the empty JSON string", IntegrationCoupon.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IntegrationCoupon.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntegrationCoupon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntegrationCoupon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntegrationCoupon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntegrationCoupon.class));

       return (TypeAdapter<T>) new TypeAdapter<IntegrationCoupon>() {
           @Override
           public void write(JsonWriter out, IntegrationCoupon value) throws IOException {
           ...
           @Override
           public IntegrationCoupon read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             IntegrationCoupon instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of IntegrationCoupon given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntegrationCoupon
   * @throws IOException if the JSON string is invalid with respect to IntegrationCoupon
   */
  public static IntegrationCoupon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntegrationCoupon.class);
  }

  /**
   * Convert an instance of IntegrationCoupon to an JSON string
   *
   * @return JSON string
   */
