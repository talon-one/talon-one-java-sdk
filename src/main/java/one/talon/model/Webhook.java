...
public class Webhook {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, created, modified, applicationIds, title, description, draft, verb, url, headers, payload, params, enabled, authenticationId, additionalProperties);
  }
