...
public class IntegrationHubFlowResponse {
  ...
  public static final String SERIALIZED_NAME_DISABLED_UNTIL = "disabledUntil";
  @SerializedName(SERIALIZED_NAME_DISABLED_UNTIL)
  @javax.annotation.Nullable
  ...
  @javax.annotation.Nonnull
  private IntegrationHubFlowConfigResponse config;

  public IntegrationHubFlowResponse() {
  }

  public IntegrationHubFlowResponse id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public IntegrationHubFlowResponse integrationName(@javax.annotation.Nullable String integrationName) {
  ...
  public IntegrationHubFlowResponse instanceName(@javax.annotation.Nullable String instanceName) {
  ...
  public IntegrationHubFlowResponse createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public IntegrationHubFlowResponse disabledUntil(@javax.annotation.Nullable OffsetDateTime disabledUntil) {
  ...
  public IntegrationHubFlowResponse applicationId(@javax.annotation.Nullable Long applicationId) {
  ...
  public IntegrationHubFlowResponse loyaltyProgramId(@javax.annotation.Nullable Long loyaltyProgramId) {
  ...
  public IntegrationHubFlowResponse eventType(@javax.annotation.Nonnull String eventType) {
   ...
   */
  @javax.annotation.Nonnull
  public IntegrationHubFlowConfigResponse getConfig() {
    return config;
  }

  public void setConfig(@javax.annotation.Nonnull IntegrationHubFlowConfigResponse config) {
    this.config = config;
  }
   ...
   * @return the IntegrationHubFlowResponse instance itself
   */
  public IntegrationHubFlowResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IntegrationHubFlowResponse integrationHubFlowResponse = (IntegrationHubFlowResponse) o;
    return Objects.equals(this.id, integrationHubFlowResponse.id) &&
        Objects.equals(this.integrationName, integrationHubFlowResponse.integrationName) &&
        Objects.equals(this.instanceName, integrationHubFlowResponse.instanceName) &&
        Objects.equals(this.createdAt, integrationHubFlowResponse.createdAt) &&
        Objects.equals(this.disabledUntil, integrationHubFlowResponse.disabledUntil) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntegrationHubFlowResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationHubFlowResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntegrationHubFlowResponse is not found in the empty JSON string", IntegrationHubFlowResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IntegrationHubFlowResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntegrationHubFlowResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntegrationHubFlowResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntegrationHubFlowResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntegrationHubFlowResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<IntegrationHubFlowResponse>() {
           @Override
           public void write(JsonWriter out, IntegrationHubFlowResponse value) throws IOException {
           ...
           @Override
           public IntegrationHubFlowResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             IntegrationHubFlowResponse instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of IntegrationHubFlowResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntegrationHubFlowResponse
   * @throws IOException if the JSON string is invalid with respect to IntegrationHubFlowResponse
   */
  public static IntegrationHubFlowResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntegrationHubFlowResponse.class);
  }

  /**
   * Convert an instance of IntegrationHubFlowResponse to an JSON string
   *
   * @return JSON string
   */
