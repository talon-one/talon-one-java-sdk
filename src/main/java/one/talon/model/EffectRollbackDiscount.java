...
public class EffectRollbackDiscount {
  ...
  @javax.annotation.Nonnull
  private RollbackDiscountEffectProps props;

  public EffectRollbackDiscount() {
  }

  public EffectRollbackDiscount experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectRollbackDiscount campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectRollbackDiscount rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectRollbackDiscount ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectRollbackDiscount ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectRollbackDiscount effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectRollbackDiscount triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectRollbackDiscount triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectRollbackDiscount conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectRollbackDiscount evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectRollbackDiscount evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectRollbackDiscount campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectRollbackDiscount campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectRollbackDiscount selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectRollbackDiscount selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectRollbackDiscount adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectRollbackDiscount rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectRollbackDiscount props(@javax.annotation.Nonnull RollbackDiscountEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RollbackDiscountEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull RollbackDiscountEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectRollbackDiscount instance itself
   */
  public EffectRollbackDiscount putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectRollbackDiscount effectRollbackDiscount = (EffectRollbackDiscount) o;
    return Objects.equals(this.experimentId, effectRollbackDiscount.experimentId) &&
        Objects.equals(this.campaignId, effectRollbackDiscount.campaignId) &&
        Objects.equals(this.rulesetId, effectRollbackDiscount.rulesetId) &&
        Objects.equals(this.ruleIndex, effectRollbackDiscount.ruleIndex) &&
        Objects.equals(this.ruleName, effectRollbackDiscount.ruleName) &&
        Objects.equals(this.effectType, effectRollbackDiscount.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectRollbackDiscount.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectRollbackDiscount.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectRollbackDiscount.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectRollbackDiscount.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectRollbackDiscount.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectRollbackDiscount.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectRollbackDiscount.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectRollbackDiscount.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectRollbackDiscount.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectRollbackDiscount.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectRollbackDiscount.rewardId) &&
        Objects.equals(this.props, effectRollbackDiscount.props)&&
        Objects.equals(this.additionalProperties, effectRollbackDiscount.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectRollbackDiscount {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectRollbackDiscount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectRollbackDiscount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectRollbackDiscount is not found in the empty JSON string", EffectRollbackDiscount.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectRollbackDiscount.openapiRequiredFields) {
      ...
      RollbackDiscountEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectRollbackDiscount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectRollbackDiscount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectRollbackDiscount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectRollbackDiscount.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectRollbackDiscount>() {
           @Override
           public void write(JsonWriter out, EffectRollbackDiscount value) throws IOException {
           ...
           @Override
           public EffectRollbackDiscount read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectRollbackDiscount instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectRollbackDiscount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectRollbackDiscount
   * @throws IOException if the JSON string is invalid with respect to EffectRollbackDiscount
   */
  public static EffectRollbackDiscount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectRollbackDiscount.class);
  }

  /**
   * Convert an instance of EffectRollbackDiscount to an JSON string
   *
   * @return JSON string
   */
