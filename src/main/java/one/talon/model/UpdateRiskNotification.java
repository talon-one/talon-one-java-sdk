...
public class UpdateRiskNotification {
  ...
  public UpdateRiskNotification() {
  }

  public UpdateRiskNotification entity(@javax.annotation.Nonnull EntityEnum entity) {
    this.entity = entity;
    return this;
  }
  ...
  public UpdateRiskNotification activity(@javax.annotation.Nonnull ActivityEnum activity) {
  ...
  public UpdateRiskNotification timeFrame(@javax.annotation.Nonnull TimeFrameEnum timeFrame) {
  ...
  public UpdateRiskNotification active(@javax.annotation.Nonnull Boolean active) {
    this.active = active;
    return this;
  }
   ...
   * @return the UpdateRiskNotification instance itself
   */
  public UpdateRiskNotification putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateRiskNotification updateRiskNotification = (UpdateRiskNotification) o;
    return Objects.equals(this.entity, updateRiskNotification.entity) &&
        Objects.equals(this.activity, updateRiskNotification.activity) &&
        Objects.equals(this.timeFrame, updateRiskNotification.timeFrame) &&
        Objects.equals(this.active, updateRiskNotification.active)&&
        Objects.equals(this.additionalProperties, updateRiskNotification.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(entity, activity, timeFrame, active, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("entity", "activity", "timeFrame", "active"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("entity", "activity", "timeFrame", "active"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateRiskNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRiskNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateRiskNotification is not found in the empty JSON string", UpdateRiskNotification.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateRiskNotification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateRiskNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateRiskNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateRiskNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateRiskNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateRiskNotification>() {
           @Override
           public void write(JsonWriter out, UpdateRiskNotification value) throws IOException {
           ...
           @Override
           public UpdateRiskNotification read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdateRiskNotification instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UpdateRiskNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateRiskNotification
   * @throws IOException if the JSON string is invalid with respect to UpdateRiskNotification
   */
  public static UpdateRiskNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateRiskNotification.class);
  }

  /**
   * Convert an instance of UpdateRiskNotification to an JSON string
   *
   * @return JSON string
   */
