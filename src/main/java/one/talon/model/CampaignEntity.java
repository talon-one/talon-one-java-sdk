...
public class CampaignEntity {
  ...
  public CampaignEntity campaignId(@javax.annotation.Nonnull Long campaignId) {
   ...
   * @return the CampaignEntity instance itself
   */
  public CampaignEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.campaignId, campaignEntity.campaignId)&&
        Objects.equals(this.additionalProperties, campaignEntity.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(campaignId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("campaignId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CampaignEntity is not found in the empty JSON string", CampaignEntity.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CampaignEntity.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignEntity>() {
           ...
           public CampaignEntity read(JsonReader in) throws IOException {
             ...
             CampaignEntity instance = thisAdapter.fromJsonTree(jsonObj);
