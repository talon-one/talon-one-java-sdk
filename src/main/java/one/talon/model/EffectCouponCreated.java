...
public class EffectCouponCreated {
  ...
  @javax.annotation.Nonnull
  private CouponCreatedEffectProps props;

  public EffectCouponCreated() {
  }

  public EffectCouponCreated experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectCouponCreated campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectCouponCreated rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectCouponCreated ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectCouponCreated ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectCouponCreated effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectCouponCreated triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectCouponCreated triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectCouponCreated conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectCouponCreated evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectCouponCreated evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectCouponCreated campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectCouponCreated campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectCouponCreated selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectCouponCreated selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectCouponCreated adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectCouponCreated rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectCouponCreated props(@javax.annotation.Nonnull CouponCreatedEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public CouponCreatedEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull CouponCreatedEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectCouponCreated instance itself
   */
  public EffectCouponCreated putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectCouponCreated effectCouponCreated = (EffectCouponCreated) o;
    return Objects.equals(this.experimentId, effectCouponCreated.experimentId) &&
        Objects.equals(this.campaignId, effectCouponCreated.campaignId) &&
        Objects.equals(this.rulesetId, effectCouponCreated.rulesetId) &&
        Objects.equals(this.ruleIndex, effectCouponCreated.ruleIndex) &&
        Objects.equals(this.ruleName, effectCouponCreated.ruleName) &&
        Objects.equals(this.effectType, effectCouponCreated.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectCouponCreated.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectCouponCreated.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectCouponCreated.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectCouponCreated.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectCouponCreated.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectCouponCreated.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectCouponCreated.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectCouponCreated.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectCouponCreated.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectCouponCreated.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectCouponCreated.rewardId) &&
        Objects.equals(this.props, effectCouponCreated.props)&&
        Objects.equals(this.additionalProperties, effectCouponCreated.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectCouponCreated {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectCouponCreated
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectCouponCreated.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectCouponCreated is not found in the empty JSON string", EffectCouponCreated.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectCouponCreated.openapiRequiredFields) {
      ...
      CouponCreatedEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectCouponCreated.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectCouponCreated' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectCouponCreated> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectCouponCreated.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectCouponCreated>() {
           @Override
           public void write(JsonWriter out, EffectCouponCreated value) throws IOException {
           ...
           @Override
           public EffectCouponCreated read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectCouponCreated instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectCouponCreated given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectCouponCreated
   * @throws IOException if the JSON string is invalid with respect to EffectCouponCreated
   */
  public static EffectCouponCreated fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectCouponCreated.class);
  }

  /**
   * Convert an instance of EffectCouponCreated to an JSON string
   *
   * @return JSON string
   */
