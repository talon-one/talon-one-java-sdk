...
public class AddLoyaltyPoints {
   ...
   * @return the AddLoyaltyPoints instance itself
   */
  public AddLoyaltyPoints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.points, addLoyaltyPoints.points) &&
        ...
        Objects.equals(this.additionalProperties, addLoyaltyPoints.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(points, name, validityDuration, validUntil, pendingDuration, pendingUntil, subledgerId, applicationId, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddLoyaltyPoints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AddLoyaltyPoints is not found in the empty JSON string", AddLoyaltyPoints.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AddLoyaltyPoints>() {
           ...
           public AddLoyaltyPoints read(JsonReader in) throws IOException {
             ...
             AddLoyaltyPoints instance = thisAdapter.fromJsonTree(jsonObj);
