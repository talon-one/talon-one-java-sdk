...
public class EventV3RequestEntity {
  ...
  public EventV3RequestEntity() {
  }

  public EventV3RequestEntity profileId(@javax.annotation.Nonnull String profileId) {
  ...
  public EventV3RequestEntity storeIntegrationId(@javax.annotation.Nullable String storeIntegrationId) {
  ...
  public EventV3RequestEntity evaluableCampaignIds(@javax.annotation.Nullable List<Long> evaluableCampaignIds) {
    this.evaluableCampaignIds = evaluableCampaignIds;
    return this;
  }

  public EventV3RequestEntity addEvaluableCampaignIdsItem(Long evaluableCampaignIdsItem) {
  ...
  public EventV3RequestEntity type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public EventV3RequestEntity attributes(@javax.annotation.Nullable Object attributes) {
  ...
  public EventV3RequestEntity integrationId(@javax.annotation.Nonnull String integrationId) {
  ...
  public EventV3RequestEntity connectedSessionId(@javax.annotation.Nullable String connectedSessionId) {
  ...
  public EventV3RequestEntity referralCode(@javax.annotation.Nullable String referralCode) {
   ...
   * @return the EventV3RequestEntity instance itself
   */
  public EventV3RequestEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EventV3RequestEntity eventV3RequestEntity = (EventV3RequestEntity) o;
    return Objects.equals(this.profileId, eventV3RequestEntity.profileId) &&
        Objects.equals(this.storeIntegrationId, eventV3RequestEntity.storeIntegrationId) &&
        Objects.equals(this.evaluableCampaignIds, eventV3RequestEntity.evaluableCampaignIds) &&
        Objects.equals(this.type, eventV3RequestEntity.type) &&
        Objects.equals(this.attributes, eventV3RequestEntity.attributes) &&
        Objects.equals(this.integrationId, eventV3RequestEntity.integrationId) &&
        Objects.equals(this.connectedSessionId, eventV3RequestEntity.connectedSessionId) &&
        Objects.equals(this.referralCode, eventV3RequestEntity.referralCode)&&
        Objects.equals(this.additionalProperties, eventV3RequestEntity.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(profileId, storeIntegrationId, evaluableCampaignIds, type, attributes, integrationId, connectedSessionId, referralCode, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("profileId", "storeIntegrationId", "evaluableCampaignIds", "type", "attributes", "integrationId", "connectedSessionId", "referralCode"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventV3RequestEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventV3RequestEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventV3RequestEntity is not found in the empty JSON string", EventV3RequestEntity.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventV3RequestEntity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventV3RequestEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventV3RequestEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventV3RequestEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventV3RequestEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<EventV3RequestEntity>() {
           @Override
           public void write(JsonWriter out, EventV3RequestEntity value) throws IOException {
           ...
           @Override
           public EventV3RequestEntity read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EventV3RequestEntity instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EventV3RequestEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventV3RequestEntity
   * @throws IOException if the JSON string is invalid with respect to EventV3RequestEntity
   */
  public static EventV3RequestEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventV3RequestEntity.class);
  }

  /**
   * Convert an instance of EventV3RequestEntity to an JSON string
   *
   * @return JSON string
   */
