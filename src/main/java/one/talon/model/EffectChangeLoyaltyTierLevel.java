...
public class EffectChangeLoyaltyTierLevel {
  ...
  @javax.annotation.Nonnull
  private ChangeLoyaltyTierLevelEffectProps props;

  public EffectChangeLoyaltyTierLevel() {
  }

  public EffectChangeLoyaltyTierLevel experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectChangeLoyaltyTierLevel campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectChangeLoyaltyTierLevel rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectChangeLoyaltyTierLevel ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectChangeLoyaltyTierLevel ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectChangeLoyaltyTierLevel effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectChangeLoyaltyTierLevel triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectChangeLoyaltyTierLevel triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectChangeLoyaltyTierLevel conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectChangeLoyaltyTierLevel evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectChangeLoyaltyTierLevel evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectChangeLoyaltyTierLevel campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectChangeLoyaltyTierLevel campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectChangeLoyaltyTierLevel selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectChangeLoyaltyTierLevel selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectChangeLoyaltyTierLevel adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectChangeLoyaltyTierLevel rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectChangeLoyaltyTierLevel props(@javax.annotation.Nonnull ChangeLoyaltyTierLevelEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public ChangeLoyaltyTierLevelEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull ChangeLoyaltyTierLevelEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectChangeLoyaltyTierLevel instance itself
   */
  public EffectChangeLoyaltyTierLevel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectChangeLoyaltyTierLevel effectChangeLoyaltyTierLevel = (EffectChangeLoyaltyTierLevel) o;
    return Objects.equals(this.experimentId, effectChangeLoyaltyTierLevel.experimentId) &&
        Objects.equals(this.campaignId, effectChangeLoyaltyTierLevel.campaignId) &&
        Objects.equals(this.rulesetId, effectChangeLoyaltyTierLevel.rulesetId) &&
        Objects.equals(this.ruleIndex, effectChangeLoyaltyTierLevel.ruleIndex) &&
        Objects.equals(this.ruleName, effectChangeLoyaltyTierLevel.ruleName) &&
        Objects.equals(this.effectType, effectChangeLoyaltyTierLevel.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectChangeLoyaltyTierLevel.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectChangeLoyaltyTierLevel.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectChangeLoyaltyTierLevel.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectChangeLoyaltyTierLevel.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectChangeLoyaltyTierLevel.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectChangeLoyaltyTierLevel.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectChangeLoyaltyTierLevel.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectChangeLoyaltyTierLevel.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectChangeLoyaltyTierLevel.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectChangeLoyaltyTierLevel.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectChangeLoyaltyTierLevel.rewardId) &&
        Objects.equals(this.props, effectChangeLoyaltyTierLevel.props)&&
        Objects.equals(this.additionalProperties, effectChangeLoyaltyTierLevel.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectChangeLoyaltyTierLevel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectChangeLoyaltyTierLevel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectChangeLoyaltyTierLevel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectChangeLoyaltyTierLevel is not found in the empty JSON string", EffectChangeLoyaltyTierLevel.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectChangeLoyaltyTierLevel.openapiRequiredFields) {
      ...
      ChangeLoyaltyTierLevelEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectChangeLoyaltyTierLevel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectChangeLoyaltyTierLevel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectChangeLoyaltyTierLevel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectChangeLoyaltyTierLevel.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectChangeLoyaltyTierLevel>() {
           @Override
           public void write(JsonWriter out, EffectChangeLoyaltyTierLevel value) throws IOException {
           ...
           @Override
           public EffectChangeLoyaltyTierLevel read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectChangeLoyaltyTierLevel instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectChangeLoyaltyTierLevel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectChangeLoyaltyTierLevel
   * @throws IOException if the JSON string is invalid with respect to EffectChangeLoyaltyTierLevel
   */
  public static EffectChangeLoyaltyTierLevel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectChangeLoyaltyTierLevel.class);
  }

  /**
   * Convert an instance of EffectChangeLoyaltyTierLevel to an JSON string
   *
   * @return JSON string
   */
