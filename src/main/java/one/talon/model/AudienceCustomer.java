...
public class AudienceCustomer {
  ...
  @javax.annotation.Nullable
  private List<Long> connectedApplicationsIds = new ArrayList<>();
  ...
  @javax.annotation.Nullable
  private List<Long> connectedAudiences = new ArrayList<>();

  public AudienceCustomer() {
  }

  public AudienceCustomer id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public AudienceCustomer created(@javax.annotation.Nonnull OffsetDateTime created) {
  ...
  public AudienceCustomer integrationId(@javax.annotation.Nonnull String integrationId) {
  ...
  public AudienceCustomer attributes(@javax.annotation.Nullable Object attributes) {
  ...
  public AudienceCustomer accountId(@javax.annotation.Nonnull Long accountId) {
  ...
  public AudienceCustomer closedSessions(@javax.annotation.Nonnull Long closedSessions) {
  ...
  public AudienceCustomer totalSales(@javax.annotation.Nonnull BigDecimal totalSales) {
  ...
  public AudienceCustomer loyaltyMemberships(@javax.annotation.Nullable List<LoyaltyMembership> loyaltyMemberships) {
  ...
  public AudienceCustomer audienceMemberships(@javax.annotation.Nullable List<AudienceMembership> audienceMemberships) {
  ...
  public AudienceCustomer lastActivity(@javax.annotation.Nonnull OffsetDateTime lastActivity) {
  ...
  public AudienceCustomer sandbox(@javax.annotation.Nullable Boolean sandbox) {
  ...
  public AudienceCustomer connectedApplicationsIds(@javax.annotation.Nullable List<Long> connectedApplicationsIds) {
  ...
  public AudienceCustomer addConnectedApplicationsIdsItem(Long connectedApplicationsIdsItem) {
    if (this.connectedApplicationsIds == null) {
      this.connectedApplicationsIds = new ArrayList<>();
    }
  ...
  public void setConnectedApplicationsIds(@javax.annotation.Nullable List<Long> connectedApplicationsIds) {
    this.connectedApplicationsIds = connectedApplicationsIds;
  }


  public AudienceCustomer connectedAudiences(@javax.annotation.Nullable List<Long> connectedAudiences) {
  ...
  public AudienceCustomer addConnectedAudiencesItem(Long connectedAudiencesItem) {
    if (this.connectedAudiences == null) {
      this.connectedAudiences = new ArrayList<>();
    }
  ...
  public void setConnectedAudiences(@javax.annotation.Nullable List<Long> connectedAudiences) {
    this.connectedAudiences = connectedAudiences;
  }
  ...
  static {
    ...
    openapiFields.add("connectedApplicationsIds");
    openapiFields.add("connectedAudiences");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AudienceCustomer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AudienceCustomer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AudienceCustomer is not found in the empty JSON string", AudienceCustomer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AudienceCustomer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AudienceCustomer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("connectedApplicationsIds") != null && !jsonObj.get("connectedApplicationsIds").isJsonNull() && !jsonObj.get("connectedApplicationsIds").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `connectedApplicationsIds` to be an array in the JSON string but got `%s`", jsonObj.get("connectedApplicationsIds").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("connectedAudiences") != null && !jsonObj.get("connectedAudiences").isJsonNull() && !jsonObj.get("connectedAudiences").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `connectedAudiences` to be an array in the JSON string but got `%s`", jsonObj.get("connectedAudiences").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AudienceCustomer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AudienceCustomer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AudienceCustomer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AudienceCustomer.class));

       return (TypeAdapter<T>) new TypeAdapter<AudienceCustomer>() {
           @Override
           public void write(JsonWriter out, AudienceCustomer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AudienceCustomer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AudienceCustomer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AudienceCustomer
   * @throws IOException if the JSON string is invalid with respect to AudienceCustomer
   */
  public static AudienceCustomer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AudienceCustomer.class);
  }

  /**
   * Convert an instance of AudienceCustomer to an JSON string
   *
   * @return JSON string
   */
