...
public class AudienceCustomer {
  ...
  @javax.annotation.Nullable
  private List<Long> connectedApplicationsIds;
  ...
  @javax.annotation.Nullable
  private List<Long> connectedAudiences;
  ...
  public AudienceCustomer attributes(@javax.annotation.Nullable Map<String, Object> attributes) {
    this.attributes = attributes;
    return this;
  }

  public AudienceCustomer putAttributesItem(String key, Object attributesItem) {
   ...
   * @return the AudienceCustomer instance itself
   */
  public AudienceCustomer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, audienceCustomer.id) &&
        ...
        Objects.equals(this.additionalProperties, audienceCustomer.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, created, integrationId, attributes, accountId, closedSessions, totalSales, loyaltyMemberships, audienceMemberships, lastActivity, sandbox, connectedApplicationsIds, connectedAudiences, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created", "integrationId", "attributes", "accountId", "closedSessions", "totalSales", "loyaltyMemberships", "audienceMemberships", "lastActivity", "sandbox", "connectedApplicationsIds", "connectedAudiences"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AudienceCustomer>() {
           ...
           public AudienceCustomer read(JsonReader in) throws IOException {
             ...
             AudienceCustomer instance = thisAdapter.fromJsonTree(jsonObj);
