...
public class UpdateCampaignTemplate {
   ...
   * @return the UpdateCampaignTemplate instance itself
   */
  public UpdateCampaignTemplate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateCampaignTemplate.name) &&
        ...
        Objects.equals(this.additionalProperties, updateCampaignTemplate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, instructions, campaignAttributes, couponAttributes, state, activeRulesetId, tags, reevaluateOnReturn, features, couponSettings, couponReservationSettings, referralSettings, limits, templateParams, applicationsIds, campaignCollections, defaultCampaignGroupId, campaignType, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCampaignTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateCampaignTemplate is not found in the empty JSON string", UpdateCampaignTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("templateParams") != null && !jsonObj.get("templateParams").isJsonNull()) {
        ...
        if (jsonArraytemplateParams != null) {
          ...
          if (!jsonObj.get("templateParams").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `templateParams` to be an array in the JSON string but got `%s`", jsonObj.get("templateParams").toString()));
          }
      ...
      if (jsonObj.get("applicationsIds") == null) {
        ...
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `applicationsIds` to be an array in the JSON string but got `%s`", jsonObj.get("applicationsIds").toString()));
      }
      if (jsonObj.get("campaignCollections") != null && !jsonObj.get("campaignCollections").isJsonNull()) {
        ...
        if (jsonArraycampaignCollections != null) {
          ...
          if (!jsonObj.get("campaignCollections").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `campaignCollections` to be an array in the JSON string but got `%s`", jsonObj.get("campaignCollections").toString()));
          }
      ...
      if ((jsonObj.get("campaignType") != null && !jsonObj.get("campaignType").isJsonNull()) && !jsonObj.get("campaignType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `campaignType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("campaignType").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateCampaignTemplate>() {
           ...
           public UpdateCampaignTemplate read(JsonReader in) throws IOException {
             ...
             UpdateCampaignTemplate instance = thisAdapter.fromJsonTree(jsonObj);
