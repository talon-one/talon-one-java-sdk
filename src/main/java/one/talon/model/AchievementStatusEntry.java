...
public class AchievementStatusEntry {
   ...
   * @return the AchievementStatusEntry instance itself
   */
  public AchievementStatusEntry putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AchievementStatusEntry>() {
           ...
           public AchievementStatusEntry read(JsonReader in) throws IOException {
             ...
             AchievementStatusEntry instance = thisAdapter.fromJsonTree(jsonObj);
