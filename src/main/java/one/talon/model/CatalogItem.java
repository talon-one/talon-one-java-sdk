...
public class CatalogItem {
   ...
   * @return the CatalogItem instance itself
   */
  public CatalogItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, catalogItem.id) &&
        ...
        Objects.equals(this.additionalProperties, catalogItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, created, sku, price, catalogid, version, attributes, product, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created", "sku", "price", "catalogid", "version", "attributes", "product"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "created", "sku", "catalogid", "version"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CatalogItem is not found in the empty JSON string", CatalogItem.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CatalogItem>() {
           ...
           public CatalogItem read(JsonReader in) throws IOException {
             ...
             CatalogItem instance = thisAdapter.fromJsonTree(jsonObj);
