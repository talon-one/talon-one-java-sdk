...
public class RevisionVersion {
  ...
  public RevisionVersion couponAttributes(@javax.annotation.Nullable Object couponAttributes) {
   ...
   * @return the RevisionVersion instance itself
   */
  public RevisionVersion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, revisionVersion.id) &&
        ...
        Objects.equals(this.additionalProperties, revisionVersion.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, startTime, endTime, attributes, description, activeRulesetId, tags, couponSettings, referralSettings, limits, reevaluateOnReturn, features, couponAttributes, accountId, applicationId, campaignId, created, createdBy, revisionId, version, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "startTime", "endTime", "attributes", "description", "activeRulesetId", "tags", "couponSettings", "referralSettings", "limits", "reevaluateOnReturn", "features", "couponAttributes", "accountId", "applicationId", "campaignId", "created", "createdBy", "revisionId", "version"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RevisionVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RevisionVersion is not found in the empty JSON string", RevisionVersion.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RevisionVersion>() {
           ...
           public RevisionVersion read(JsonReader in) throws IOException {
             ...
             RevisionVersion instance = thisAdapter.fromJsonTree(jsonObj);
