...
public class ExperimentVariant {
   ...
   * @return the ExperimentVariant instance itself
   */
  public ExperimentVariant putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ExperimentVariant>() {
           ...
           public ExperimentVariant read(JsonReader in) throws IOException {
             ...
             ExperimentVariant instance = thisAdapter.fromJsonTree(jsonObj);
