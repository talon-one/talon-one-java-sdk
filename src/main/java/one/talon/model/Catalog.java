...
public class Catalog {
  ...
  public Catalog id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public Catalog created(@javax.annotation.Nonnull OffsetDateTime created) {
  ...
  public Catalog accountId(@javax.annotation.Nonnull Long accountId) {
  ...
  public Catalog modified(@javax.annotation.Nonnull OffsetDateTime modified) {
  ...
  public Catalog description(@javax.annotation.Nonnull String description) {
  ...
  public Catalog subscribedApplicationsIds(@javax.annotation.Nullable List<Long> subscribedApplicationsIds) {
  ...
  public Catalog version(@javax.annotation.Nonnull Long version) {
  ...
  public Catalog createdBy(@javax.annotation.Nonnull Long createdBy) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created", "accountId", "modified", "name", "description", "subscribedApplicationsIds", "version", "createdBy"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "created", "accountId", "modified", "name", "description", "version", "createdBy"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Catalog.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Catalog is not found in the empty JSON string", Catalog.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Catalog.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Catalog` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
