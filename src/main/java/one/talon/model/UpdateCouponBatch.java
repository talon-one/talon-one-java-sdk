...
public class UpdateCouponBatch {
   ...
   * @return the UpdateCouponBatch instance itself
   */
  public UpdateCouponBatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usageLimit, updateCouponBatch.usageLimit) &&
        ...
        Objects.equals(this.additionalProperties, updateCouponBatch.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(usageLimit, discountLimit, reservationLimit, startDate, expiryDate, attributes, batchID, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCouponBatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateCouponBatch is not found in the empty JSON string", UpdateCouponBatch.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateCouponBatch>() {
           ...
           public UpdateCouponBatch read(JsonReader in) throws IOException {
             ...
             UpdateCouponBatch instance = thisAdapter.fromJsonTree(jsonObj);
