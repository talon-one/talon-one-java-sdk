...
public class CampaignBudget {
   ...
   * @return the CampaignBudget instance itself
   */
  public CampaignBudget putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, campaignBudget.action) &&
        ...
        Objects.equals(this.additionalProperties, campaignBudget.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, limit, counter, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("action", "limit", "counter"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("action", "limit", "counter"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignBudget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CampaignBudget is not found in the empty JSON string", CampaignBudget.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignBudget>() {
           ...
           public CampaignBudget read(JsonReader in) throws IOException {
             ...
             CampaignBudget instance = thisAdapter.fromJsonTree(jsonObj);
