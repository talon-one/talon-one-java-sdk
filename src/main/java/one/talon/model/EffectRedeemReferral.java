...
public class EffectRedeemReferral {
  ...
  @javax.annotation.Nonnull
  private RedeemReferralEffectProps props;

  public EffectRedeemReferral() {
  }

  public EffectRedeemReferral experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectRedeemReferral campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectRedeemReferral rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectRedeemReferral ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectRedeemReferral ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectRedeemReferral effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectRedeemReferral triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectRedeemReferral triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectRedeemReferral conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectRedeemReferral evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectRedeemReferral evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectRedeemReferral campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectRedeemReferral campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectRedeemReferral selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectRedeemReferral selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectRedeemReferral adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectRedeemReferral rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  @Deprecated
  public EffectRedeemReferral props(@javax.annotation.Nonnull RedeemReferralEffectProps props) {
    this.props = props;
    return this;
  }
  ...
  @Deprecated
  @javax.annotation.Nonnull
  public RedeemReferralEffectProps getProps() {
    return props;
  }

  @Deprecated
  public void setProps(@javax.annotation.Nonnull RedeemReferralEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectRedeemReferral instance itself
   */
  public EffectRedeemReferral putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectRedeemReferral effectRedeemReferral = (EffectRedeemReferral) o;
    return Objects.equals(this.experimentId, effectRedeemReferral.experimentId) &&
        Objects.equals(this.campaignId, effectRedeemReferral.campaignId) &&
        Objects.equals(this.rulesetId, effectRedeemReferral.rulesetId) &&
        Objects.equals(this.ruleIndex, effectRedeemReferral.ruleIndex) &&
        Objects.equals(this.ruleName, effectRedeemReferral.ruleName) &&
        Objects.equals(this.effectType, effectRedeemReferral.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectRedeemReferral.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectRedeemReferral.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectRedeemReferral.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectRedeemReferral.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectRedeemReferral.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectRedeemReferral.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectRedeemReferral.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectRedeemReferral.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectRedeemReferral.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectRedeemReferral.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectRedeemReferral.rewardId) &&
        Objects.equals(this.props, effectRedeemReferral.props)&&
        Objects.equals(this.additionalProperties, effectRedeemReferral.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectRedeemReferral {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectRedeemReferral
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectRedeemReferral.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectRedeemReferral is not found in the empty JSON string", EffectRedeemReferral.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectRedeemReferral.openapiRequiredFields) {
      ...
      RedeemReferralEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectRedeemReferral.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectRedeemReferral' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectRedeemReferral> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectRedeemReferral.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectRedeemReferral>() {
           @Override
           public void write(JsonWriter out, EffectRedeemReferral value) throws IOException {
           ...
           @Override
           public EffectRedeemReferral read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectRedeemReferral instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectRedeemReferral given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectRedeemReferral
   * @throws IOException if the JSON string is invalid with respect to EffectRedeemReferral
   */
  public static EffectRedeemReferral fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectRedeemReferral.class);
  }

  /**
   * Convert an instance of EffectRedeemReferral to an JSON string
   *
   * @return JSON string
   */
