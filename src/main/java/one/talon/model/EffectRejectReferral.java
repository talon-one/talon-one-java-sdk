...
public class EffectRejectReferral {
  ...
  @javax.annotation.Nonnull
  private RejectReferralEffectProps props;

  public EffectRejectReferral() {
  }

  public EffectRejectReferral experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectRejectReferral campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectRejectReferral rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectRejectReferral ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectRejectReferral ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectRejectReferral effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectRejectReferral triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectRejectReferral triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectRejectReferral conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectRejectReferral evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectRejectReferral evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectRejectReferral campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectRejectReferral campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectRejectReferral selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectRejectReferral selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectRejectReferral adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectRejectReferral rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectRejectReferral props(@javax.annotation.Nonnull RejectReferralEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RejectReferralEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull RejectReferralEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectRejectReferral instance itself
   */
  public EffectRejectReferral putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectRejectReferral effectRejectReferral = (EffectRejectReferral) o;
    return Objects.equals(this.experimentId, effectRejectReferral.experimentId) &&
        Objects.equals(this.campaignId, effectRejectReferral.campaignId) &&
        Objects.equals(this.rulesetId, effectRejectReferral.rulesetId) &&
        Objects.equals(this.ruleIndex, effectRejectReferral.ruleIndex) &&
        Objects.equals(this.ruleName, effectRejectReferral.ruleName) &&
        Objects.equals(this.effectType, effectRejectReferral.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectRejectReferral.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectRejectReferral.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectRejectReferral.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectRejectReferral.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectRejectReferral.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectRejectReferral.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectRejectReferral.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectRejectReferral.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectRejectReferral.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectRejectReferral.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectRejectReferral.rewardId) &&
        Objects.equals(this.props, effectRejectReferral.props)&&
        Objects.equals(this.additionalProperties, effectRejectReferral.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectRejectReferral {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectRejectReferral
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectRejectReferral.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectRejectReferral is not found in the empty JSON string", EffectRejectReferral.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectRejectReferral.openapiRequiredFields) {
      ...
      RejectReferralEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectRejectReferral.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectRejectReferral' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectRejectReferral> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectRejectReferral.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectRejectReferral>() {
           @Override
           public void write(JsonWriter out, EffectRejectReferral value) throws IOException {
           ...
           @Override
           public EffectRejectReferral read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectRejectReferral instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectRejectReferral given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectRejectReferral
   * @throws IOException if the JSON string is invalid with respect to EffectRejectReferral
   */
  public static EffectRejectReferral fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectRejectReferral.class);
  }

  /**
   * Convert an instance of EffectRejectReferral to an JSON string
   *
   * @return JSON string
   */
