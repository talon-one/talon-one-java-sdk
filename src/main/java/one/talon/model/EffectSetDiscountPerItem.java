...
public class EffectSetDiscountPerItem {
  ...
  @javax.annotation.Nonnull
  private SetDiscountPerItemEffectProps props;

  public EffectSetDiscountPerItem() {
  }

  public EffectSetDiscountPerItem experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectSetDiscountPerItem campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectSetDiscountPerItem rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectSetDiscountPerItem ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectSetDiscountPerItem ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectSetDiscountPerItem effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectSetDiscountPerItem triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectSetDiscountPerItem triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectSetDiscountPerItem conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectSetDiscountPerItem evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectSetDiscountPerItem evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectSetDiscountPerItem campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectSetDiscountPerItem campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectSetDiscountPerItem selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectSetDiscountPerItem selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectSetDiscountPerItem adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectSetDiscountPerItem rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectSetDiscountPerItem props(@javax.annotation.Nonnull SetDiscountPerItemEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public SetDiscountPerItemEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull SetDiscountPerItemEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectSetDiscountPerItem instance itself
   */
  public EffectSetDiscountPerItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectSetDiscountPerItem effectSetDiscountPerItem = (EffectSetDiscountPerItem) o;
    return Objects.equals(this.experimentId, effectSetDiscountPerItem.experimentId) &&
        Objects.equals(this.campaignId, effectSetDiscountPerItem.campaignId) &&
        Objects.equals(this.rulesetId, effectSetDiscountPerItem.rulesetId) &&
        Objects.equals(this.ruleIndex, effectSetDiscountPerItem.ruleIndex) &&
        Objects.equals(this.ruleName, effectSetDiscountPerItem.ruleName) &&
        Objects.equals(this.effectType, effectSetDiscountPerItem.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectSetDiscountPerItem.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectSetDiscountPerItem.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectSetDiscountPerItem.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectSetDiscountPerItem.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectSetDiscountPerItem.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectSetDiscountPerItem.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectSetDiscountPerItem.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectSetDiscountPerItem.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectSetDiscountPerItem.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectSetDiscountPerItem.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectSetDiscountPerItem.rewardId) &&
        Objects.equals(this.props, effectSetDiscountPerItem.props)&&
        Objects.equals(this.additionalProperties, effectSetDiscountPerItem.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectSetDiscountPerItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectSetDiscountPerItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectSetDiscountPerItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectSetDiscountPerItem is not found in the empty JSON string", EffectSetDiscountPerItem.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectSetDiscountPerItem.openapiRequiredFields) {
      ...
      SetDiscountPerItemEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectSetDiscountPerItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectSetDiscountPerItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectSetDiscountPerItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectSetDiscountPerItem.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectSetDiscountPerItem>() {
           @Override
           public void write(JsonWriter out, EffectSetDiscountPerItem value) throws IOException {
           ...
           @Override
           public EffectSetDiscountPerItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectSetDiscountPerItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectSetDiscountPerItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectSetDiscountPerItem
   * @throws IOException if the JSON string is invalid with respect to EffectSetDiscountPerItem
   */
  public static EffectSetDiscountPerItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectSetDiscountPerItem.class);
  }

  /**
   * Convert an instance of EffectSetDiscountPerItem to an JSON string
   *
   * @return JSON string
   */
