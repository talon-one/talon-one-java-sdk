...
public class StrikethroughGroupBlock {
  ...
  public StrikethroughGroupBlock id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public StrikethroughGroupBlock type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public StrikethroughGroupBlock tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public StrikethroughGroupBlock addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public StrikethroughGroupBlock operator(@javax.annotation.Nonnull OperatorEnum operator) {
   ...
   * @return the StrikethroughGroupBlock instance itself
   */
  public StrikethroughGroupBlock putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    StrikethroughGroupBlock strikethroughGroupBlock = (StrikethroughGroupBlock) o;
    return Objects.equals(this.id, strikethroughGroupBlock.id) &&
        Objects.equals(this.type, strikethroughGroupBlock.type) &&
        Objects.equals(this.tags, strikethroughGroupBlock.tags) &&
        Objects.equals(this.operator, strikethroughGroupBlock.operator) &&
        Objects.equals(this.blocks, strikethroughGroupBlock.blocks) &&
        Objects.equals(this.onFailure, strikethroughGroupBlock.onFailure) &&
        Objects.equals(this.onError, strikethroughGroupBlock.onError)&&
        Objects.equals(this.additionalProperties, strikethroughGroupBlock.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StrikethroughGroupBlock
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StrikethroughGroupBlock.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StrikethroughGroupBlock is not found in the empty JSON string", StrikethroughGroupBlock.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StrikethroughGroupBlock.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StrikethroughGroupBlock.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StrikethroughGroupBlock' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StrikethroughGroupBlock> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StrikethroughGroupBlock.class));

       return (TypeAdapter<T>) new TypeAdapter<StrikethroughGroupBlock>() {
           @Override
           public void write(JsonWriter out, StrikethroughGroupBlock value) throws IOException {
           ...
           @Override
           public StrikethroughGroupBlock read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             StrikethroughGroupBlock instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of StrikethroughGroupBlock given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StrikethroughGroupBlock
   * @throws IOException if the JSON string is invalid with respect to StrikethroughGroupBlock
   */
  public static StrikethroughGroupBlock fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StrikethroughGroupBlock.class);
  }

  /**
   * Convert an instance of StrikethroughGroupBlock to an JSON string
   *
   * @return JSON string
   */
