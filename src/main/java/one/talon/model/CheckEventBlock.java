...
public class CheckEventBlock {
   ...
   * @return the CheckEventBlock instance itself
   */
  public CheckEventBlock putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CheckEventBlock checkEventBlock = (CheckEventBlock) o;
    return Objects.equals(this.id, checkEventBlock.id) &&
        Objects.equals(this.type, checkEventBlock.type) &&
        Objects.equals(this.tags, checkEventBlock.tags) &&
        Objects.equals(this.eventType, checkEventBlock.eventType) &&
        Objects.equals(this.matchers, checkEventBlock.matchers) &&
        Objects.equals(this.onFailure, checkEventBlock.onFailure)&&
        Objects.equals(this.additionalProperties, checkEventBlock.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, tags, eventType, matchers, onFailure, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CheckEventBlock
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckEventBlock.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CheckEventBlock is not found in the empty JSON string", CheckEventBlock.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CheckEventBlock.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckEventBlock.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckEventBlock' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckEventBlock> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckEventBlock.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckEventBlock>() {
           @Override
           public void write(JsonWriter out, CheckEventBlock value) throws IOException {
           ...
           @Override
           public CheckEventBlock read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CheckEventBlock instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CheckEventBlock given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CheckEventBlock
   * @throws IOException if the JSON string is invalid with respect to CheckEventBlock
   */
  public static CheckEventBlock fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckEventBlock.class);
  }

  /**
   * Convert an instance of CheckEventBlock to an JSON string
   *
   * @return JSON string
   */
