...
public class NewApplication {
  ...
  public NewApplication bestPriorPriceSettings(@javax.annotation.Nullable BestPriorPriceSettings bestPriorPriceSettings) {
   ...
   * @return the NewApplication instance itself
   */
  public NewApplication putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NewApplication>() {
           ...
           public NewApplication read(JsonReader in) throws IOException {
             ...
             NewApplication instance = thisAdapter.fromJsonTree(jsonObj);
