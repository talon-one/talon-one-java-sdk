...
public class EffectSetDiscountPerAdditionalCost {
  ...
  @javax.annotation.Nonnull
  private SetDiscountPerAdditionalCostEffectProps props;

  public EffectSetDiscountPerAdditionalCost() {
  }

  public EffectSetDiscountPerAdditionalCost experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectSetDiscountPerAdditionalCost campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectSetDiscountPerAdditionalCost rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectSetDiscountPerAdditionalCost ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectSetDiscountPerAdditionalCost ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectSetDiscountPerAdditionalCost effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectSetDiscountPerAdditionalCost triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectSetDiscountPerAdditionalCost triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectSetDiscountPerAdditionalCost conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectSetDiscountPerAdditionalCost evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectSetDiscountPerAdditionalCost evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectSetDiscountPerAdditionalCost campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectSetDiscountPerAdditionalCost campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectSetDiscountPerAdditionalCost selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectSetDiscountPerAdditionalCost selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectSetDiscountPerAdditionalCost adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectSetDiscountPerAdditionalCost rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectSetDiscountPerAdditionalCost props(@javax.annotation.Nonnull SetDiscountPerAdditionalCostEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public SetDiscountPerAdditionalCostEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull SetDiscountPerAdditionalCostEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectSetDiscountPerAdditionalCost instance itself
   */
  public EffectSetDiscountPerAdditionalCost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectSetDiscountPerAdditionalCost effectSetDiscountPerAdditionalCost = (EffectSetDiscountPerAdditionalCost) o;
    return Objects.equals(this.experimentId, effectSetDiscountPerAdditionalCost.experimentId) &&
        Objects.equals(this.campaignId, effectSetDiscountPerAdditionalCost.campaignId) &&
        Objects.equals(this.rulesetId, effectSetDiscountPerAdditionalCost.rulesetId) &&
        Objects.equals(this.ruleIndex, effectSetDiscountPerAdditionalCost.ruleIndex) &&
        Objects.equals(this.ruleName, effectSetDiscountPerAdditionalCost.ruleName) &&
        Objects.equals(this.effectType, effectSetDiscountPerAdditionalCost.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectSetDiscountPerAdditionalCost.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectSetDiscountPerAdditionalCost.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectSetDiscountPerAdditionalCost.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectSetDiscountPerAdditionalCost.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectSetDiscountPerAdditionalCost.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectSetDiscountPerAdditionalCost.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectSetDiscountPerAdditionalCost.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectSetDiscountPerAdditionalCost.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectSetDiscountPerAdditionalCost.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectSetDiscountPerAdditionalCost.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectSetDiscountPerAdditionalCost.rewardId) &&
        Objects.equals(this.props, effectSetDiscountPerAdditionalCost.props)&&
        Objects.equals(this.additionalProperties, effectSetDiscountPerAdditionalCost.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectSetDiscountPerAdditionalCost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectSetDiscountPerAdditionalCost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectSetDiscountPerAdditionalCost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectSetDiscountPerAdditionalCost is not found in the empty JSON string", EffectSetDiscountPerAdditionalCost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectSetDiscountPerAdditionalCost.openapiRequiredFields) {
      ...
      SetDiscountPerAdditionalCostEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectSetDiscountPerAdditionalCost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectSetDiscountPerAdditionalCost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectSetDiscountPerAdditionalCost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectSetDiscountPerAdditionalCost.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectSetDiscountPerAdditionalCost>() {
           @Override
           public void write(JsonWriter out, EffectSetDiscountPerAdditionalCost value) throws IOException {
           ...
           @Override
           public EffectSetDiscountPerAdditionalCost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectSetDiscountPerAdditionalCost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectSetDiscountPerAdditionalCost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectSetDiscountPerAdditionalCost
   * @throws IOException if the JSON string is invalid with respect to EffectSetDiscountPerAdditionalCost
   */
  public static EffectSetDiscountPerAdditionalCost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectSetDiscountPerAdditionalCost.class);
  }

  /**
   * Convert an instance of EffectSetDiscountPerAdditionalCost to an JSON string
   *
   * @return JSON string
   */
