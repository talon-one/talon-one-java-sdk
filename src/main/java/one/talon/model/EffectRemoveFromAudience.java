...
public class EffectRemoveFromAudience {
  ...
  @javax.annotation.Nonnull
  private RemoveFromAudienceEffectProps props;

  public EffectRemoveFromAudience() {
  }

  public EffectRemoveFromAudience experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectRemoveFromAudience campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectRemoveFromAudience rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectRemoveFromAudience ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectRemoveFromAudience ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectRemoveFromAudience effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectRemoveFromAudience triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectRemoveFromAudience triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectRemoveFromAudience conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectRemoveFromAudience evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectRemoveFromAudience evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectRemoveFromAudience campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectRemoveFromAudience campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectRemoveFromAudience selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectRemoveFromAudience selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectRemoveFromAudience adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectRemoveFromAudience rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectRemoveFromAudience props(@javax.annotation.Nonnull RemoveFromAudienceEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RemoveFromAudienceEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull RemoveFromAudienceEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectRemoveFromAudience instance itself
   */
  public EffectRemoveFromAudience putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectRemoveFromAudience effectRemoveFromAudience = (EffectRemoveFromAudience) o;
    return Objects.equals(this.experimentId, effectRemoveFromAudience.experimentId) &&
        Objects.equals(this.campaignId, effectRemoveFromAudience.campaignId) &&
        Objects.equals(this.rulesetId, effectRemoveFromAudience.rulesetId) &&
        Objects.equals(this.ruleIndex, effectRemoveFromAudience.ruleIndex) &&
        Objects.equals(this.ruleName, effectRemoveFromAudience.ruleName) &&
        Objects.equals(this.effectType, effectRemoveFromAudience.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectRemoveFromAudience.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectRemoveFromAudience.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectRemoveFromAudience.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectRemoveFromAudience.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectRemoveFromAudience.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectRemoveFromAudience.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectRemoveFromAudience.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectRemoveFromAudience.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectRemoveFromAudience.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectRemoveFromAudience.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectRemoveFromAudience.rewardId) &&
        Objects.equals(this.props, effectRemoveFromAudience.props)&&
        Objects.equals(this.additionalProperties, effectRemoveFromAudience.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectRemoveFromAudience {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectRemoveFromAudience
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectRemoveFromAudience.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectRemoveFromAudience is not found in the empty JSON string", EffectRemoveFromAudience.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectRemoveFromAudience.openapiRequiredFields) {
      ...
      RemoveFromAudienceEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectRemoveFromAudience.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectRemoveFromAudience' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectRemoveFromAudience> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectRemoveFromAudience.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectRemoveFromAudience>() {
           @Override
           public void write(JsonWriter out, EffectRemoveFromAudience value) throws IOException {
           ...
           @Override
           public EffectRemoveFromAudience read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectRemoveFromAudience instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectRemoveFromAudience given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectRemoveFromAudience
   * @throws IOException if the JSON string is invalid with respect to EffectRemoveFromAudience
   */
  public static EffectRemoveFromAudience fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectRemoveFromAudience.class);
  }

  /**
   * Convert an instance of EffectRemoveFromAudience to an JSON string
   *
   * @return JSON string
   */
