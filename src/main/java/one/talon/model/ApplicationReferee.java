...
public class ApplicationReferee {
   ...
   * @return the ApplicationReferee instance itself
   */
  public ApplicationReferee putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applicationId, applicationReferee.applicationId) &&
        ...
        Objects.equals(this.additionalProperties, applicationReferee.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationReferee.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApplicationReferee is not found in the empty JSON string", ApplicationReferee.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("friendIntegrationId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `friendIntegrationId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("friendIntegrationId").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ApplicationReferee>() {
           ...
           public ApplicationReferee read(JsonReader in) throws IOException {
             ...
             ApplicationReferee instance = thisAdapter.fromJsonTree(jsonObj);
