...
public class ManagementKey {
   ...
   * @return the ManagementKey instance itself
   */
  public ManagementKey putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, managementKey.name) &&
        ...
        Objects.equals(this.additionalProperties, managementKey.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, expiryDate, endpoints, allowedApplicationIds, id, createdBy, accountID, created, disabled, lastUsed, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ManagementKey>() {
           ...
           public ManagementKey read(JsonReader in) throws IOException {
             ...
             ManagementKey instance = thisAdapter.fromJsonTree(jsonObj);
