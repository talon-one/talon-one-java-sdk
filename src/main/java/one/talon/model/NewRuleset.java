...
public class NewRuleset {
  ...
  public NewRuleset rules(@javax.annotation.Nonnull List<Rule> rules) {
    this.rules = rules;
    return this;
  }
  ...
  public NewRuleset strikethroughRules(@javax.annotation.Nullable List<Rule> strikethroughRules) {
    this.strikethroughRules = strikethroughRules;
    return this;
  }

  public NewRuleset addStrikethroughRulesItem(Rule strikethroughRulesItem) {
  ...
  public NewRuleset bindings(@javax.annotation.Nonnull List<Binding> bindings) {
  ...
  public NewRuleset rbVersion(@javax.annotation.Nullable String rbVersion) {
  ...
  public NewRuleset activate(@javax.annotation.Nullable Boolean activate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rules, newRuleset.rules) &&
        Objects.equals(this.strikethroughRules, newRuleset.strikethroughRules) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(rules, strikethroughRules, bindings, rbVersion, activate);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("rules", "strikethroughRules", "bindings", "rbVersion", "activate"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("rules", "bindings"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewRuleset
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewRuleset.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in NewRuleset is not found in the empty JSON string", NewRuleset.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewRuleset.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `NewRuleset` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewRuleset.openapiRequiredFields) {
      ...
      if (jsonObj.get("strikethroughRules") != null && !jsonObj.get("strikethroughRules").isJsonNull()) {
        ...
        if (jsonArraystrikethroughRules != null) {
          ...
          if (!jsonObj.get("strikethroughRules").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `strikethroughRules` to be an array in the JSON string but got `%s`", jsonObj.get("strikethroughRules").toString()));
          }
      ...
      if (!jsonObj.get("bindings").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `bindings` to be an array in the JSON string but got `%s`", jsonObj.get("bindings").toString()));
      }
      ...
      if ((jsonObj.get("rbVersion") != null && !jsonObj.get("rbVersion").isJsonNull()) && !jsonObj.get("rbVersion").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `rbVersion` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rbVersion").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewRuleset.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewRuleset' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewRuleset> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewRuleset.class));

       return (TypeAdapter<T>) new TypeAdapter<NewRuleset>() {
           @Override
           public void write(JsonWriter out, NewRuleset value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewRuleset read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewRuleset given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewRuleset
   * @throws IOException if the JSON string is invalid with respect to NewRuleset
   */
  public static NewRuleset fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewRuleset.class);
  }

  /**
   * Convert an instance of NewRuleset to an JSON string
   *
   * @return JSON string
   */
