...
public class NewRuleset {
   ...
   * @return the NewRuleset instance itself
   */
  public NewRuleset putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rules, newRuleset.rules) &&
        ...
        Objects.equals(this.additionalProperties, newRuleset.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rules, strikethroughRules, bindings, rbVersion, activate, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewRuleset.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NewRuleset is not found in the empty JSON string", NewRuleset.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NewRuleset>() {
           ...
           public NewRuleset read(JsonReader in) throws IOException {
             ...
             NewRuleset instance = thisAdapter.fromJsonTree(jsonObj);
