...
public class EffectIncreaseAchievementProgress {
  ...
  @javax.annotation.Nonnull
  private IncreaseAchievementProgressEffectProps props;

  public EffectIncreaseAchievementProgress() {
  }

  public EffectIncreaseAchievementProgress experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectIncreaseAchievementProgress campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectIncreaseAchievementProgress rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectIncreaseAchievementProgress ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectIncreaseAchievementProgress ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectIncreaseAchievementProgress effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectIncreaseAchievementProgress triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectIncreaseAchievementProgress triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectIncreaseAchievementProgress conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectIncreaseAchievementProgress evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectIncreaseAchievementProgress evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectIncreaseAchievementProgress campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectIncreaseAchievementProgress campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectIncreaseAchievementProgress selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectIncreaseAchievementProgress selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectIncreaseAchievementProgress adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectIncreaseAchievementProgress rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectIncreaseAchievementProgress props(@javax.annotation.Nonnull IncreaseAchievementProgressEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public IncreaseAchievementProgressEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull IncreaseAchievementProgressEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectIncreaseAchievementProgress instance itself
   */
  public EffectIncreaseAchievementProgress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectIncreaseAchievementProgress effectIncreaseAchievementProgress = (EffectIncreaseAchievementProgress) o;
    return Objects.equals(this.experimentId, effectIncreaseAchievementProgress.experimentId) &&
        Objects.equals(this.campaignId, effectIncreaseAchievementProgress.campaignId) &&
        Objects.equals(this.rulesetId, effectIncreaseAchievementProgress.rulesetId) &&
        Objects.equals(this.ruleIndex, effectIncreaseAchievementProgress.ruleIndex) &&
        Objects.equals(this.ruleName, effectIncreaseAchievementProgress.ruleName) &&
        Objects.equals(this.effectType, effectIncreaseAchievementProgress.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectIncreaseAchievementProgress.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectIncreaseAchievementProgress.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectIncreaseAchievementProgress.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectIncreaseAchievementProgress.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectIncreaseAchievementProgress.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectIncreaseAchievementProgress.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectIncreaseAchievementProgress.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectIncreaseAchievementProgress.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectIncreaseAchievementProgress.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectIncreaseAchievementProgress.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectIncreaseAchievementProgress.rewardId) &&
        Objects.equals(this.props, effectIncreaseAchievementProgress.props)&&
        Objects.equals(this.additionalProperties, effectIncreaseAchievementProgress.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectIncreaseAchievementProgress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectIncreaseAchievementProgress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectIncreaseAchievementProgress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectIncreaseAchievementProgress is not found in the empty JSON string", EffectIncreaseAchievementProgress.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectIncreaseAchievementProgress.openapiRequiredFields) {
      ...
      IncreaseAchievementProgressEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectIncreaseAchievementProgress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectIncreaseAchievementProgress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectIncreaseAchievementProgress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectIncreaseAchievementProgress.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectIncreaseAchievementProgress>() {
           @Override
           public void write(JsonWriter out, EffectIncreaseAchievementProgress value) throws IOException {
           ...
           @Override
           public EffectIncreaseAchievementProgress read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectIncreaseAchievementProgress instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectIncreaseAchievementProgress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectIncreaseAchievementProgress
   * @throws IOException if the JSON string is invalid with respect to EffectIncreaseAchievementProgress
   */
  public static EffectIncreaseAchievementProgress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectIncreaseAchievementProgress.class);
  }

  /**
   * Convert an instance of EffectIncreaseAchievementProgress to an JSON string
   *
   * @return JSON string
   */
