...
public class CouponCreationJob {
   ...
   * @return the CouponCreationJob instance itself
   */
  public CouponCreationJob putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, couponCreationJob.id) &&
        ...
        Objects.equals(this.additionalProperties, couponCreationJob.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, created, campaignId, applicationId, accountId, usageLimit, discountLimit, reservationLimit, startDate, expiryDate, numberOfCoupons, couponSettings, attributes, isReservationMandatory, batchId, status, createdAmount, failCount, errors, createdBy, communicated, chunkExecutionCount, chunkSize, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CouponCreationJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CouponCreationJob is not found in the empty JSON string", CouponCreationJob.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CouponCreationJob>() {
           ...
           public CouponCreationJob read(JsonReader in) throws IOException {
             ...
             CouponCreationJob instance = thisAdapter.fromJsonTree(jsonObj);
