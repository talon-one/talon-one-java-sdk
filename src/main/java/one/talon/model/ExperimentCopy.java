...
public class ExperimentCopy {
   ...
   * @return the ExperimentCopy instance itself
   */
  public ExperimentCopy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.targetApplicationId, experimentCopy.targetApplicationId) &&
        ...
        Objects.equals(this.additionalProperties, experimentCopy.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(targetApplicationId, experiment, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("targetApplicationId", "experiment"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("targetApplicationId", "experiment"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<ExperimentCopy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExperimentCopy.class));

       return (TypeAdapter<T>) new TypeAdapter<ExperimentCopy>() {
           @Override
           ...
           public ExperimentCopy read(JsonReader in) throws IOException {
             ...
             ExperimentCopy instance = thisAdapter.fromJsonTree(jsonObj);
