...
public class GetUsers200Response {
   ...
   * @return the GetUsers200Response instance itself
   */
  public GetUsers200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalResultSize, getUsers200Response.totalResultSize) &&
        ...
        Objects.equals(this.additionalProperties, getUsers200Response.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUsers200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetUsers200Response is not found in the empty JSON string", GetUsers200Response.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetUsers200Response>() {
           ...
           public GetUsers200Response read(JsonReader in) throws IOException {
             ...
             GetUsers200Response instance = thisAdapter.fromJsonTree(jsonObj);
