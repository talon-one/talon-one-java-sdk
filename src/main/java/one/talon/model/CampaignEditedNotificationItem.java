...
public class CampaignEditedNotificationItem {
  ...
  static {
    ...
    openapiRequiredFields.add("oldCampaign");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignEditedNotificationItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignEditedNotificationItem is not found in the empty JSON string", CampaignEditedNotificationItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignEditedNotificationItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignEditedNotificationItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
