...
public class PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction.class));

       return (TypeAdapter<T>) new TypeAdapter<PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction>() {
           @Override
           public void write(JsonWriter out, PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction
   * @throws IOException if the JSON string is invalid with respect to PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction
   */
  public static PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction.class);
  }

  /**
   * Convert an instance of PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction to an JSON string
   *
   * @return JSON string
   */
