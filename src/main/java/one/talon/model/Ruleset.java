...
public class Ruleset {
   ...
   * @return the Ruleset instance itself
   */
  public Ruleset putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, ruleset.id) &&
        ...
        Objects.equals(this.additionalProperties, ruleset.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, created, userId, rules, strikethroughRules, bindings, rbVersion, activate, campaignId, templateId, activatedAt, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Ruleset>() {
           ...
           public Ruleset read(JsonReader in) throws IOException {
             ...
             Ruleset instance = thisAdapter.fromJsonTree(jsonObj);
