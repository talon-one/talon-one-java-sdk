...
public class NewUser {
   ...
   * @return the NewUser instance itself
   */
  public NewUser putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, newUser.email) &&
        ...
        Objects.equals(this.additionalProperties, newUser.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, password, name, inviteToken, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NewUser>() {
           ...
           public NewUser read(JsonReader in) throws IOException {
             ...
             NewUser instance = thisAdapter.fromJsonTree(jsonObj);
