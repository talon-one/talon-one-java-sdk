...
public class AddedDeductedPointsBalancesAction {
  ...
  public AddedDeductedPointsBalancesAction amount(@javax.annotation.Nonnull BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public AddedDeductedPointsBalancesAction reason(@javax.annotation.Nonnull String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public AddedDeductedPointsBalancesAction operation(@javax.annotation.Nonnull OperationEnum operation) {
  ...
  public AddedDeductedPointsBalancesAction startDate(@javax.annotation.Nullable OffsetDateTime startDate) {
  ...
  public AddedDeductedPointsBalancesAction expiryDate(@javax.annotation.Nullable OffsetDateTime expiryDate) {
   ...
   * @return the AddedDeductedPointsBalancesAction instance itself
   */
  public AddedDeductedPointsBalancesAction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, addedDeductedPointsBalancesAction.amount) &&
        ...
        Objects.equals(this.additionalProperties, addedDeductedPointsBalancesAction.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, reason, operation, startDate, expiryDate, transactionUUID, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddedDeductedPointsBalancesAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddedDeductedPointsBalancesAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AddedDeductedPointsBalancesAction is not found in the empty JSON string", AddedDeductedPointsBalancesAction.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddedDeductedPointsBalancesAction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddedDeductedPointsBalancesAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddedDeductedPointsBalancesAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddedDeductedPointsBalancesAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddedDeductedPointsBalancesAction.class));

       return (TypeAdapter<T>) new TypeAdapter<AddedDeductedPointsBalancesAction>() {
           @Override
           public void write(JsonWriter out, AddedDeductedPointsBalancesAction value) throws IOException {
           ...
           @Override
           public AddedDeductedPointsBalancesAction read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AddedDeductedPointsBalancesAction instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AddedDeductedPointsBalancesAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddedDeductedPointsBalancesAction
   * @throws IOException if the JSON string is invalid with respect to AddedDeductedPointsBalancesAction
   */
  public static AddedDeductedPointsBalancesAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddedDeductedPointsBalancesAction.class);
  }

  /**
   * Convert an instance of AddedDeductedPointsBalancesAction to an JSON string
   *
   * @return JSON string
   */
