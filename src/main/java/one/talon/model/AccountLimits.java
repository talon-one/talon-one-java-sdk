  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountLimits.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AccountLimits is not found in the empty JSON string", AccountLimits.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("promotionTypes") == null) {
        ...
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `promotionTypes` to be an array in the JSON string but got `%s`", jsonObj.get("promotionTypes").toString()));
      }
