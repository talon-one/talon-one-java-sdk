...
public class EffectSetDiscountPerAdditionalCostPerItem {
  ...
  @javax.annotation.Nonnull
  private SetDiscountPerAdditionalCostPerItemEffectProps props;

  public EffectSetDiscountPerAdditionalCostPerItem() {
  }

  public EffectSetDiscountPerAdditionalCostPerItem experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectSetDiscountPerAdditionalCostPerItem props(@javax.annotation.Nonnull SetDiscountPerAdditionalCostPerItemEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public SetDiscountPerAdditionalCostPerItemEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull SetDiscountPerAdditionalCostPerItemEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectSetDiscountPerAdditionalCostPerItem instance itself
   */
  public EffectSetDiscountPerAdditionalCostPerItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectSetDiscountPerAdditionalCostPerItem effectSetDiscountPerAdditionalCostPerItem = (EffectSetDiscountPerAdditionalCostPerItem) o;
    return Objects.equals(this.experimentId, effectSetDiscountPerAdditionalCostPerItem.experimentId) &&
        Objects.equals(this.campaignId, effectSetDiscountPerAdditionalCostPerItem.campaignId) &&
        Objects.equals(this.rulesetId, effectSetDiscountPerAdditionalCostPerItem.rulesetId) &&
        Objects.equals(this.ruleIndex, effectSetDiscountPerAdditionalCostPerItem.ruleIndex) &&
        Objects.equals(this.ruleName, effectSetDiscountPerAdditionalCostPerItem.ruleName) &&
        Objects.equals(this.effectType, effectSetDiscountPerAdditionalCostPerItem.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectSetDiscountPerAdditionalCostPerItem.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectSetDiscountPerAdditionalCostPerItem.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectSetDiscountPerAdditionalCostPerItem.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectSetDiscountPerAdditionalCostPerItem.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectSetDiscountPerAdditionalCostPerItem.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectSetDiscountPerAdditionalCostPerItem.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectSetDiscountPerAdditionalCostPerItem.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectSetDiscountPerAdditionalCostPerItem.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectSetDiscountPerAdditionalCostPerItem.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectSetDiscountPerAdditionalCostPerItem.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectSetDiscountPerAdditionalCostPerItem.rewardId) &&
        Objects.equals(this.props, effectSetDiscountPerAdditionalCostPerItem.props)&&
        Objects.equals(this.additionalProperties, effectSetDiscountPerAdditionalCostPerItem.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectSetDiscountPerAdditionalCostPerItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectSetDiscountPerAdditionalCostPerItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectSetDiscountPerAdditionalCostPerItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectSetDiscountPerAdditionalCostPerItem is not found in the empty JSON string", EffectSetDiscountPerAdditionalCostPerItem.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectSetDiscountPerAdditionalCostPerItem.openapiRequiredFields) {
      ...
      SetDiscountPerAdditionalCostPerItemEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectSetDiscountPerAdditionalCostPerItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectSetDiscountPerAdditionalCostPerItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectSetDiscountPerAdditionalCostPerItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectSetDiscountPerAdditionalCostPerItem.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectSetDiscountPerAdditionalCostPerItem>() {
           @Override
           public void write(JsonWriter out, EffectSetDiscountPerAdditionalCostPerItem value) throws IOException {
           ...
           @Override
           public EffectSetDiscountPerAdditionalCostPerItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectSetDiscountPerAdditionalCostPerItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectSetDiscountPerAdditionalCostPerItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectSetDiscountPerAdditionalCostPerItem
   * @throws IOException if the JSON string is invalid with respect to EffectSetDiscountPerAdditionalCostPerItem
   */
  public static EffectSetDiscountPerAdditionalCostPerItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectSetDiscountPerAdditionalCostPerItem.class);
  }

  /**
   * Convert an instance of EffectSetDiscountPerAdditionalCostPerItem to an JSON string
   *
   * @return JSON string
   */
