...
public class CampaignTemplate {
  ...
  public CampaignTemplate reevaluateOnReturn(@javax.annotation.Nonnull Boolean reevaluateOnReturn) {
   ...
   * @return the CampaignTemplate instance itself
   */
  public CampaignTemplate putAdditionalProperty(String key, Object value) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created", "accountId", "userId", "name", "description", "instructions", "campaignAttributes", "couponAttributes", "state", "activeRulesetId", "tags", "reevaluateOnReturn", "features", "couponSettings", "couponReservationSettings", "referralSettings", "limits", "templateParams", "applicationsIds", "campaignCollections", "defaultCampaignGroupId", "campaignType", "campaignsCount", "updated", "updatedBy", "validApplicationIds", "isUserFavorite"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "created", "accountId", "userId", "name", "description", "instructions", "state", "reevaluateOnReturn", "applicationsIds", "validApplicationIds"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CampaignTemplate is not found in the empty JSON string", CampaignTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("validApplicationIds") == null) {
        ...
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `validApplicationIds` to be an array in the JSON string but got `%s`", jsonObj.get("validApplicationIds").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignTemplate>() {
           ...
           public CampaignTemplate read(JsonReader in) throws IOException {
             ...
             CampaignTemplate instance = thisAdapter.fromJsonTree(jsonObj);
