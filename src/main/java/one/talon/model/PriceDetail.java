...
public class PriceDetail {
   ...
   * @return the PriceDetail instance itself
   */
  public PriceDetail putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.price, priceDetail.price) &&
        ...
        Objects.equals(this.additionalProperties, priceDetail.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(price, adjustmentContextId, adjustmentReferenceId, adjustmentEffectiveFrom, adjustmentEffectiveUntil, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("price", "adjustmentContextId", "adjustmentReferenceId", "adjustmentEffectiveFrom", "adjustmentEffectiveUntil"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PriceDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PriceDetail is not found in the empty JSON string", PriceDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("adjustmentContextId") != null && !jsonObj.get("adjustmentContextId").isJsonNull()) && !jsonObj.get("adjustmentContextId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `adjustmentContextId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("adjustmentContextId").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PriceDetail>() {
           ...
           public PriceDetail read(JsonReader in) throws IOException {
             ...
             PriceDetail instance = thisAdapter.fromJsonTree(jsonObj);
