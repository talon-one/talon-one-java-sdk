...
public class CustomerSessionV2 {
  ...
  public CustomerSessionV2 rewardIntegrationIds(@javax.annotation.Nullable List<String> rewardIntegrationIds) {
    this.rewardIntegrationIds = rewardIntegrationIds;
    return this;
  }

  public CustomerSessionV2 addRewardIntegrationIdsItem(String rewardIntegrationIdsItem) {
  ...
  public CustomerSessionV2 experimentVariantAllocations(@javax.annotation.Nullable List<ExperimentVariantAllocation> experimentVariantAllocations) {
   ...
   * @return the CustomerSessionV2 instance itself
   */
  public CustomerSessionV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, customerSessionV2.id) &&
        ...
        Objects.equals(this.rewardIntegrationIds, customerSessionV2.rewardIntegrationIds) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, created, integrationId, applicationId, profileId, storeIntegrationId, evaluableCampaignIds, couponCodes, referralCode, loyaltyCards, rewardIntegrationIds, state, cartItems, experimentVariantAllocations, additionalCosts, identifiers, attributes, firstSession, updateCount, total, cartItemTotal, additionalCostTotal, cartItemAdditionalCostTotal, updated, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created", "integrationId", "applicationId", "profileId", "storeIntegrationId", "evaluableCampaignIds", "couponCodes", "referralCode", "loyaltyCards", "rewardIntegrationIds", "state", "cartItems", "experimentVariantAllocations", "additionalCosts", "identifiers", "attributes", "firstSession", "updateCount", "total", "cartItemTotal", "additionalCostTotal", "cartItemAdditionalCostTotal", "updated"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerSessionV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomerSessionV2 is not found in the empty JSON string", CustomerSessionV2.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("couponCodes") != null && !jsonObj.get("couponCodes").isJsonNull() && !jsonObj.get("couponCodes").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `couponCodes` to be an array in the JSON string but got `%s`", jsonObj.get("couponCodes").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerSessionV2>() {
           ...
           public CustomerSessionV2 read(JsonReader in) throws IOException {
             ...
             CustomerSessionV2 instance = thisAdapter.fromJsonTree(jsonObj);
