...
public class NewCampaign {
  ...
  public NewCampaign name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public NewCampaign description(@javax.annotation.Nullable String description) {
  ...
  public NewCampaign startTime(@javax.annotation.Nullable OffsetDateTime startTime) {
  ...
  public NewCampaign endTime(@javax.annotation.Nullable OffsetDateTime endTime) {
  ...
  public NewCampaign attributes(@javax.annotation.Nullable Object attributes) {
  ...
  public NewCampaign state(@javax.annotation.Nonnull StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public NewCampaign activeRulesetId(@javax.annotation.Nullable Long activeRulesetId) {
  ...
  public NewCampaign tags(@javax.annotation.Nonnull List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public NewCampaign reevaluateOnReturn(@javax.annotation.Nullable Boolean reevaluateOnReturn) {
  ...
  public NewCampaign features(@javax.annotation.Nonnull List<FeaturesEnum> features) {
  ...
  public NewCampaign couponSettings(@javax.annotation.Nullable CodeGeneratorSettings couponSettings) {
  ...
  public NewCampaign referralSettings(@javax.annotation.Nullable CodeGeneratorSettings referralSettings) {
  ...
  public NewCampaign limits(@javax.annotation.Nonnull List<LimitConfig> limits) {
    this.limits = limits;
    return this;
  }
  ...
  public NewCampaign campaignGroups(@javax.annotation.Nullable List<Long> campaignGroups) {
  ...
  public NewCampaign type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public NewCampaign linkedStoreIds(@javax.annotation.Nullable List<Long> linkedStoreIds) {
  ...
  public NewCampaign couponAttributes(@javax.annotation.Nullable Object couponAttributes) {
  ...
  public NewCampaign evaluationGroupId(@javax.annotation.Nullable Long evaluationGroupId) {
   ...
   * @return the NewCampaign instance itself
   */
  public NewCampaign putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, newCampaign.name) &&
        ...
        Objects.equals(this.reevaluateOnReturn, newCampaign.reevaluateOnReturn) &&
        ...
        Objects.equals(this.couponAttributes, newCampaign.couponAttributes) &&
        Objects.equals(this.evaluationGroupId, newCampaign.evaluationGroupId)&&
        Objects.equals(this.additionalProperties, newCampaign.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, startTime, endTime, attributes, state, activeRulesetId, tags, reevaluateOnReturn, features, couponSettings, referralSettings, limits, campaignGroups, type, linkedStoreIds, couponAttributes, evaluationGroupId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "startTime", "endTime", "attributes", "state", "activeRulesetId", "tags", "reevaluateOnReturn", "features", "couponSettings", "referralSettings", "limits", "campaignGroups", "type", "linkedStoreIds", "couponAttributes", "evaluationGroupId"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewCampaign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NewCampaign is not found in the empty JSON string", NewCampaign.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<NewCampaign>() {
           @Override
           public void write(JsonWriter out, NewCampaign value) throws IOException {
           ...
           @Override
           public NewCampaign read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             NewCampaign instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of NewCampaign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewCampaign
   * @throws IOException if the JSON string is invalid with respect to NewCampaign
   */
  public static NewCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewCampaign.class);
  }

  /**
   * Convert an instance of NewCampaign to an JSON string
   *
   * @return JSON string
   */
