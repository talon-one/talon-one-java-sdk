...
public class UpdateApplication {
   ...
   * @return the UpdateApplication instance itself
   */
  public UpdateApplication putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateApplication>() {
           ...
           public UpdateApplication read(JsonReader in) throws IOException {
             ...
             UpdateApplication instance = thisAdapter.fromJsonTree(jsonObj);
