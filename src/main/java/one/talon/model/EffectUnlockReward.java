...
import one.talon.model.UnlockRewardEffectProps;
...
public class EffectUnlockReward {
  ...
  @javax.annotation.Nonnull
  private UnlockRewardEffectProps props;

  public EffectUnlockReward() {
  }

  public EffectUnlockReward experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectUnlockReward campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectUnlockReward rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectUnlockReward ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectUnlockReward ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectUnlockReward effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectUnlockReward triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectUnlockReward triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectUnlockReward conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectUnlockReward evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectUnlockReward evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectUnlockReward campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectUnlockReward campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectUnlockReward selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectUnlockReward selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectUnlockReward adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectUnlockReward rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectUnlockReward props(@javax.annotation.Nonnull UnlockRewardEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public UnlockRewardEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull UnlockRewardEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectUnlockReward instance itself
   */
  public EffectUnlockReward putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectUnlockReward effectUnlockReward = (EffectUnlockReward) o;
    return Objects.equals(this.experimentId, effectUnlockReward.experimentId) &&
        Objects.equals(this.campaignId, effectUnlockReward.campaignId) &&
        Objects.equals(this.rulesetId, effectUnlockReward.rulesetId) &&
        Objects.equals(this.ruleIndex, effectUnlockReward.ruleIndex) &&
        Objects.equals(this.ruleName, effectUnlockReward.ruleName) &&
        Objects.equals(this.effectType, effectUnlockReward.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectUnlockReward.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectUnlockReward.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectUnlockReward.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectUnlockReward.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectUnlockReward.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectUnlockReward.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectUnlockReward.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectUnlockReward.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectUnlockReward.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectUnlockReward.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectUnlockReward.rewardId) &&
        Objects.equals(this.props, effectUnlockReward.props)&&
        Objects.equals(this.additionalProperties, effectUnlockReward.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectUnlockReward {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectUnlockReward
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectUnlockReward.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectUnlockReward is not found in the empty JSON string", EffectUnlockReward.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectUnlockReward.openapiRequiredFields) {
      ...
      UnlockRewardEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectUnlockReward.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectUnlockReward' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectUnlockReward> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectUnlockReward.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectUnlockReward>() {
           @Override
           public void write(JsonWriter out, EffectUnlockReward value) throws IOException {
           ...
           @Override
           public EffectUnlockReward read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectUnlockReward instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectUnlockReward given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectUnlockReward
   * @throws IOException if the JSON string is invalid with respect to EffectUnlockReward
   */
  public static EffectUnlockReward fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectUnlockReward.class);
  }

  /**
   * Convert an instance of EffectUnlockReward to an JSON string
   *
   * @return JSON string
   */
