  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookWithOutgoingIntegrationDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WebhookWithOutgoingIntegrationDetails is not found in the empty JSON string", WebhookWithOutgoingIntegrationDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookWithOutgoingIntegrationDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebhookWithOutgoingIntegrationDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("outgoingIntegrationTypeName") != null && !jsonObj.get("outgoingIntegrationTypeName").isJsonNull()) && !jsonObj.get("outgoingIntegrationTypeName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `outgoingIntegrationTypeName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("outgoingIntegrationTypeName").toString()));
      }
  }
