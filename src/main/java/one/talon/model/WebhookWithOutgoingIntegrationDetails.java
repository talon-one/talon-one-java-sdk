...
public class WebhookWithOutgoingIntegrationDetails {
   ...
   * @return the WebhookWithOutgoingIntegrationDetails instance itself
   */
  public WebhookWithOutgoingIntegrationDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webhookWithOutgoingIntegrationDetails.id) &&
        ...
        Objects.equals(this.additionalProperties, webhookWithOutgoingIntegrationDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, created, modified, applicationIds, title, description, draft, verb, url, headers, payload, params, enabled, authenticationId, outgoingIntegrationTemplateId, outgoingIntegrationTypeId, outgoingIntegrationTypeName, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created", "modified", "applicationIds", "title", "description", "draft", "verb", "url", "headers", "payload", "params", "enabled", "authenticationId", "outgoingIntegrationTemplateId", "outgoingIntegrationTypeId", "outgoingIntegrationTypeName"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookWithOutgoingIntegrationDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebhookWithOutgoingIntegrationDetails is not found in the empty JSON string", WebhookWithOutgoingIntegrationDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("outgoingIntegrationTypeName") != null && !jsonObj.get("outgoingIntegrationTypeName").isJsonNull()) && !jsonObj.get("outgoingIntegrationTypeName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `outgoingIntegrationTypeName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("outgoingIntegrationTypeName").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookWithOutgoingIntegrationDetails>() {
           ...
           public WebhookWithOutgoingIntegrationDetails read(JsonReader in) throws IOException {
             ...
             WebhookWithOutgoingIntegrationDetails instance = thisAdapter.fromJsonTree(jsonObj);
