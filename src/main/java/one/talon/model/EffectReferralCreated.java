...
public class EffectReferralCreated {
  ...
  @javax.annotation.Nonnull
  private ReferralCreatedEffectProps props;

  public EffectReferralCreated() {
  }

  public EffectReferralCreated experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectReferralCreated campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectReferralCreated rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectReferralCreated ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectReferralCreated ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectReferralCreated effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectReferralCreated triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectReferralCreated triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectReferralCreated conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectReferralCreated evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectReferralCreated evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectReferralCreated campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectReferralCreated campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectReferralCreated selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectReferralCreated selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectReferralCreated adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectReferralCreated rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectReferralCreated props(@javax.annotation.Nonnull ReferralCreatedEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public ReferralCreatedEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull ReferralCreatedEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectReferralCreated instance itself
   */
  public EffectReferralCreated putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectReferralCreated effectReferralCreated = (EffectReferralCreated) o;
    return Objects.equals(this.experimentId, effectReferralCreated.experimentId) &&
        Objects.equals(this.campaignId, effectReferralCreated.campaignId) &&
        Objects.equals(this.rulesetId, effectReferralCreated.rulesetId) &&
        Objects.equals(this.ruleIndex, effectReferralCreated.ruleIndex) &&
        Objects.equals(this.ruleName, effectReferralCreated.ruleName) &&
        Objects.equals(this.effectType, effectReferralCreated.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectReferralCreated.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectReferralCreated.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectReferralCreated.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectReferralCreated.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectReferralCreated.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectReferralCreated.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectReferralCreated.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectReferralCreated.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectReferralCreated.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectReferralCreated.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectReferralCreated.rewardId) &&
        Objects.equals(this.props, effectReferralCreated.props)&&
        Objects.equals(this.additionalProperties, effectReferralCreated.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectReferralCreated {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectReferralCreated
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectReferralCreated.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectReferralCreated is not found in the empty JSON string", EffectReferralCreated.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectReferralCreated.openapiRequiredFields) {
      ...
      ReferralCreatedEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectReferralCreated.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectReferralCreated' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectReferralCreated> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectReferralCreated.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectReferralCreated>() {
           @Override
           public void write(JsonWriter out, EffectReferralCreated value) throws IOException {
           ...
           @Override
           public EffectReferralCreated read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectReferralCreated instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectReferralCreated given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectReferralCreated
   * @throws IOException if the JSON string is invalid with respect to EffectReferralCreated
   */
  public static EffectReferralCreated fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectReferralCreated.class);
  }

  /**
   * Convert an instance of EffectReferralCreated to an JSON string
   *
   * @return JSON string
   */
