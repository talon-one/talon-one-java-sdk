...
public class CustomerSession {
   ...
   * @return the CustomerSession instance itself
   */
  public CustomerSession putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.integrationId, customerSession.integrationId) &&
        ...
        Objects.equals(this.additionalProperties, customerSession.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(integrationId, created, applicationId, profileId, coupon, referral, state, cartItems, identifiers, total, attributes, firstSession, updateCount, discounts, updated, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomerSession is not found in the empty JSON string", CustomerSession.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerSession>() {
           ...
           public CustomerSession read(JsonReader in) throws IOException {
             ...
             CustomerSession instance = thisAdapter.fromJsonTree(jsonObj);
