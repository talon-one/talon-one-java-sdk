...
public class LedgerInfo {
   ...
   * @return the LedgerInfo instance itself
   */
  public LedgerInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentBalance, ledgerInfo.currentBalance) &&
        ...
        Objects.equals(this.additionalProperties, ledgerInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currentBalance, pendingBalance, negativeBalance, expiredBalance, spentBalance, tentativeCurrentBalance, tentativePendingBalance, tentativeNegativeBalance, currentTier, pointsToNextTier, nextTierName, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LedgerInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LedgerInfo is not found in the empty JSON string", LedgerInfo.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LedgerInfo>() {
           ...
           public LedgerInfo read(JsonReader in) throws IOException {
             ...
             LedgerInfo instance = thisAdapter.fromJsonTree(jsonObj);
