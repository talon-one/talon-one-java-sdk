...
public class NewAttribute {
   ...
   * @return the NewAttribute instance itself
   */
  public NewAttribute putAdditionalProperty(String key, Object value) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entity, eventType, name, title, type, description, suggestions, hasAllowedList, restrictedBySuggestions, editable, subscribedApplicationsIds, subscribedCatalogsIds, allowedSubscriptions, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NewAttribute is not found in the empty JSON string", NewAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("allowedSubscriptions") != null && !jsonObj.get("allowedSubscriptions").isJsonNull() && !jsonObj.get("allowedSubscriptions").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `allowedSubscriptions` to be an array in the JSON string but got `%s`", jsonObj.get("allowedSubscriptions").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NewAttribute>() {
           ...
           public NewAttribute read(JsonReader in) throws IOException {
             ...
             NewAttribute instance = thisAdapter.fromJsonTree(jsonObj);
