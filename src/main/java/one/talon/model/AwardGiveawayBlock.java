...
public class AwardGiveawayBlock {
  ...
  public AwardGiveawayBlock profile(@javax.annotation.Nonnull ProfileEnum profile) {
  ...
  public AwardGiveawayBlock onFailure(@javax.annotation.Nullable List<Object> onFailure) {
    this.onFailure = onFailure;
    return this;
  }

  public AwardGiveawayBlock addOnFailureItem(Object onFailureItem) {
  ...
  public AwardGiveawayBlock onError(@javax.annotation.Nullable Map<String, List<Object>> onError) {
    this.onError = onError;
    return this;
  }

  public AwardGiveawayBlock putOnErrorItem(String key, List<Object> onErrorItem) {
   ...
   * @return the AwardGiveawayBlock instance itself
   */
  public AwardGiveawayBlock putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AwardGiveawayBlock awardGiveawayBlock = (AwardGiveawayBlock) o;
    return Objects.equals(this.id, awardGiveawayBlock.id) &&
        Objects.equals(this.type, awardGiveawayBlock.type) &&
        Objects.equals(this.tags, awardGiveawayBlock.tags) &&
        Objects.equals(this.giveawayPool, awardGiveawayBlock.giveawayPool) &&
        Objects.equals(this.profile, awardGiveawayBlock.profile) &&
        Objects.equals(this.onFailure, awardGiveawayBlock.onFailure) &&
        Objects.equals(this.onError, awardGiveawayBlock.onError)&&
        Objects.equals(this.additionalProperties, awardGiveawayBlock.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, tags, giveawayPool, profile, onFailure, onError, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    giveawayPool: ").append(toIndentedString(giveawayPool)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwardGiveawayBlock
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwardGiveawayBlock.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AwardGiveawayBlock is not found in the empty JSON string", AwardGiveawayBlock.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AwardGiveawayBlock.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwardGiveawayBlock.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwardGiveawayBlock' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwardGiveawayBlock> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwardGiveawayBlock.class));

       return (TypeAdapter<T>) new TypeAdapter<AwardGiveawayBlock>() {
           @Override
           public void write(JsonWriter out, AwardGiveawayBlock value) throws IOException {
           ...
           @Override
           public AwardGiveawayBlock read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AwardGiveawayBlock instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AwardGiveawayBlock given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwardGiveawayBlock
   * @throws IOException if the JSON string is invalid with respect to AwardGiveawayBlock
   */
  public static AwardGiveawayBlock fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwardGiveawayBlock.class);
  }

  /**
   * Convert an instance of AwardGiveawayBlock to an JSON string
   *
   * @return JSON string
   */
