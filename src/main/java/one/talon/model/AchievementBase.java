...
public class AchievementBase {
  ...
  public AchievementBase name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AchievementBase title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public AchievementBase description(@javax.annotation.Nullable String description) {
  ...
  public AchievementBase target(@javax.annotation.Nullable BigDecimal target) {
    this.target = target;
    return this;
  }
  ...
  public AchievementBase period(@javax.annotation.Nullable String period) {
    this.period = period;
    return this;
  }
  ...
  public AchievementBase periodEndOverride(@javax.annotation.Nullable TimePoint periodEndOverride) {
  ...
  public AchievementBase recurrencePolicy(@javax.annotation.Nullable RecurrencePolicyEnum recurrencePolicy) {
  ...
  public AchievementBase activationPolicy(@javax.annotation.Nullable ActivationPolicyEnum activationPolicy) {
  ...
  public AchievementBase fixedStartDate(@javax.annotation.Nullable OffsetDateTime fixedStartDate) {
  ...
  public AchievementBase endDate(@javax.annotation.Nullable OffsetDateTime endDate) {
  ...
  public AchievementBase allowRollbackAfterCompletion(@javax.annotation.Nullable Boolean allowRollbackAfterCompletion) {
  ...
  public boolean equals(Object o) {
    ...
    AchievementBase achievementBase = (AchievementBase) o;
    return Objects.equals(this.name, achievementBase.name) &&
        Objects.equals(this.title, achievementBase.title) &&
        Objects.equals(this.description, achievementBase.description) &&
        Objects.equals(this.target, achievementBase.target) &&
        Objects.equals(this.period, achievementBase.period) &&
        Objects.equals(this.periodEndOverride, achievementBase.periodEndOverride) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to AchievementBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AchievementBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AchievementBase is not found in the empty JSON string", AchievementBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AchievementBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AchievementBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AchievementBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AchievementBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AchievementBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AchievementBase.class));

       return (TypeAdapter<T>) new TypeAdapter<AchievementBase>() {
           @Override
  ...
  /**
   * Create an instance of AchievementBase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AchievementBase
   * @throws IOException if the JSON string is invalid with respect to AchievementBase
   */
  public static AchievementBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AchievementBase.class);
  }

  /**
   * Convert an instance of AchievementBase to an JSON string
   *
   * @return JSON string
   */
