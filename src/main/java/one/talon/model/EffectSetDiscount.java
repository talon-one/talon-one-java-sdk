...
public class EffectSetDiscount {
  ...
  @javax.annotation.Nonnull
  private SetDiscountEffectProps props;

  public EffectSetDiscount() {
  }

  public EffectSetDiscount experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectSetDiscount campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectSetDiscount rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectSetDiscount ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectSetDiscount ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectSetDiscount effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectSetDiscount triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectSetDiscount triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectSetDiscount conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectSetDiscount evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectSetDiscount evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectSetDiscount campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectSetDiscount campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectSetDiscount selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectSetDiscount selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectSetDiscount adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectSetDiscount rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectSetDiscount props(@javax.annotation.Nonnull SetDiscountEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public SetDiscountEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull SetDiscountEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectSetDiscount instance itself
   */
  public EffectSetDiscount putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectSetDiscount effectSetDiscount = (EffectSetDiscount) o;
    return Objects.equals(this.experimentId, effectSetDiscount.experimentId) &&
        Objects.equals(this.campaignId, effectSetDiscount.campaignId) &&
        Objects.equals(this.rulesetId, effectSetDiscount.rulesetId) &&
        Objects.equals(this.ruleIndex, effectSetDiscount.ruleIndex) &&
        Objects.equals(this.ruleName, effectSetDiscount.ruleName) &&
        Objects.equals(this.effectType, effectSetDiscount.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectSetDiscount.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectSetDiscount.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectSetDiscount.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectSetDiscount.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectSetDiscount.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectSetDiscount.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectSetDiscount.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectSetDiscount.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectSetDiscount.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectSetDiscount.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectSetDiscount.rewardId) &&
        Objects.equals(this.props, effectSetDiscount.props)&&
        Objects.equals(this.additionalProperties, effectSetDiscount.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectSetDiscount {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectSetDiscount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectSetDiscount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectSetDiscount is not found in the empty JSON string", EffectSetDiscount.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectSetDiscount.openapiRequiredFields) {
      ...
      SetDiscountEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectSetDiscount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectSetDiscount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectSetDiscount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectSetDiscount.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectSetDiscount>() {
           @Override
           public void write(JsonWriter out, EffectSetDiscount value) throws IOException {
           ...
           @Override
           public EffectSetDiscount read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectSetDiscount instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectSetDiscount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectSetDiscount
   * @throws IOException if the JSON string is invalid with respect to EffectSetDiscount
   */
  public static EffectSetDiscount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectSetDiscount.class);
  }

  /**
   * Convert an instance of EffectSetDiscount to an JSON string
   *
   * @return JSON string
   */
