...
public class GetRulesets200Response {
  ...
  @javax.annotation.Nonnull
  private List<Ruleset> data = new ArrayList<>();

  public GetRulesets200Response() {
  }

  public GetRulesets200Response totalResultSize(@javax.annotation.Nonnull Long totalResultSize) {
  ...
  public GetRulesets200Response data(@javax.annotation.Nonnull List<Ruleset> data) {
    this.data = data;
    return this;
  }

  public GetRulesets200Response addDataItem(Ruleset dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nonnull List<Ruleset> data) {
    this.data = data;
  }
   ...
   * @return the GetRulesets200Response instance itself
   */
  public GetRulesets200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalResultSize, getRulesets200Response.totalResultSize) &&
        Objects.equals(this.data, getRulesets200Response.data)&&
        Objects.equals(this.additionalProperties, getRulesets200Response.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRulesets200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetRulesets200Response is not found in the empty JSON string", GetRulesets200Response.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetRulesets200Response.openapiRequiredFields) {
      ...
      if (jsonObj.get("data") != null) {
        ...
        for (int i = 0; i < jsonArraydata.size(); i++) {
          Ruleset.validateJsonElement(jsonArraydata.get(i));
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetRulesets200Response>() {
           ...
           public GetRulesets200Response read(JsonReader in) throws IOException {
             ...
             GetRulesets200Response instance = thisAdapter.fromJsonTree(jsonObj);
