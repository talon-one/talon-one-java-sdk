...
public class CustomerProfileIntegrationResponseV2 {
  ...
  public CustomerProfileIntegrationResponseV2 campaignEligibility(@javax.annotation.Nullable List<CampaignEligibility> campaignEligibility) {
    this.campaignEligibility = campaignEligibility;
    return this;
  }

  public CustomerProfileIntegrationResponseV2 addCampaignEligibilityItem(CampaignEligibility campaignEligibilityItem) {
  ...
  public CustomerProfileIntegrationResponseV2 rewards(@javax.annotation.Nullable List<RewardWithUnlocks> rewards) {
    this.rewards = rewards;
    return this;
  }

  public CustomerProfileIntegrationResponseV2 addRewardsItem(RewardWithUnlocks rewardsItem) {
   ...
   * @return the CustomerProfileIntegrationResponseV2 instance itself
   */
  public CustomerProfileIntegrationResponseV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customerProfile, customerProfileIntegrationResponseV2.customerProfile) &&
        ...
        Objects.equals(this.campaignEligibility, customerProfileIntegrationResponseV2.campaignEligibility) &&
        Objects.equals(this.awardedGiveaways, customerProfileIntegrationResponseV2.awardedGiveaways) &&
        Objects.equals(this.rewards, customerProfileIntegrationResponseV2.rewards) &&
        ...
        Objects.equals(this.additionalProperties, customerProfileIntegrationResponseV2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customerProfile, event, loyalty, triggeredCampaigns, ruleFailureReasons, campaignEligibility, awardedGiveaways, rewards, effects, createdCoupons, createdReferrals, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("customerProfile", "event", "loyalty", "triggeredCampaigns", "ruleFailureReasons", "campaignEligibility", "awardedGiveaways", "rewards", "effects", "createdCoupons", "createdReferrals"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerProfileIntegrationResponseV2>() {
           ...
           public CustomerProfileIntegrationResponseV2 read(JsonReader in) throws IOException {
             ...
             CustomerProfileIntegrationResponseV2 instance = thisAdapter.fromJsonTree(jsonObj);
