...
public class UpdateAchievement {
   ...
   * @return the UpdateAchievement instance itself
   */
  public UpdateAchievement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateAchievement.name) &&
        ...
        Objects.equals(this.additionalProperties, updateAchievement.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAchievement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateAchievement is not found in the empty JSON string", UpdateAchievement.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateAchievement>() {
           ...
           public UpdateAchievement read(JsonReader in) throws IOException {
             ...
             UpdateAchievement instance = thisAdapter.fromJsonTree(jsonObj);
