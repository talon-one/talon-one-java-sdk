...
public class EffectRollbackCoupon {
  ...
  @javax.annotation.Nonnull
  private RollbackCouponEffectProps props;

  public EffectRollbackCoupon() {
  }

  public EffectRollbackCoupon experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectRollbackCoupon campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectRollbackCoupon rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectRollbackCoupon ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectRollbackCoupon ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectRollbackCoupon effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectRollbackCoupon triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectRollbackCoupon triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectRollbackCoupon conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectRollbackCoupon evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectRollbackCoupon evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectRollbackCoupon campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectRollbackCoupon campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectRollbackCoupon selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectRollbackCoupon selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectRollbackCoupon adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectRollbackCoupon rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectRollbackCoupon props(@javax.annotation.Nonnull RollbackCouponEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RollbackCouponEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull RollbackCouponEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectRollbackCoupon instance itself
   */
  public EffectRollbackCoupon putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectRollbackCoupon effectRollbackCoupon = (EffectRollbackCoupon) o;
    return Objects.equals(this.experimentId, effectRollbackCoupon.experimentId) &&
        Objects.equals(this.campaignId, effectRollbackCoupon.campaignId) &&
        Objects.equals(this.rulesetId, effectRollbackCoupon.rulesetId) &&
        Objects.equals(this.ruleIndex, effectRollbackCoupon.ruleIndex) &&
        Objects.equals(this.ruleName, effectRollbackCoupon.ruleName) &&
        Objects.equals(this.effectType, effectRollbackCoupon.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectRollbackCoupon.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectRollbackCoupon.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectRollbackCoupon.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectRollbackCoupon.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectRollbackCoupon.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectRollbackCoupon.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectRollbackCoupon.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectRollbackCoupon.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectRollbackCoupon.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectRollbackCoupon.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectRollbackCoupon.rewardId) &&
        Objects.equals(this.props, effectRollbackCoupon.props)&&
        Objects.equals(this.additionalProperties, effectRollbackCoupon.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectRollbackCoupon
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectRollbackCoupon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectRollbackCoupon is not found in the empty JSON string", EffectRollbackCoupon.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectRollbackCoupon.openapiRequiredFields) {
      ...
      RollbackCouponEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectRollbackCoupon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectRollbackCoupon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectRollbackCoupon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectRollbackCoupon.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectRollbackCoupon>() {
           @Override
           public void write(JsonWriter out, EffectRollbackCoupon value) throws IOException {
           ...
           @Override
           public EffectRollbackCoupon read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectRollbackCoupon instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectRollbackCoupon given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectRollbackCoupon
   * @throws IOException if the JSON string is invalid with respect to EffectRollbackCoupon
   */
  public static EffectRollbackCoupon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectRollbackCoupon.class);
  }

  /**
   * Convert an instance of EffectRollbackCoupon to an JSON string
   *
   * @return JSON string
   */
