...
public class CardAddedDeductedPointsNotification {
  ...
  static {
    ...
    openapiFields.add("ProfileIntegrationIDs");
    ...
    openapiRequiredFields.add("ProfileIntegrationIDs");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CardAddedDeductedPointsNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardAddedDeductedPointsNotification is not found in the empty JSON string", CardAddedDeductedPointsNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CardAddedDeductedPointsNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CardAddedDeductedPointsNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("ProfileIntegrationIDs") == null) {
        ...
        throw new IllegalArgumentException(String.format("Expected the field `ProfileIntegrationIDs` to be an array in the JSON string but got `%s`", jsonObj.get("ProfileIntegrationIDs").toString()));
      }
