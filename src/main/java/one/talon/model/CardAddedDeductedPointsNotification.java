...
public class CardAddedDeductedPointsNotification {
  ...
  public CardAddedDeductedPointsNotification transactionUUID(@javax.annotation.Nonnull UUID transactionUUID) {
   ...
   * @return the CardAddedDeductedPointsNotification instance itself
   */
  public CardAddedDeductedPointsNotification putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cardIdentifier, cardAddedDeductedPointsNotification.cardIdentifier) &&
        ...
        Objects.equals(this.transactionUUID, cardAddedDeductedPointsNotification.transactionUUID)&&
        Objects.equals(this.additionalProperties, cardAddedDeductedPointsNotification.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cardIdentifier, employeeName, loyaltyProgramID, notificationType, profileIntegrationIDs, sessionIntegrationID, subledgerID, typeOfChange, userID, usersPerCardLimit, amount, expiryDate, operation, reason, startDate, transactionUUID, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("CardIdentifier", "EmployeeName", "LoyaltyProgramID", "NotificationType", "ProfileIntegrationIDs", "SessionIntegrationID", "SubledgerID", "TypeOfChange", "UserID", "UsersPerCardLimit", "Amount", "ExpiryDate", "Operation", "Reason", "StartDate", "TransactionUUID"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("CardIdentifier", "EmployeeName", "LoyaltyProgramID", "NotificationType", "ProfileIntegrationIDs", "SessionIntegrationID", "SubledgerID", "TypeOfChange", "UserID", "UsersPerCardLimit", "Amount", "Operation", "Reason", "TransactionUUID"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CardAddedDeductedPointsNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CardAddedDeductedPointsNotification is not found in the empty JSON string", CardAddedDeductedPointsNotification.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CardAddedDeductedPointsNotification>() {
           ...
           public CardAddedDeductedPointsNotification read(JsonReader in) throws IOException {
             ...
             CardAddedDeductedPointsNotification instance = thisAdapter.fromJsonTree(jsonObj);
