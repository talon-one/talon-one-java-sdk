...
public class BestPriorTarget {
   ...
   * @return the BestPriorTarget instance itself
   */
  public BestPriorTarget putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.targetType, bestPriorTarget.targetType) &&
        ...
        Objects.equals(this.additionalProperties, bestPriorTarget.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(targetType, audienceID, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BestPriorTarget>() {
           ...
           public BestPriorTarget read(JsonReader in) throws IOException {
             ...
             BestPriorTarget instance = thisAdapter.fromJsonTree(jsonObj);
