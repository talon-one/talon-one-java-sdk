...
public class TalangAttribute {
  ...
  static {
    ...
    openapiRequiredFields.add("campaignsCount");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TalangAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TalangAttribute is not found in the empty JSON string", TalangAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TalangAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TalangAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("exampleValue") != null && !jsonObj.get("exampleValue").isJsonNull() && !jsonObj.get("exampleValue").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `exampleValue` to be an array in the JSON string but got `%s`", jsonObj.get("exampleValue").toString()));
      }
  }
