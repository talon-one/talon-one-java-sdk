...
public class EffectRollbackAddedLoyaltyPoints {
  ...
  @javax.annotation.Nonnull
  private RollbackAddedLoyaltyPointsEffectProps props;

  public EffectRollbackAddedLoyaltyPoints() {
  }

  public EffectRollbackAddedLoyaltyPoints experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectRollbackAddedLoyaltyPoints campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectRollbackAddedLoyaltyPoints rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectRollbackAddedLoyaltyPoints ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectRollbackAddedLoyaltyPoints ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectRollbackAddedLoyaltyPoints effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectRollbackAddedLoyaltyPoints triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectRollbackAddedLoyaltyPoints triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectRollbackAddedLoyaltyPoints conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectRollbackAddedLoyaltyPoints evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectRollbackAddedLoyaltyPoints evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectRollbackAddedLoyaltyPoints campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectRollbackAddedLoyaltyPoints campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectRollbackAddedLoyaltyPoints selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectRollbackAddedLoyaltyPoints selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectRollbackAddedLoyaltyPoints adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectRollbackAddedLoyaltyPoints rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectRollbackAddedLoyaltyPoints props(@javax.annotation.Nonnull RollbackAddedLoyaltyPointsEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RollbackAddedLoyaltyPointsEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull RollbackAddedLoyaltyPointsEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectRollbackAddedLoyaltyPoints instance itself
   */
  public EffectRollbackAddedLoyaltyPoints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectRollbackAddedLoyaltyPoints effectRollbackAddedLoyaltyPoints = (EffectRollbackAddedLoyaltyPoints) o;
    return Objects.equals(this.experimentId, effectRollbackAddedLoyaltyPoints.experimentId) &&
        Objects.equals(this.campaignId, effectRollbackAddedLoyaltyPoints.campaignId) &&
        Objects.equals(this.rulesetId, effectRollbackAddedLoyaltyPoints.rulesetId) &&
        Objects.equals(this.ruleIndex, effectRollbackAddedLoyaltyPoints.ruleIndex) &&
        Objects.equals(this.ruleName, effectRollbackAddedLoyaltyPoints.ruleName) &&
        Objects.equals(this.effectType, effectRollbackAddedLoyaltyPoints.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectRollbackAddedLoyaltyPoints.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectRollbackAddedLoyaltyPoints.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectRollbackAddedLoyaltyPoints.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectRollbackAddedLoyaltyPoints.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectRollbackAddedLoyaltyPoints.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectRollbackAddedLoyaltyPoints.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectRollbackAddedLoyaltyPoints.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectRollbackAddedLoyaltyPoints.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectRollbackAddedLoyaltyPoints.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectRollbackAddedLoyaltyPoints.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectRollbackAddedLoyaltyPoints.rewardId) &&
        Objects.equals(this.props, effectRollbackAddedLoyaltyPoints.props)&&
        Objects.equals(this.additionalProperties, effectRollbackAddedLoyaltyPoints.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectRollbackAddedLoyaltyPoints {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectRollbackAddedLoyaltyPoints
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectRollbackAddedLoyaltyPoints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectRollbackAddedLoyaltyPoints is not found in the empty JSON string", EffectRollbackAddedLoyaltyPoints.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectRollbackAddedLoyaltyPoints.openapiRequiredFields) {
      ...
      RollbackAddedLoyaltyPointsEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectRollbackAddedLoyaltyPoints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectRollbackAddedLoyaltyPoints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectRollbackAddedLoyaltyPoints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectRollbackAddedLoyaltyPoints.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectRollbackAddedLoyaltyPoints>() {
           @Override
           public void write(JsonWriter out, EffectRollbackAddedLoyaltyPoints value) throws IOException {
           ...
           @Override
           public EffectRollbackAddedLoyaltyPoints read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectRollbackAddedLoyaltyPoints instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectRollbackAddedLoyaltyPoints given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectRollbackAddedLoyaltyPoints
   * @throws IOException if the JSON string is invalid with respect to EffectRollbackAddedLoyaltyPoints
   */
  public static EffectRollbackAddedLoyaltyPoints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectRollbackAddedLoyaltyPoints.class);
  }

  /**
   * Convert an instance of EffectRollbackAddedLoyaltyPoints to an JSON string
   *
   * @return JSON string
   */
