...
public class UpdateAchievementV2 {
   ...
   * @return the UpdateAchievementV2 instance itself
   */
  public UpdateAchievementV2 putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateAchievementV2>() {
           ...
           public UpdateAchievementV2 read(JsonReader in) throws IOException {
             ...
             UpdateAchievementV2 instance = thisAdapter.fromJsonTree(jsonObj);
