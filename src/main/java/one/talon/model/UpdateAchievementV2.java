...
public class UpdateAchievementV2 {
  ...
  public UpdateAchievementV2 period(@javax.annotation.Nullable String period) {
    this.period = period;
    return this;
  }
  ...
  public UpdateAchievementV2 recurrencePolicy(@javax.annotation.Nullable RecurrencePolicyEnum recurrencePolicy) {
  ...
  public UpdateAchievementV2 activationPolicy(@javax.annotation.Nullable ActivationPolicyEnum activationPolicy) {
  ...
  public UpdateAchievementV2 fixedStartDate(@javax.annotation.Nullable OffsetDateTime fixedStartDate) {
  ...
  public UpdateAchievementV2 endDate(@javax.annotation.Nullable OffsetDateTime endDate) {
  ...
  public UpdateAchievementV2 allowRollbackAfterCompletion(@javax.annotation.Nullable Boolean allowRollbackAfterCompletion) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAchievementV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAchievementV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAchievementV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateAchievementV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAchievementV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAchievementV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAchievementV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAchievementV2.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAchievementV2>() {
           @Override
           public void write(JsonWriter out, UpdateAchievementV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAchievementV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAchievementV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAchievementV2
   * @throws IOException if the JSON string is invalid with respect to UpdateAchievementV2
   */
  public static UpdateAchievementV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAchievementV2.class);
  }

  /**
   * Convert an instance of UpdateAchievementV2 to an JSON string
   *
   * @return JSON string
   */
