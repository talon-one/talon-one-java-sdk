...
public class EffectRejectCoupon {
  ...
  @javax.annotation.Nonnull
  private RejectCouponEffectProps props;

  public EffectRejectCoupon() {
  }

  public EffectRejectCoupon experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectRejectCoupon campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectRejectCoupon rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectRejectCoupon ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectRejectCoupon ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectRejectCoupon effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectRejectCoupon triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectRejectCoupon triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectRejectCoupon conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectRejectCoupon evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectRejectCoupon evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectRejectCoupon campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectRejectCoupon campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectRejectCoupon selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectRejectCoupon selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectRejectCoupon adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectRejectCoupon rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectRejectCoupon props(@javax.annotation.Nonnull RejectCouponEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RejectCouponEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull RejectCouponEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectRejectCoupon instance itself
   */
  public EffectRejectCoupon putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectRejectCoupon effectRejectCoupon = (EffectRejectCoupon) o;
    return Objects.equals(this.experimentId, effectRejectCoupon.experimentId) &&
        Objects.equals(this.campaignId, effectRejectCoupon.campaignId) &&
        Objects.equals(this.rulesetId, effectRejectCoupon.rulesetId) &&
        Objects.equals(this.ruleIndex, effectRejectCoupon.ruleIndex) &&
        Objects.equals(this.ruleName, effectRejectCoupon.ruleName) &&
        Objects.equals(this.effectType, effectRejectCoupon.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectRejectCoupon.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectRejectCoupon.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectRejectCoupon.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectRejectCoupon.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectRejectCoupon.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectRejectCoupon.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectRejectCoupon.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectRejectCoupon.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectRejectCoupon.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectRejectCoupon.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectRejectCoupon.rewardId) &&
        Objects.equals(this.props, effectRejectCoupon.props)&&
        Objects.equals(this.additionalProperties, effectRejectCoupon.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectRejectCoupon {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectRejectCoupon
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectRejectCoupon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectRejectCoupon is not found in the empty JSON string", EffectRejectCoupon.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectRejectCoupon.openapiRequiredFields) {
      ...
      RejectCouponEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectRejectCoupon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectRejectCoupon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectRejectCoupon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectRejectCoupon.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectRejectCoupon>() {
           @Override
           public void write(JsonWriter out, EffectRejectCoupon value) throws IOException {
           ...
           @Override
           public EffectRejectCoupon read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectRejectCoupon instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectRejectCoupon given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectRejectCoupon
   * @throws IOException if the JSON string is invalid with respect to EffectRejectCoupon
   */
  public static EffectRejectCoupon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectRejectCoupon.class);
  }

  /**
   * Convert an instance of EffectRejectCoupon to an JSON string
   *
   * @return JSON string
   */
