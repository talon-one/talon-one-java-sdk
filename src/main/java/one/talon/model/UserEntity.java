...
public class UserEntity {
  ...
  public UserEntity userId(@javax.annotation.Nonnull Long userId) {
    this.userId = userId;
    return this;
  }
   ...
   * @return the UserEntity instance itself
   */
  public UserEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userId, userEntity.userId)&&
        Objects.equals(this.additionalProperties, userEntity.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserEntity is not found in the empty JSON string", UserEntity.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserEntity.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserEntity>() {
           ...
           public UserEntity read(JsonReader in) throws IOException {
             ...
             UserEntity instance = thisAdapter.fromJsonTree(jsonObj);
