...
public class PendingActivePointsData {
   ...
   * @return the PendingActivePointsData instance itself
   */
  public PendingActivePointsData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.loyaltyProgramID, pendingActivePointsData.loyaltyProgramID) &&
        ...
        Objects.equals(this.additionalProperties, pendingActivePointsData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loyaltyProgramID, subledgerID, customerProfileID, points, activeOn, expireOn, sessionIntegrationID, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PendingActivePointsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PendingActivePointsData is not found in the empty JSON string", PendingActivePointsData.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PendingActivePointsData>() {
           ...
           public PendingActivePointsData read(JsonReader in) throws IOException {
             ...
             PendingActivePointsData instance = thisAdapter.fromJsonTree(jsonObj);
