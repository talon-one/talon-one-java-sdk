...
public class IntegrationHubEventPayloadLoyaltyProfileBasedNotification {
  ...
  public IntegrationHubEventPayloadLoyaltyProfileBasedNotification loyaltyProgramName(@javax.annotation.Nonnull String loyaltyProgramName) {
  ...
  public IntegrationHubEventPayloadLoyaltyProfileBasedNotification currentTier(@javax.annotation.Nonnull String currentTier) {
  ...
  public IntegrationHubEventPayloadLoyaltyProfileBasedNotification actions(@javax.annotation.Nullable List<IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction> actions) {
  ...
  public void setActions(@javax.annotation.Nullable List<IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction> actions) {
    this.actions = actions;
  }
   ...
   * @return the IntegrationHubEventPayloadLoyaltyProfileBasedNotification instance itself
   */
  public IntegrationHubEventPayloadLoyaltyProfileBasedNotification putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.profileIntegrationID, integrationHubEventPayloadLoyaltyProfileBasedNotification.profileIntegrationID) &&
        ...
        Objects.equals(this.loyaltyProgramName, integrationHubEventPayloadLoyaltyProfileBasedNotification.loyaltyProgramName) &&
        ...
        Objects.equals(this.additionalProperties, integrationHubEventPayloadLoyaltyProfileBasedNotification.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(profileIntegrationID, loyaltyProgramID, loyaltyProgramName, subledgerID, sourceOfEvent, currentTier, employeeName, userID, currentPoints, actions, publishedAt, oldTier, tierExpirationDate, timestampOfTierChange, pointsRequiredToTheNextTier, nextTier, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ProfileIntegrationID", "LoyaltyProgramID", "LoyaltyProgramName", "SubledgerID", "SourceOfEvent", "CurrentTier", "EmployeeName", "UserID", "CurrentPoints", "Actions", "PublishedAt", "OldTier", "TierExpirationDate", "TimestampOfTierChange", "PointsRequiredToTheNextTier", "NextTier"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<IntegrationHubEventPayloadLoyaltyProfileBasedNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntegrationHubEventPayloadLoyaltyProfileBasedNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<IntegrationHubEventPayloadLoyaltyProfileBasedNotification>() {
           @Override
           ...
           public IntegrationHubEventPayloadLoyaltyProfileBasedNotification read(JsonReader in) throws IOException {
             ...
             IntegrationHubEventPayloadLoyaltyProfileBasedNotification instance = thisAdapter.fromJsonTree(jsonObj);
