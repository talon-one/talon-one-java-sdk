...
public class WillAwardGiveawayEffectProps {
   ...
   * @return the WillAwardGiveawayEffectProps instance itself
   */
  public WillAwardGiveawayEffectProps putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.poolId, willAwardGiveawayEffectProps.poolId) &&
        ...
        Objects.equals(this.additionalProperties, willAwardGiveawayEffectProps.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(poolId, poolName, recipientIntegrationId, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WillAwardGiveawayEffectProps.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WillAwardGiveawayEffectProps is not found in the empty JSON string", WillAwardGiveawayEffectProps.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WillAwardGiveawayEffectProps>() {
           ...
           public WillAwardGiveawayEffectProps read(JsonReader in) throws IOException {
             ...
             WillAwardGiveawayEffectProps instance = thisAdapter.fromJsonTree(jsonObj);
