...
public class UpdateLoyaltyProgram {
  ...
  public UpdateLoyaltyProgram title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public UpdateLoyaltyProgram description(@javax.annotation.Nullable String description) {
  ...
  public UpdateLoyaltyProgram subscribedApplications(@javax.annotation.Nullable List<Long> subscribedApplications) {
    this.subscribedApplications = subscribedApplications;
    return this;
  }

  public UpdateLoyaltyProgram addSubscribedApplicationsItem(Long subscribedApplicationsItem) {
  ...
  public UpdateLoyaltyProgram defaultValidity(@javax.annotation.Nullable String defaultValidity) {
  ...
  public UpdateLoyaltyProgram defaultPending(@javax.annotation.Nullable String defaultPending) {
  ...
  public UpdateLoyaltyProgram allowSubledger(@javax.annotation.Nullable Boolean allowSubledger) {
  ...
  public UpdateLoyaltyProgram usersPerCardLimit(@javax.annotation.Nullable Long usersPerCardLimit) {
  ...
  public UpdateLoyaltyProgram sandbox(@javax.annotation.Nullable Boolean sandbox) {
  ...
  public UpdateLoyaltyProgram programJoinPolicy(@javax.annotation.Nullable ProgramJoinPolicyEnum programJoinPolicy) {
  ...
  public UpdateLoyaltyProgram tiersExpirationPolicy(@javax.annotation.Nullable TiersExpirationPolicyEnum tiersExpirationPolicy) {
  ...
  public UpdateLoyaltyProgram tierCycleStartDate(@javax.annotation.Nullable OffsetDateTime tierCycleStartDate) {
  ...
  public UpdateLoyaltyProgram tiersExpireIn(@javax.annotation.Nullable String tiersExpireIn) {
  ...
  public UpdateLoyaltyProgram tiersDowngradePolicy(@javax.annotation.Nullable TiersDowngradePolicyEnum tiersDowngradePolicy) {
  ...
  public UpdateLoyaltyProgram cardCodeSettings(@javax.annotation.Nullable CodeGeneratorSettings cardCodeSettings) {
  ...
  public UpdateLoyaltyProgram returnPolicy(@javax.annotation.Nullable ReturnPolicyEnum returnPolicy) {
  ...
  public UpdateLoyaltyProgram tiers(@javax.annotation.Nullable List<NewLoyaltyTier> tiers) {
    this.tiers = tiers;
    return this;
  }
   ...
   * @return the UpdateLoyaltyProgram instance itself
   */
  public UpdateLoyaltyProgram putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, updateLoyaltyProgram.title) &&
        ...
        Objects.equals(this.additionalProperties, updateLoyaltyProgram.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, subscribedApplications, defaultValidity, defaultPending, allowSubledger, usersPerCardLimit, sandbox, programJoinPolicy, tiersExpirationPolicy, tierCycleStartDate, tiersExpireIn, tiersDowngradePolicy, cardCodeSettings, returnPolicy, tiers, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("title", "description", "subscribedApplications", "defaultValidity", "defaultPending", "allowSubledger", "usersPerCardLimit", "sandbox", "programJoinPolicy", "tiersExpirationPolicy", "tierCycleStartDate", "tiersExpireIn", "tiersDowngradePolicy", "cardCodeSettings", "returnPolicy", "tiers"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateLoyaltyProgram
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateLoyaltyProgram.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateLoyaltyProgram is not found in the empty JSON string", UpdateLoyaltyProgram.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateLoyaltyProgram.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateLoyaltyProgram' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateLoyaltyProgram> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateLoyaltyProgram.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateLoyaltyProgram>() {
           @Override
           public void write(JsonWriter out, UpdateLoyaltyProgram value) throws IOException {
           ...
           @Override
           public UpdateLoyaltyProgram read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdateLoyaltyProgram instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UpdateLoyaltyProgram given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateLoyaltyProgram
   * @throws IOException if the JSON string is invalid with respect to UpdateLoyaltyProgram
   */
  public static UpdateLoyaltyProgram fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateLoyaltyProgram.class);
  }

  /**
   * Convert an instance of UpdateLoyaltyProgram to an JSON string
   *
   * @return JSON string
   */
