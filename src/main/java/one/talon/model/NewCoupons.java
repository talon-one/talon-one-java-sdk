...
public class NewCoupons {
   ...
   * @return the NewCoupons instance itself
   */
  public NewCoupons putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NewCoupons>() {
           ...
           public NewCoupons read(JsonReader in) throws IOException {
             ...
             NewCoupons instance = thisAdapter.fromJsonTree(jsonObj);
