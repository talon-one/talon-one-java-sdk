...
public class LibraryAttribute {
   ...
   * @return the LibraryAttribute instance itself
   */
  public LibraryAttribute putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entity, libraryAttribute.entity) &&
        ...
        Objects.equals(this.additionalProperties, libraryAttribute.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(entity, name, title, type, description, presets, suggestions, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LibraryAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LibraryAttribute is not found in the empty JSON string", LibraryAttribute.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LibraryAttribute>() {
           ...
           public LibraryAttribute read(JsonReader in) throws IOException {
             ...
             LibraryAttribute instance = thisAdapter.fromJsonTree(jsonObj);
