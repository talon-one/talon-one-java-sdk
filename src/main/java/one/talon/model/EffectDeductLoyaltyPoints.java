...
public class EffectDeductLoyaltyPoints {
  ...
  @javax.annotation.Nonnull
  private DeductLoyaltyPointsEffectProps props;

  public EffectDeductLoyaltyPoints() {
  }

  public EffectDeductLoyaltyPoints experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectDeductLoyaltyPoints campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectDeductLoyaltyPoints rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectDeductLoyaltyPoints ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectDeductLoyaltyPoints ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectDeductLoyaltyPoints triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectDeductLoyaltyPoints triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectDeductLoyaltyPoints conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectDeductLoyaltyPoints evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectDeductLoyaltyPoints evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectDeductLoyaltyPoints campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectDeductLoyaltyPoints campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectDeductLoyaltyPoints selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectDeductLoyaltyPoints selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectDeductLoyaltyPoints adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectDeductLoyaltyPoints rewardId(@javax.annotation.Nullable Long rewardId) {
   ...
   */
  @javax.annotation.Nonnull
  public DeductLoyaltyPointsEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull DeductLoyaltyPointsEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectDeductLoyaltyPoints instance itself
   */
  public EffectDeductLoyaltyPoints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectDeductLoyaltyPoints effectDeductLoyaltyPoints = (EffectDeductLoyaltyPoints) o;
    return Objects.equals(this.experimentId, effectDeductLoyaltyPoints.experimentId) &&
        Objects.equals(this.campaignId, effectDeductLoyaltyPoints.campaignId) &&
        ...
        Objects.equals(this.evaluationGroupID, effectDeductLoyaltyPoints.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectDeductLoyaltyPoints.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectDeductLoyaltyPoints.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectDeductLoyaltyPoints.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectDeductLoyaltyPoints.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectDeductLoyaltyPoints.selectedPrice) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectDeductLoyaltyPoints
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectDeductLoyaltyPoints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectDeductLoyaltyPoints is not found in the empty JSON string", EffectDeductLoyaltyPoints.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectDeductLoyaltyPoints.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectDeductLoyaltyPoints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectDeductLoyaltyPoints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectDeductLoyaltyPoints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectDeductLoyaltyPoints.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectDeductLoyaltyPoints>() {
           @Override
           public void write(JsonWriter out, EffectDeductLoyaltyPoints value) throws IOException {
           ...
           @Override
           public EffectDeductLoyaltyPoints read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectDeductLoyaltyPoints instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectDeductLoyaltyPoints given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectDeductLoyaltyPoints
   * @throws IOException if the JSON string is invalid with respect to EffectDeductLoyaltyPoints
   */
  public static EffectDeductLoyaltyPoints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectDeductLoyaltyPoints.class);
  }

  /**
   * Convert an instance of EffectDeductLoyaltyPoints to an JSON string
   *
   * @return JSON string
   */
