...
public class PromotionGroupBlock {
  ...
  public PromotionGroupBlock id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public PromotionGroupBlock type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public PromotionGroupBlock tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PromotionGroupBlock addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public PromotionGroupBlock operator(@javax.annotation.Nonnull OperatorEnum operator) {
   ...
   * @return the PromotionGroupBlock instance itself
   */
  public PromotionGroupBlock putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PromotionGroupBlock promotionGroupBlock = (PromotionGroupBlock) o;
    return Objects.equals(this.id, promotionGroupBlock.id) &&
        Objects.equals(this.type, promotionGroupBlock.type) &&
        Objects.equals(this.tags, promotionGroupBlock.tags) &&
        Objects.equals(this.operator, promotionGroupBlock.operator) &&
        Objects.equals(this.blocks, promotionGroupBlock.blocks) &&
        Objects.equals(this.onFailure, promotionGroupBlock.onFailure) &&
        Objects.equals(this.onError, promotionGroupBlock.onError)&&
        Objects.equals(this.additionalProperties, promotionGroupBlock.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PromotionGroupBlock
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromotionGroupBlock.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromotionGroupBlock is not found in the empty JSON string", PromotionGroupBlock.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PromotionGroupBlock.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PromotionGroupBlock.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PromotionGroupBlock' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PromotionGroupBlock> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PromotionGroupBlock.class));

       return (TypeAdapter<T>) new TypeAdapter<PromotionGroupBlock>() {
           @Override
           public void write(JsonWriter out, PromotionGroupBlock value) throws IOException {
           ...
           @Override
           public PromotionGroupBlock read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PromotionGroupBlock instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PromotionGroupBlock given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PromotionGroupBlock
   * @throws IOException if the JSON string is invalid with respect to PromotionGroupBlock
   */
  public static PromotionGroupBlock fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PromotionGroupBlock.class);
  }

  /**
   * Convert an instance of PromotionGroupBlock to an JSON string
   *
   * @return JSON string
   */
