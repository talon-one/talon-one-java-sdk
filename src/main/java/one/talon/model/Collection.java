...
public class Collection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, created, accountId, modified, description, subscribedApplicationsIds, name, modifiedBy, createdBy, applicationId, campaignId, payload, additionalProperties);
  }
