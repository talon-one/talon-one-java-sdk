...
public class EffectStartAchievementProgress {
  ...
  @javax.annotation.Nonnull
  private StartAchievementProgressEffectProps props;

  public EffectStartAchievementProgress() {
  }

  public EffectStartAchievementProgress experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectStartAchievementProgress campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectStartAchievementProgress rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectStartAchievementProgress ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectStartAchievementProgress ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectStartAchievementProgress effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectStartAchievementProgress triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectStartAchievementProgress triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectStartAchievementProgress conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectStartAchievementProgress evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectStartAchievementProgress evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectStartAchievementProgress campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectStartAchievementProgress campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectStartAchievementProgress selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectStartAchievementProgress selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectStartAchievementProgress adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectStartAchievementProgress rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectStartAchievementProgress props(@javax.annotation.Nonnull StartAchievementProgressEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public StartAchievementProgressEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull StartAchievementProgressEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectStartAchievementProgress instance itself
   */
  public EffectStartAchievementProgress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectStartAchievementProgress effectStartAchievementProgress = (EffectStartAchievementProgress) o;
    return Objects.equals(this.experimentId, effectStartAchievementProgress.experimentId) &&
        Objects.equals(this.campaignId, effectStartAchievementProgress.campaignId) &&
        Objects.equals(this.rulesetId, effectStartAchievementProgress.rulesetId) &&
        Objects.equals(this.ruleIndex, effectStartAchievementProgress.ruleIndex) &&
        Objects.equals(this.ruleName, effectStartAchievementProgress.ruleName) &&
        Objects.equals(this.effectType, effectStartAchievementProgress.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectStartAchievementProgress.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectStartAchievementProgress.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectStartAchievementProgress.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectStartAchievementProgress.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectStartAchievementProgress.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectStartAchievementProgress.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectStartAchievementProgress.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectStartAchievementProgress.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectStartAchievementProgress.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectStartAchievementProgress.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectStartAchievementProgress.rewardId) &&
        Objects.equals(this.props, effectStartAchievementProgress.props)&&
        Objects.equals(this.additionalProperties, effectStartAchievementProgress.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectStartAchievementProgress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectStartAchievementProgress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectStartAchievementProgress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectStartAchievementProgress is not found in the empty JSON string", EffectStartAchievementProgress.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectStartAchievementProgress.openapiRequiredFields) {
      ...
      StartAchievementProgressEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectStartAchievementProgress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectStartAchievementProgress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectStartAchievementProgress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectStartAchievementProgress.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectStartAchievementProgress>() {
           @Override
           public void write(JsonWriter out, EffectStartAchievementProgress value) throws IOException {
           ...
           @Override
           public EffectStartAchievementProgress read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectStartAchievementProgress instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectStartAchievementProgress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectStartAchievementProgress
   * @throws IOException if the JSON string is invalid with respect to EffectStartAchievementProgress
   */
  public static EffectStartAchievementProgress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectStartAchievementProgress.class);
  }

  /**
   * Convert an instance of EffectStartAchievementProgress to an JSON string
   *
   * @return JSON string
   */
