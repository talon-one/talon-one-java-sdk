...
public class NewCustomerSessionV2 {
  ...
  public NewCustomerSessionV2 attributes(@javax.annotation.Nullable Map<String, Object> attributes) {
   ...
   * @return the NewCustomerSessionV2 instance itself
   */
  public NewCustomerSessionV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.profileId, newCustomerSessionV2.profileId) &&
        ...
        Objects.equals(this.additionalProperties, newCustomerSessionV2.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewCustomerSessionV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NewCustomerSessionV2 is not found in the empty JSON string", NewCustomerSessionV2.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NewCustomerSessionV2>() {
           ...
           public NewCustomerSessionV2 read(JsonReader in) throws IOException {
             ...
             NewCustomerSessionV2 instance = thisAdapter.fromJsonTree(jsonObj);
