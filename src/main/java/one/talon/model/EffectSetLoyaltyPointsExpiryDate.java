...
public class EffectSetLoyaltyPointsExpiryDate {
  ...
  @javax.annotation.Nonnull
  private SetLoyaltyPointsExpiryDateEffectProps props;

  public EffectSetLoyaltyPointsExpiryDate() {
  }

  public EffectSetLoyaltyPointsExpiryDate experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectSetLoyaltyPointsExpiryDate campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectSetLoyaltyPointsExpiryDate rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectSetLoyaltyPointsExpiryDate ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectSetLoyaltyPointsExpiryDate ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectSetLoyaltyPointsExpiryDate effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectSetLoyaltyPointsExpiryDate triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectSetLoyaltyPointsExpiryDate triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectSetLoyaltyPointsExpiryDate conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectSetLoyaltyPointsExpiryDate evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectSetLoyaltyPointsExpiryDate evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectSetLoyaltyPointsExpiryDate campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectSetLoyaltyPointsExpiryDate campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectSetLoyaltyPointsExpiryDate selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectSetLoyaltyPointsExpiryDate selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectSetLoyaltyPointsExpiryDate adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectSetLoyaltyPointsExpiryDate rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectSetLoyaltyPointsExpiryDate props(@javax.annotation.Nonnull SetLoyaltyPointsExpiryDateEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public SetLoyaltyPointsExpiryDateEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull SetLoyaltyPointsExpiryDateEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectSetLoyaltyPointsExpiryDate instance itself
   */
  public EffectSetLoyaltyPointsExpiryDate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectSetLoyaltyPointsExpiryDate effectSetLoyaltyPointsExpiryDate = (EffectSetLoyaltyPointsExpiryDate) o;
    return Objects.equals(this.experimentId, effectSetLoyaltyPointsExpiryDate.experimentId) &&
        Objects.equals(this.campaignId, effectSetLoyaltyPointsExpiryDate.campaignId) &&
        Objects.equals(this.rulesetId, effectSetLoyaltyPointsExpiryDate.rulesetId) &&
        Objects.equals(this.ruleIndex, effectSetLoyaltyPointsExpiryDate.ruleIndex) &&
        Objects.equals(this.ruleName, effectSetLoyaltyPointsExpiryDate.ruleName) &&
        Objects.equals(this.effectType, effectSetLoyaltyPointsExpiryDate.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectSetLoyaltyPointsExpiryDate.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectSetLoyaltyPointsExpiryDate.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectSetLoyaltyPointsExpiryDate.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectSetLoyaltyPointsExpiryDate.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectSetLoyaltyPointsExpiryDate.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectSetLoyaltyPointsExpiryDate.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectSetLoyaltyPointsExpiryDate.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectSetLoyaltyPointsExpiryDate.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectSetLoyaltyPointsExpiryDate.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectSetLoyaltyPointsExpiryDate.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectSetLoyaltyPointsExpiryDate.rewardId) &&
        Objects.equals(this.props, effectSetLoyaltyPointsExpiryDate.props)&&
        Objects.equals(this.additionalProperties, effectSetLoyaltyPointsExpiryDate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectSetLoyaltyPointsExpiryDate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectSetLoyaltyPointsExpiryDate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectSetLoyaltyPointsExpiryDate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectSetLoyaltyPointsExpiryDate is not found in the empty JSON string", EffectSetLoyaltyPointsExpiryDate.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectSetLoyaltyPointsExpiryDate.openapiRequiredFields) {
      ...
      SetLoyaltyPointsExpiryDateEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectSetLoyaltyPointsExpiryDate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectSetLoyaltyPointsExpiryDate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectSetLoyaltyPointsExpiryDate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectSetLoyaltyPointsExpiryDate.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectSetLoyaltyPointsExpiryDate>() {
           @Override
           public void write(JsonWriter out, EffectSetLoyaltyPointsExpiryDate value) throws IOException {
           ...
           @Override
           public EffectSetLoyaltyPointsExpiryDate read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectSetLoyaltyPointsExpiryDate instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectSetLoyaltyPointsExpiryDate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectSetLoyaltyPointsExpiryDate
   * @throws IOException if the JSON string is invalid with respect to EffectSetLoyaltyPointsExpiryDate
   */
  public static EffectSetLoyaltyPointsExpiryDate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectSetLoyaltyPointsExpiryDate.class);
  }

  /**
   * Convert an instance of EffectSetLoyaltyPointsExpiryDate to an JSON string
   *
   * @return JSON string
   */
