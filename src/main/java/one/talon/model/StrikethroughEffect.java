...
public class StrikethroughEffect {
   ...
   * @return the StrikethroughEffect instance itself
   */
  public StrikethroughEffect putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.campaignId, strikethroughEffect.campaignId) &&
        ...
        Objects.equals(this.additionalProperties, strikethroughEffect.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(campaignId, rulesetId, ruleIndex, ruleName, type, props, startTime, endTime, selectedPriceType, selectedPrice, adjustmentReferenceId, targets, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StrikethroughEffect>() {
           ...
           public StrikethroughEffect read(JsonReader in) throws IOException {
             ...
             StrikethroughEffect instance = thisAdapter.fromJsonTree(jsonObj);
