...
public class EffectAddFreeItem {
  ...
  @javax.annotation.Nonnull
  private AddFreeItemEffectProps props;

  public EffectAddFreeItem() {
  }

  public EffectAddFreeItem experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectAddFreeItem campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectAddFreeItem rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectAddFreeItem ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectAddFreeItem ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectAddFreeItem effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectAddFreeItem triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectAddFreeItem triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectAddFreeItem conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectAddFreeItem evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectAddFreeItem evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectAddFreeItem campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectAddFreeItem campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectAddFreeItem selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectAddFreeItem selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectAddFreeItem adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectAddFreeItem rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectAddFreeItem props(@javax.annotation.Nonnull AddFreeItemEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AddFreeItemEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull AddFreeItemEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectAddFreeItem instance itself
   */
  public EffectAddFreeItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectAddFreeItem effectAddFreeItem = (EffectAddFreeItem) o;
    return Objects.equals(this.experimentId, effectAddFreeItem.experimentId) &&
        Objects.equals(this.campaignId, effectAddFreeItem.campaignId) &&
        Objects.equals(this.rulesetId, effectAddFreeItem.rulesetId) &&
        Objects.equals(this.ruleIndex, effectAddFreeItem.ruleIndex) &&
        Objects.equals(this.ruleName, effectAddFreeItem.ruleName) &&
        Objects.equals(this.effectType, effectAddFreeItem.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectAddFreeItem.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectAddFreeItem.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectAddFreeItem.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectAddFreeItem.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectAddFreeItem.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectAddFreeItem.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectAddFreeItem.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectAddFreeItem.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectAddFreeItem.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectAddFreeItem.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectAddFreeItem.rewardId) &&
        Objects.equals(this.props, effectAddFreeItem.props)&&
        Objects.equals(this.additionalProperties, effectAddFreeItem.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectAddFreeItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectAddFreeItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectAddFreeItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectAddFreeItem is not found in the empty JSON string", EffectAddFreeItem.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectAddFreeItem.openapiRequiredFields) {
      ...
      AddFreeItemEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectAddFreeItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectAddFreeItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectAddFreeItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectAddFreeItem.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectAddFreeItem>() {
           @Override
           public void write(JsonWriter out, EffectAddFreeItem value) throws IOException {
           ...
           @Override
           public EffectAddFreeItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectAddFreeItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectAddFreeItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectAddFreeItem
   * @throws IOException if the JSON string is invalid with respect to EffectAddFreeItem
   */
  public static EffectAddFreeItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectAddFreeItem.class);
  }

  /**
   * Convert an instance of EffectAddFreeItem to an JSON string
   *
   * @return JSON string
   */
