...
public class ModelReturn {
  ...
  static {
    ...
    openapiFields.add("returnedCartItems");
    ...
    openapiRequiredFields.add("returnedCartItems");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("returnedCartItems").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `returnedCartItems` to be an array in the JSON string but got `%s`", jsonObj.get("returnedCartItems").toString()));
      }
