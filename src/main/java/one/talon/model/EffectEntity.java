...
public class EffectEntity {
  ...
  public EffectEntity experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectEntity campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectEntity rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectEntity ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectEntity ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectEntity triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectEntity triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectEntity conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectEntity evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectEntity evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectEntity campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectEntity campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectEntity selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectEntity selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectEntity adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.experimentId, effectEntity.experimentId) &&
        Objects.equals(this.campaignId, effectEntity.campaignId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(experimentId, campaignId, rulesetId, ruleIndex, ruleName, effectType, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("experimentId", "campaignId", "rulesetId", "ruleIndex", "ruleName", "effectType", "triggeredByCoupon", "triggeredForCatalogItem", "conditionIndex", "evaluationGroupID", "evaluationGroupMode", "campaignRevisionId", "campaignRevisionVersionId", "selectedPriceType", "selectedPrice", "adjustmentReferenceId"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectEntity is not found in the empty JSON string", EffectEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EffectEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EffectEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectEntity>() {
           @Override
           public void write(JsonWriter out, EffectEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EffectEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EffectEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectEntity
   * @throws IOException if the JSON string is invalid with respect to EffectEntity
   */
  public static EffectEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectEntity.class);
  }

  /**
   * Convert an instance of EffectEntity to an JSON string
   *
   * @return JSON string
   */
