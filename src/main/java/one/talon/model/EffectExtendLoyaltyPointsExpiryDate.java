...
public class EffectExtendLoyaltyPointsExpiryDate {
  ...
  @javax.annotation.Nonnull
  private ExtendLoyaltyPointsExpiryDateEffectProps props;
  ...
  public EffectExtendLoyaltyPointsExpiryDate props(@javax.annotation.Nonnull ExtendLoyaltyPointsExpiryDateEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public ExtendLoyaltyPointsExpiryDateEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull ExtendLoyaltyPointsExpiryDateEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectExtendLoyaltyPointsExpiryDate instance itself
   */
  public EffectExtendLoyaltyPointsExpiryDate putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectExtendLoyaltyPointsExpiryDate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectExtendLoyaltyPointsExpiryDate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectExtendLoyaltyPointsExpiryDate is not found in the empty JSON string", EffectExtendLoyaltyPointsExpiryDate.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectExtendLoyaltyPointsExpiryDate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectExtendLoyaltyPointsExpiryDate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectExtendLoyaltyPointsExpiryDate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectExtendLoyaltyPointsExpiryDate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectExtendLoyaltyPointsExpiryDate.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectExtendLoyaltyPointsExpiryDate>() {
           @Override
           public void write(JsonWriter out, EffectExtendLoyaltyPointsExpiryDate value) throws IOException {
           ...
           @Override
           public EffectExtendLoyaltyPointsExpiryDate read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectExtendLoyaltyPointsExpiryDate instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectExtendLoyaltyPointsExpiryDate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectExtendLoyaltyPointsExpiryDate
   * @throws IOException if the JSON string is invalid with respect to EffectExtendLoyaltyPointsExpiryDate
   */
  public static EffectExtendLoyaltyPointsExpiryDate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectExtendLoyaltyPointsExpiryDate.class);
  }

  /**
   * Convert an instance of EffectExtendLoyaltyPointsExpiryDate to an JSON string
   *
   * @return JSON string
   */
