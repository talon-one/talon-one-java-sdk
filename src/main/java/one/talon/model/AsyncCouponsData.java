...
public class AsyncCouponsData {
   ...
   * @return the AsyncCouponsData instance itself
   */
  public AsyncCouponsData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.batchID, asyncCouponsData.batchID) &&
        ...
        Objects.equals(this.additionalProperties, asyncCouponsData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(batchID, typeOfChange, operation, employeeName, notificationType, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("BatchID", "TypeOfChange", "Operation", "EmployeeName", "NotificationType"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("BatchID", "TypeOfChange", "Operation", "EmployeeName", "NotificationType"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AsyncCouponsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AsyncCouponsData is not found in the empty JSON string", AsyncCouponsData.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AsyncCouponsData>() {
           ...
           public AsyncCouponsData read(JsonReader in) throws IOException {
             ...
             AsyncCouponsData instance = thisAdapter.fromJsonTree(jsonObj);
