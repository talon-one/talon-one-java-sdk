...
public class Notification {
  ...
  public Notification id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public Notification name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public Notification description(@javax.annotation.Nonnull String description) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Notification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Notification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
