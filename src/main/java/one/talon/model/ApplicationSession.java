...
public class ApplicationSession {
   ...
   * @return the ApplicationSession instance itself
   */
  public ApplicationSession putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, applicationSession.id) &&
        ...
        Objects.equals(this.additionalProperties, applicationSession.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, created, integrationId, storeIntegrationId, applicationId, profileId, profileintegrationid, coupon, referral, state, cartItems, discounts, totalDiscounts, total, attributes, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApplicationSession is not found in the empty JSON string", ApplicationSession.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ApplicationSession>() {
           ...
           public ApplicationSession read(JsonReader in) throws IOException {
             ...
             ApplicationSession instance = thisAdapter.fromJsonTree(jsonObj);
