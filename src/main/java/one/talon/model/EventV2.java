...
public class EventV2 {
   ...
   * @return the EventV2 instance itself
   */
  public EventV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.profileId, eventV2.profileId) &&
        ...
        Objects.equals(this.additionalProperties, eventV2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(profileId, storeIntegrationId, evaluableCampaignIds, type, attributes, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("profileId", "storeIntegrationId", "evaluableCampaignIds", "type", "attributes"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventV2 is not found in the empty JSON string", EventV2.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EventV2>() {
           ...
           public EventV2 read(JsonReader in) throws IOException {
             ...
             EventV2 instance = thisAdapter.fromJsonTree(jsonObj);
