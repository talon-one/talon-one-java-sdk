...
public class NewMessageTest {
   ...
   * @return the NewMessageTest instance itself
   */
  public NewMessageTest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.headers, newMessageTest.headers) &&
        ...
        Objects.equals(this.additionalProperties, newMessageTest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(headers, verb, url, payload, params, applicationIds, authenticationId, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewMessageTest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NewMessageTest is not found in the empty JSON string", NewMessageTest.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NewMessageTest>() {
           ...
           public NewMessageTest read(JsonReader in) throws IOException {
             ...
             NewMessageTest instance = thisAdapter.fromJsonTree(jsonObj);
