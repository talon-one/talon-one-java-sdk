...
import one.talon.model.UseRewardEffectProps;
...
public class EffectUseReward {
  ...
  @javax.annotation.Nonnull
  private UseRewardEffectProps props;

  public EffectUseReward() {
  }

  public EffectUseReward experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectUseReward campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectUseReward rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectUseReward ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectUseReward ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectUseReward effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectUseReward triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectUseReward triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectUseReward conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectUseReward evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectUseReward evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectUseReward campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectUseReward campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectUseReward selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectUseReward selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectUseReward adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectUseReward rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectUseReward props(@javax.annotation.Nonnull UseRewardEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public UseRewardEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull UseRewardEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectUseReward instance itself
   */
  public EffectUseReward putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectUseReward effectUseReward = (EffectUseReward) o;
    return Objects.equals(this.experimentId, effectUseReward.experimentId) &&
        Objects.equals(this.campaignId, effectUseReward.campaignId) &&
        Objects.equals(this.rulesetId, effectUseReward.rulesetId) &&
        Objects.equals(this.ruleIndex, effectUseReward.ruleIndex) &&
        Objects.equals(this.ruleName, effectUseReward.ruleName) &&
        Objects.equals(this.effectType, effectUseReward.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectUseReward.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectUseReward.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectUseReward.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectUseReward.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectUseReward.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectUseReward.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectUseReward.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectUseReward.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectUseReward.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectUseReward.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectUseReward.rewardId) &&
        Objects.equals(this.props, effectUseReward.props)&&
        Objects.equals(this.additionalProperties, effectUseReward.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectUseReward {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectUseReward
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectUseReward.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectUseReward is not found in the empty JSON string", EffectUseReward.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectUseReward.openapiRequiredFields) {
      ...
      UseRewardEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectUseReward.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectUseReward' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectUseReward> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectUseReward.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectUseReward>() {
           @Override
           public void write(JsonWriter out, EffectUseReward value) throws IOException {
           ...
           @Override
           public EffectUseReward read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectUseReward instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectUseReward given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectUseReward
   * @throws IOException if the JSON string is invalid with respect to EffectUseReward
   */
  public static EffectUseReward fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectUseReward.class);
  }

  /**
   * Convert an instance of EffectUseReward to an JSON string
   *
   * @return JSON string
   */
