...
public class ApplicationEntity {
   ...
   * @return the ApplicationEntity instance itself
   */
  public ApplicationEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applicationId, applicationEntity.applicationId)&&
        Objects.equals(this.additionalProperties, applicationEntity.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicationId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("applicationId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("applicationId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApplicationEntity is not found in the empty JSON string", ApplicationEntity.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ApplicationEntity>() {
           ...
           public ApplicationEntity read(JsonReader in) throws IOException {
             ...
             ApplicationEntity instance = thisAdapter.fromJsonTree(jsonObj);
