...
public class PrismaticEventPayloadLoyaltyProfileBasedNotification {
  ...
  public PrismaticEventPayloadLoyaltyProfileBasedNotification actions(@javax.annotation.Nullable List<PrismaticEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction> actions) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<PrismaticEventPayloadLoyaltyProfileBasedNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrismaticEventPayloadLoyaltyProfileBasedNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<PrismaticEventPayloadLoyaltyProfileBasedNotification>() {
           @Override
