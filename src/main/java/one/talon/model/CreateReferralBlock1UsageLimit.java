...
public class CreateReferralBlock1UsageLimit extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateReferralBlock1UsageLimit.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateReferralBlock1UsageLimit' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateReferralBlock1UsageLimit>() {
                @Override
                public void write(JsonWriter out, CreateReferralBlock1UsageLimit value) throws IOException {
                ...
                @Override
                public CreateReferralBlock1UsageLimit read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateReferralBlock1UsageLimit ret = new CreateReferralBlock1UsageLimit();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CreateReferralBlock1UsageLimit: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateReferralBlock1UsageLimit() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateReferralBlock1UsageLimit(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CreateReferralBlock1UsageLimit.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CreateReferralBlock1UsageLimit
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CreateReferralBlock1UsageLimit with oneOf schemas: BigDecimal, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of CreateReferralBlock1UsageLimit given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CreateReferralBlock1UsageLimit
     * @throws IOException if the JSON string is invalid with respect to CreateReferralBlock1UsageLimit
     */
    public static CreateReferralBlock1UsageLimit fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CreateReferralBlock1UsageLimit.class);
    }

    /**
     * Convert an instance of CreateReferralBlock1UsageLimit to an JSON string
     *
     * @return JSON string
     */
