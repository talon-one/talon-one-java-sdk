...
public class EffectAddLoyaltyPoints {
  ...
  @javax.annotation.Nonnull
  private AddLoyaltyPointsEffectProps props;

  public EffectAddLoyaltyPoints() {
  }

  public EffectAddLoyaltyPoints experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectAddLoyaltyPoints campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectAddLoyaltyPoints rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectAddLoyaltyPoints ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectAddLoyaltyPoints ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectAddLoyaltyPoints effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectAddLoyaltyPoints triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectAddLoyaltyPoints triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectAddLoyaltyPoints conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectAddLoyaltyPoints evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectAddLoyaltyPoints evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectAddLoyaltyPoints campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectAddLoyaltyPoints campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectAddLoyaltyPoints selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectAddLoyaltyPoints selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectAddLoyaltyPoints adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectAddLoyaltyPoints rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectAddLoyaltyPoints props(@javax.annotation.Nonnull AddLoyaltyPointsEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AddLoyaltyPointsEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull AddLoyaltyPointsEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectAddLoyaltyPoints instance itself
   */
  public EffectAddLoyaltyPoints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectAddLoyaltyPoints effectAddLoyaltyPoints = (EffectAddLoyaltyPoints) o;
    return Objects.equals(this.experimentId, effectAddLoyaltyPoints.experimentId) &&
        Objects.equals(this.campaignId, effectAddLoyaltyPoints.campaignId) &&
        Objects.equals(this.rulesetId, effectAddLoyaltyPoints.rulesetId) &&
        Objects.equals(this.ruleIndex, effectAddLoyaltyPoints.ruleIndex) &&
        Objects.equals(this.ruleName, effectAddLoyaltyPoints.ruleName) &&
        Objects.equals(this.effectType, effectAddLoyaltyPoints.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectAddLoyaltyPoints.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectAddLoyaltyPoints.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectAddLoyaltyPoints.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectAddLoyaltyPoints.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectAddLoyaltyPoints.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectAddLoyaltyPoints.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectAddLoyaltyPoints.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectAddLoyaltyPoints.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectAddLoyaltyPoints.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectAddLoyaltyPoints.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectAddLoyaltyPoints.rewardId) &&
        Objects.equals(this.props, effectAddLoyaltyPoints.props)&&
        Objects.equals(this.additionalProperties, effectAddLoyaltyPoints.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectAddLoyaltyPoints {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectAddLoyaltyPoints
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectAddLoyaltyPoints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectAddLoyaltyPoints is not found in the empty JSON string", EffectAddLoyaltyPoints.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectAddLoyaltyPoints.openapiRequiredFields) {
      ...
      AddLoyaltyPointsEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectAddLoyaltyPoints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectAddLoyaltyPoints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectAddLoyaltyPoints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectAddLoyaltyPoints.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectAddLoyaltyPoints>() {
           @Override
           public void write(JsonWriter out, EffectAddLoyaltyPoints value) throws IOException {
           ...
           @Override
           public EffectAddLoyaltyPoints read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectAddLoyaltyPoints instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectAddLoyaltyPoints given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectAddLoyaltyPoints
   * @throws IOException if the JSON string is invalid with respect to EffectAddLoyaltyPoints
   */
  public static EffectAddLoyaltyPoints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectAddLoyaltyPoints.class);
  }

  /**
   * Convert an instance of EffectAddLoyaltyPoints to an JSON string
   *
   * @return JSON string
   */
