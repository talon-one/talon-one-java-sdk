...
public class EffectAwardGiveaway {
  ...
  @javax.annotation.Nonnull
  private AwardGiveawayEffectProps props;

  public EffectAwardGiveaway() {
  }

  public EffectAwardGiveaway experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectAwardGiveaway campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectAwardGiveaway rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectAwardGiveaway ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectAwardGiveaway ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectAwardGiveaway effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectAwardGiveaway triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectAwardGiveaway triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectAwardGiveaway conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectAwardGiveaway evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectAwardGiveaway evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectAwardGiveaway campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectAwardGiveaway campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectAwardGiveaway selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectAwardGiveaway selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectAwardGiveaway adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectAwardGiveaway rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectAwardGiveaway props(@javax.annotation.Nonnull AwardGiveawayEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AwardGiveawayEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull AwardGiveawayEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectAwardGiveaway instance itself
   */
  public EffectAwardGiveaway putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectAwardGiveaway effectAwardGiveaway = (EffectAwardGiveaway) o;
    return Objects.equals(this.experimentId, effectAwardGiveaway.experimentId) &&
        Objects.equals(this.campaignId, effectAwardGiveaway.campaignId) &&
        Objects.equals(this.rulesetId, effectAwardGiveaway.rulesetId) &&
        Objects.equals(this.ruleIndex, effectAwardGiveaway.ruleIndex) &&
        Objects.equals(this.ruleName, effectAwardGiveaway.ruleName) &&
        Objects.equals(this.effectType, effectAwardGiveaway.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectAwardGiveaway.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectAwardGiveaway.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectAwardGiveaway.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectAwardGiveaway.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectAwardGiveaway.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectAwardGiveaway.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectAwardGiveaway.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectAwardGiveaway.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectAwardGiveaway.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectAwardGiveaway.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectAwardGiveaway.rewardId) &&
        Objects.equals(this.props, effectAwardGiveaway.props)&&
        Objects.equals(this.additionalProperties, effectAwardGiveaway.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectAwardGiveaway {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectAwardGiveaway
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectAwardGiveaway.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectAwardGiveaway is not found in the empty JSON string", EffectAwardGiveaway.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectAwardGiveaway.openapiRequiredFields) {
      ...
      AwardGiveawayEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectAwardGiveaway.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectAwardGiveaway' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectAwardGiveaway> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectAwardGiveaway.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectAwardGiveaway>() {
           @Override
           public void write(JsonWriter out, EffectAwardGiveaway value) throws IOException {
           ...
           @Override
           public EffectAwardGiveaway read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectAwardGiveaway instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectAwardGiveaway given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectAwardGiveaway
   * @throws IOException if the JSON string is invalid with respect to EffectAwardGiveaway
   */
  public static EffectAwardGiveaway fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectAwardGiveaway.class);
  }

  /**
   * Convert an instance of EffectAwardGiveaway to an JSON string
   *
   * @return JSON string
   */
