...
public class CollectionItem {
  ...
  public CollectionItem item(@javax.annotation.Nonnull String item) {
    this.item = item;
    return this;
  }
   ...
   * @return the CollectionItem instance itself
   */
  public CollectionItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.item, collectionItem.item)&&
        Objects.equals(this.additionalProperties, collectionItem.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CollectionItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CollectionItem is not found in the empty JSON string", CollectionItem.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CollectionItem>() {
           ...
           public CollectionItem read(JsonReader in) throws IOException {
             ...
             CollectionItem instance = thisAdapter.fromJsonTree(jsonObj);
