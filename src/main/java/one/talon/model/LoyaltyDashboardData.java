...
public class LoyaltyDashboardData {
   ...
   * @return the LoyaltyDashboardData instance itself
   */
  public LoyaltyDashboardData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.date, loyaltyDashboardData.date) &&
        ...
        Objects.equals(this.additionalProperties, loyaltyDashboardData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, totalActivePoints, totalPendingPoints, totalSpentPoints, totalExpiredPoints, totalNegativePoints, totalMembers, newMembers, spentPoints, earnedPoints, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoyaltyDashboardData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LoyaltyDashboardData is not found in the empty JSON string", LoyaltyDashboardData.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltyDashboardData>() {
           ...
           public LoyaltyDashboardData read(JsonReader in) throws IOException {
             ...
             LoyaltyDashboardData instance = thisAdapter.fromJsonTree(jsonObj);
