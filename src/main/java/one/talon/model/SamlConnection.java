...
public class SamlConnection {
   ...
   * @return the SamlConnection instance itself
   */
  public SamlConnection putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SamlConnection>() {
           ...
           public SamlConnection read(JsonReader in) throws IOException {
             ...
             SamlConnection instance = thisAdapter.fromJsonTree(jsonObj);
