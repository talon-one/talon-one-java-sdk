...
public class EffectCustomEffect {
  ...
  @javax.annotation.Nonnull
  private CustomEffectProps props;

  public EffectCustomEffect() {
  }

  public EffectCustomEffect experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectCustomEffect campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectCustomEffect rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectCustomEffect ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectCustomEffect ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectCustomEffect effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectCustomEffect triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectCustomEffect triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectCustomEffect conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectCustomEffect evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectCustomEffect evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectCustomEffect campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectCustomEffect campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectCustomEffect selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectCustomEffect selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectCustomEffect adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectCustomEffect rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectCustomEffect props(@javax.annotation.Nonnull CustomEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public CustomEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull CustomEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectCustomEffect instance itself
   */
  public EffectCustomEffect putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectCustomEffect effectCustomEffect = (EffectCustomEffect) o;
    return Objects.equals(this.experimentId, effectCustomEffect.experimentId) &&
        Objects.equals(this.campaignId, effectCustomEffect.campaignId) &&
        Objects.equals(this.rulesetId, effectCustomEffect.rulesetId) &&
        Objects.equals(this.ruleIndex, effectCustomEffect.ruleIndex) &&
        Objects.equals(this.ruleName, effectCustomEffect.ruleName) &&
        Objects.equals(this.effectType, effectCustomEffect.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectCustomEffect.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectCustomEffect.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectCustomEffect.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectCustomEffect.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectCustomEffect.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectCustomEffect.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectCustomEffect.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectCustomEffect.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectCustomEffect.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectCustomEffect.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectCustomEffect.rewardId) &&
        Objects.equals(this.props, effectCustomEffect.props)&&
        Objects.equals(this.additionalProperties, effectCustomEffect.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectCustomEffect {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectCustomEffect
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectCustomEffect.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectCustomEffect is not found in the empty JSON string", EffectCustomEffect.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectCustomEffect.openapiRequiredFields) {
      ...
      CustomEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectCustomEffect.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectCustomEffect' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectCustomEffect> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectCustomEffect.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectCustomEffect>() {
           @Override
           public void write(JsonWriter out, EffectCustomEffect value) throws IOException {
           ...
           @Override
           public EffectCustomEffect read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectCustomEffect instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectCustomEffect given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectCustomEffect
   * @throws IOException if the JSON string is invalid with respect to EffectCustomEffect
   */
  public static EffectCustomEffect fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectCustomEffect.class);
  }

  /**
   * Convert an instance of EffectCustomEffect to an JSON string
   *
   * @return JSON string
   */
