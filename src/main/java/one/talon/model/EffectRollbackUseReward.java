...
import one.talon.model.RollbackUseRewardEffectProps;
...
public class EffectRollbackUseReward {
  ...
  @javax.annotation.Nonnull
  private RollbackUseRewardEffectProps props;

  public EffectRollbackUseReward() {
  }

  public EffectRollbackUseReward experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectRollbackUseReward campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectRollbackUseReward rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectRollbackUseReward ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectRollbackUseReward ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectRollbackUseReward effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectRollbackUseReward triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectRollbackUseReward triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectRollbackUseReward conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectRollbackUseReward evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectRollbackUseReward evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectRollbackUseReward campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectRollbackUseReward campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectRollbackUseReward selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectRollbackUseReward selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectRollbackUseReward adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectRollbackUseReward rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectRollbackUseReward props(@javax.annotation.Nonnull RollbackUseRewardEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RollbackUseRewardEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull RollbackUseRewardEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectRollbackUseReward instance itself
   */
  public EffectRollbackUseReward putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectRollbackUseReward effectRollbackUseReward = (EffectRollbackUseReward) o;
    return Objects.equals(this.experimentId, effectRollbackUseReward.experimentId) &&
        Objects.equals(this.campaignId, effectRollbackUseReward.campaignId) &&
        Objects.equals(this.rulesetId, effectRollbackUseReward.rulesetId) &&
        Objects.equals(this.ruleIndex, effectRollbackUseReward.ruleIndex) &&
        Objects.equals(this.ruleName, effectRollbackUseReward.ruleName) &&
        Objects.equals(this.effectType, effectRollbackUseReward.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectRollbackUseReward.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectRollbackUseReward.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectRollbackUseReward.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectRollbackUseReward.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectRollbackUseReward.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectRollbackUseReward.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectRollbackUseReward.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectRollbackUseReward.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectRollbackUseReward.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectRollbackUseReward.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectRollbackUseReward.rewardId) &&
        Objects.equals(this.props, effectRollbackUseReward.props)&&
        Objects.equals(this.additionalProperties, effectRollbackUseReward.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectRollbackUseReward {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectRollbackUseReward
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectRollbackUseReward.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectRollbackUseReward is not found in the empty JSON string", EffectRollbackUseReward.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectRollbackUseReward.openapiRequiredFields) {
      ...
      RollbackUseRewardEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectRollbackUseReward.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectRollbackUseReward' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectRollbackUseReward> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectRollbackUseReward.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectRollbackUseReward>() {
           @Override
           public void write(JsonWriter out, EffectRollbackUseReward value) throws IOException {
           ...
           @Override
           public EffectRollbackUseReward read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectRollbackUseReward instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectRollbackUseReward given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectRollbackUseReward
   * @throws IOException if the JSON string is invalid with respect to EffectRollbackUseReward
   */
  public static EffectRollbackUseReward fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectRollbackUseReward.class);
  }

  /**
   * Convert an instance of EffectRollbackUseReward to an JSON string
   *
   * @return JSON string
   */
