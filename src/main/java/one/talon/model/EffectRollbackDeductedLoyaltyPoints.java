...
public class EffectRollbackDeductedLoyaltyPoints {
  ...
  @javax.annotation.Nonnull
  private RollbackDeductedLoyaltyPointsEffectProps props;

  public EffectRollbackDeductedLoyaltyPoints() {
  }

  public EffectRollbackDeductedLoyaltyPoints experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectRollbackDeductedLoyaltyPoints campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectRollbackDeductedLoyaltyPoints rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectRollbackDeductedLoyaltyPoints ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectRollbackDeductedLoyaltyPoints ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectRollbackDeductedLoyaltyPoints effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectRollbackDeductedLoyaltyPoints triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectRollbackDeductedLoyaltyPoints triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectRollbackDeductedLoyaltyPoints conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectRollbackDeductedLoyaltyPoints evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectRollbackDeductedLoyaltyPoints evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectRollbackDeductedLoyaltyPoints campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectRollbackDeductedLoyaltyPoints campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectRollbackDeductedLoyaltyPoints selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectRollbackDeductedLoyaltyPoints selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectRollbackDeductedLoyaltyPoints adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectRollbackDeductedLoyaltyPoints rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectRollbackDeductedLoyaltyPoints props(@javax.annotation.Nonnull RollbackDeductedLoyaltyPointsEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RollbackDeductedLoyaltyPointsEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull RollbackDeductedLoyaltyPointsEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectRollbackDeductedLoyaltyPoints instance itself
   */
  public EffectRollbackDeductedLoyaltyPoints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectRollbackDeductedLoyaltyPoints effectRollbackDeductedLoyaltyPoints = (EffectRollbackDeductedLoyaltyPoints) o;
    return Objects.equals(this.experimentId, effectRollbackDeductedLoyaltyPoints.experimentId) &&
        Objects.equals(this.campaignId, effectRollbackDeductedLoyaltyPoints.campaignId) &&
        Objects.equals(this.rulesetId, effectRollbackDeductedLoyaltyPoints.rulesetId) &&
        Objects.equals(this.ruleIndex, effectRollbackDeductedLoyaltyPoints.ruleIndex) &&
        Objects.equals(this.ruleName, effectRollbackDeductedLoyaltyPoints.ruleName) &&
        Objects.equals(this.effectType, effectRollbackDeductedLoyaltyPoints.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectRollbackDeductedLoyaltyPoints.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectRollbackDeductedLoyaltyPoints.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectRollbackDeductedLoyaltyPoints.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectRollbackDeductedLoyaltyPoints.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectRollbackDeductedLoyaltyPoints.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectRollbackDeductedLoyaltyPoints.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectRollbackDeductedLoyaltyPoints.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectRollbackDeductedLoyaltyPoints.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectRollbackDeductedLoyaltyPoints.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectRollbackDeductedLoyaltyPoints.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectRollbackDeductedLoyaltyPoints.rewardId) &&
        Objects.equals(this.props, effectRollbackDeductedLoyaltyPoints.props)&&
        Objects.equals(this.additionalProperties, effectRollbackDeductedLoyaltyPoints.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectRollbackDeductedLoyaltyPoints {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectRollbackDeductedLoyaltyPoints
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectRollbackDeductedLoyaltyPoints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectRollbackDeductedLoyaltyPoints is not found in the empty JSON string", EffectRollbackDeductedLoyaltyPoints.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectRollbackDeductedLoyaltyPoints.openapiRequiredFields) {
      ...
      RollbackDeductedLoyaltyPointsEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectRollbackDeductedLoyaltyPoints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectRollbackDeductedLoyaltyPoints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectRollbackDeductedLoyaltyPoints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectRollbackDeductedLoyaltyPoints.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectRollbackDeductedLoyaltyPoints>() {
           @Override
           public void write(JsonWriter out, EffectRollbackDeductedLoyaltyPoints value) throws IOException {
           ...
           @Override
           public EffectRollbackDeductedLoyaltyPoints read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectRollbackDeductedLoyaltyPoints instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectRollbackDeductedLoyaltyPoints given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectRollbackDeductedLoyaltyPoints
   * @throws IOException if the JSON string is invalid with respect to EffectRollbackDeductedLoyaltyPoints
   */
  public static EffectRollbackDeductedLoyaltyPoints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectRollbackDeductedLoyaltyPoints.class);
  }

  /**
   * Convert an instance of EffectRollbackDeductedLoyaltyPoints to an JSON string
   *
   * @return JSON string
   */
