...
public class RoleV2 {
   ...
   * @return the RoleV2 instance itself
   */
  public RoleV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, roleV2.id) &&
        ...
        Objects.equals(this.additionalProperties, roleV2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, created, modified, accountId, name, description, permissions, members, isReadonly, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RoleV2>() {
           ...
           public RoleV2 read(JsonReader in) throws IOException {
             ...
             RoleV2 instance = thisAdapter.fromJsonTree(jsonObj);
