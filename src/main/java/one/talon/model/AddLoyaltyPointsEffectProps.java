...
public class AddLoyaltyPointsEffectProps {
   ...
   * @return the AddLoyaltyPointsEffectProps instance itself
   */
  public AddLoyaltyPointsEffectProps putAdditionalProperty(String key, Object value) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, programId, subLedgerId, value, desiredValue, recipientIntegrationId, startDate, expiryDate, transactionUUID, cartItemPosition, cartItemSubPosition, cardIdentifier, bundleIndex, bundleName, awaitsActivation, validityDuration, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AddLoyaltyPointsEffectProps>() {
           ...
           public AddLoyaltyPointsEffectProps read(JsonReader in) throws IOException {
             ...
             AddLoyaltyPointsEffectProps instance = thisAdapter.fromJsonTree(jsonObj);
