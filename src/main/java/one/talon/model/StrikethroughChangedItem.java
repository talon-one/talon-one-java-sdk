...
public class StrikethroughChangedItem {
   ...
   * @return the StrikethroughChangedItem instance itself
   */
  public StrikethroughChangedItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, strikethroughChangedItem.id) &&
        ...
        Objects.equals(this.additionalProperties, strikethroughChangedItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, catalogId, sku, version, price, prices, evaluatedAt, effects, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StrikethroughChangedItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StrikethroughChangedItem is not found in the empty JSON string", StrikethroughChangedItem.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StrikethroughChangedItem>() {
           ...
           public StrikethroughChangedItem read(JsonReader in) throws IOException {
             ...
             StrikethroughChangedItem instance = thisAdapter.fromJsonTree(jsonObj);
