...
public class LoyaltyLedgerEntry {
   ...
   * @return the LoyaltyLedgerEntry instance itself
   */
  public LoyaltyLedgerEntry putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, loyaltyLedgerEntry.created) &&
        ...
        Objects.equals(this.additionalProperties, loyaltyLedgerEntry.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, programID, customerProfileID, cardID, customerSessionID, eventID, type, amount, startDate, expiryDate, name, subLedgerID, userID, archived, flags, validityDuration, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltyLedgerEntry>() {
           ...
           public LoyaltyLedgerEntry read(JsonReader in) throws IOException {
             ...
             LoyaltyLedgerEntry instance = thisAdapter.fromJsonTree(jsonObj);
