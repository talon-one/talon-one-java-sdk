...
public class EffectAcceptReferral {
  ...
  @javax.annotation.Nonnull
  private AcceptReferralEffectProps props;

  public EffectAcceptReferral() {
  }

  public EffectAcceptReferral experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectAcceptReferral campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectAcceptReferral rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectAcceptReferral ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectAcceptReferral ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectAcceptReferral effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectAcceptReferral triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectAcceptReferral triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectAcceptReferral conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectAcceptReferral evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectAcceptReferral evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectAcceptReferral campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectAcceptReferral campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectAcceptReferral selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectAcceptReferral selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectAcceptReferral adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectAcceptReferral rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectAcceptReferral props(@javax.annotation.Nonnull AcceptReferralEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AcceptReferralEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull AcceptReferralEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectAcceptReferral instance itself
   */
  public EffectAcceptReferral putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectAcceptReferral effectAcceptReferral = (EffectAcceptReferral) o;
    return Objects.equals(this.experimentId, effectAcceptReferral.experimentId) &&
        Objects.equals(this.campaignId, effectAcceptReferral.campaignId) &&
        Objects.equals(this.rulesetId, effectAcceptReferral.rulesetId) &&
        Objects.equals(this.ruleIndex, effectAcceptReferral.ruleIndex) &&
        Objects.equals(this.ruleName, effectAcceptReferral.ruleName) &&
        Objects.equals(this.effectType, effectAcceptReferral.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectAcceptReferral.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectAcceptReferral.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectAcceptReferral.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectAcceptReferral.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectAcceptReferral.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectAcceptReferral.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectAcceptReferral.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectAcceptReferral.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectAcceptReferral.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectAcceptReferral.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectAcceptReferral.rewardId) &&
        Objects.equals(this.props, effectAcceptReferral.props)&&
        Objects.equals(this.additionalProperties, effectAcceptReferral.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectAcceptReferral {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectAcceptReferral
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectAcceptReferral.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectAcceptReferral is not found in the empty JSON string", EffectAcceptReferral.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectAcceptReferral.openapiRequiredFields) {
      ...
      AcceptReferralEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectAcceptReferral.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectAcceptReferral' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectAcceptReferral> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectAcceptReferral.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectAcceptReferral>() {
           @Override
           public void write(JsonWriter out, EffectAcceptReferral value) throws IOException {
           ...
           @Override
           public EffectAcceptReferral read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectAcceptReferral instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectAcceptReferral given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectAcceptReferral
   * @throws IOException if the JSON string is invalid with respect to EffectAcceptReferral
   */
  public static EffectAcceptReferral fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectAcceptReferral.class);
  }

  /**
   * Convert an instance of EffectAcceptReferral to an JSON string
   *
   * @return JSON string
   */
