...
public class BestPriorPrice {
  ...
  public BestPriorPrice contextIds(@javax.annotation.Nonnull List<String> contextIds) {
   ...
   * @return the BestPriorPrice instance itself
   */
  public BestPriorPrice putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, bestPriorPrice.id) &&
        ...
        Objects.equals(this.additionalProperties, bestPriorPrice.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, sku, observedAt, contextIds, price, metadata, target, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "sku", "observedAt", "contextIds", "price", "metadata", "target"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "sku", "observedAt", "contextIds", "price", "metadata", "target"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BestPriorPrice>() {
           ...
           public BestPriorPrice read(JsonReader in) throws IOException {
             ...
             BestPriorPrice instance = thisAdapter.fromJsonTree(jsonObj);
