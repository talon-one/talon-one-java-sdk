...
public class BestPriorPrice {
  ...
  static {
    ...
    openapiRequiredFields.add("observedAt");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BestPriorPrice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BestPriorPrice is not found in the empty JSON string", BestPriorPrice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BestPriorPrice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BestPriorPrice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
