...
public class StrikethroughLabelingNotification {
  ...
  public StrikethroughLabelingNotification notificationType(@javax.annotation.Nonnull NotificationTypeEnum notificationType) {
  ...
  public StrikethroughLabelingNotification sentAt(@javax.annotation.Nonnull OffsetDateTime sentAt) {
    this.sentAt = sentAt;
    return this;
  }
   ...
   * @return the StrikethroughLabelingNotification instance itself
   */
  public StrikethroughLabelingNotification putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, strikethroughLabelingNotification.version) &&
        ...
        Objects.equals(this.additionalProperties, strikethroughLabelingNotification.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, validFrom, applicationId, currentBatch, totalBatches, trigger, changedItems, notificationType, sentAt, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("version", "validFrom", "applicationId", "currentBatch", "totalBatches", "trigger", "changedItems", "NotificationType", "sentAt"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("applicationId", "currentBatch", "totalBatches", "trigger", "changedItems", "NotificationType", "sentAt"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StrikethroughLabelingNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StrikethroughLabelingNotification is not found in the empty JSON string", StrikethroughLabelingNotification.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StrikethroughLabelingNotification>() {
           ...
           public StrikethroughLabelingNotification read(JsonReader in) throws IOException {
             ...
             StrikethroughLabelingNotification instance = thisAdapter.fromJsonTree(jsonObj);
