...
public class EffectSet {
  ...
  @javax.annotation.Nonnull
  private UpdateAttributeEffectProps props;

  public EffectSet() {
  }

  public EffectSet experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectSet campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectSet rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectSet ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectSet ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectSet effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectSet triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectSet triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectSet conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectSet evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectSet evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectSet campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectSet campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectSet selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectSet selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectSet adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectSet rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectSet props(@javax.annotation.Nonnull UpdateAttributeEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public UpdateAttributeEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull UpdateAttributeEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectSet instance itself
   */
  public EffectSet putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectSet effectSet = (EffectSet) o;
    return Objects.equals(this.experimentId, effectSet.experimentId) &&
        Objects.equals(this.campaignId, effectSet.campaignId) &&
        Objects.equals(this.rulesetId, effectSet.rulesetId) &&
        Objects.equals(this.ruleIndex, effectSet.ruleIndex) &&
        Objects.equals(this.ruleName, effectSet.ruleName) &&
        Objects.equals(this.effectType, effectSet.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectSet.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectSet.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectSet.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectSet.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectSet.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectSet.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectSet.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectSet.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectSet.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectSet.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectSet.rewardId) &&
        Objects.equals(this.props, effectSet.props)&&
        Objects.equals(this.additionalProperties, effectSet.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectSet is not found in the empty JSON string", EffectSet.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectSet.openapiRequiredFields) {
      ...
      UpdateAttributeEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectSet.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectSet>() {
           @Override
           public void write(JsonWriter out, EffectSet value) throws IOException {
           ...
           @Override
           public EffectSet read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectSet instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectSet
   * @throws IOException if the JSON string is invalid with respect to EffectSet
   */
  public static EffectSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectSet.class);
  }

  /**
   * Convert an instance of EffectSet to an JSON string
   *
   * @return JSON string
   */
