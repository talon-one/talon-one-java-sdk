...
public class CouponWithApplication {
  ...
  public CouponWithApplication() {
  }

  public CouponWithApplication id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public CouponWithApplication created(@javax.annotation.Nonnull OffsetDateTime created) {
  ...
  public CouponWithApplication campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public CouponWithApplication value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public CouponWithApplication usageLimit(@javax.annotation.Nullable Long usageLimit) {
  ...
  public CouponWithApplication discountLimit(@javax.annotation.Nullable BigDecimal discountLimit) {
  ...
  public CouponWithApplication reservationLimit(@javax.annotation.Nullable Long reservationLimit) {
  ...
  public CouponWithApplication startDate(@javax.annotation.Nullable OffsetDateTime startDate) {
  ...
  public CouponWithApplication expiryDate(@javax.annotation.Nullable OffsetDateTime expiryDate) {
  ...
  public CouponWithApplication limits(@javax.annotation.Nullable List<LimitConfig> limits) {
    this.limits = limits;
    return this;
  }

  public CouponWithApplication addLimitsItem(LimitConfig limitsItem) {
    if (this.limits == null) {
  ...
  public CouponWithApplication usageCounter(@javax.annotation.Nonnull Long usageCounter) {
  ...
  public CouponWithApplication discountCounter(@javax.annotation.Nullable BigDecimal discountCounter) {
  ...
  public CouponWithApplication discountRemainder(@javax.annotation.Nullable BigDecimal discountRemainder) {
  ...
  public CouponWithApplication reservationCounter(@javax.annotation.Nullable BigDecimal reservationCounter) {
  ...
  public CouponWithApplication attributes(@javax.annotation.Nullable Object attributes) {
  ...
  public CouponWithApplication referralId(@javax.annotation.Nullable Long referralId) {
  ...
  public CouponWithApplication recipientIntegrationId(@javax.annotation.Nullable String recipientIntegrationId) {
  ...
  public CouponWithApplication importId(@javax.annotation.Nullable Long importId) {
  ...
  public CouponWithApplication reservation(@javax.annotation.Nullable Boolean reservation) {
  ...
  public CouponWithApplication batchId(@javax.annotation.Nullable String batchId) {
  ...
  public CouponWithApplication isReservationMandatory(@javax.annotation.Nullable Boolean isReservationMandatory) {
  ...
  public CouponWithApplication implicitlyReserved(@javax.annotation.Nullable Boolean implicitlyReserved) {
  ...
  public CouponWithApplication applicationId(@javax.annotation.Nonnull Long applicationId) {
  ...
  public CouponWithApplication applicationName(@javax.annotation.Nonnull String applicationName) {
   ...
   * @return the CouponWithApplication instance itself
   */
  public CouponWithApplication putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CouponWithApplication couponWithApplication = (CouponWithApplication) o;
    return Objects.equals(this.id, couponWithApplication.id) &&
        Objects.equals(this.created, couponWithApplication.created) &&
        Objects.equals(this.campaignId, couponWithApplication.campaignId) &&
        Objects.equals(this.value, couponWithApplication.value) &&
        Objects.equals(this.usageLimit, couponWithApplication.usageLimit) &&
        Objects.equals(this.discountLimit, couponWithApplication.discountLimit) &&
        Objects.equals(this.reservationLimit, couponWithApplication.reservationLimit) &&
        Objects.equals(this.startDate, couponWithApplication.startDate) &&
        Objects.equals(this.expiryDate, couponWithApplication.expiryDate) &&
        Objects.equals(this.limits, couponWithApplication.limits) &&
        Objects.equals(this.usageCounter, couponWithApplication.usageCounter) &&
        Objects.equals(this.discountCounter, couponWithApplication.discountCounter) &&
        Objects.equals(this.discountRemainder, couponWithApplication.discountRemainder) &&
        Objects.equals(this.reservationCounter, couponWithApplication.reservationCounter) &&
        Objects.equals(this.attributes, couponWithApplication.attributes) &&
        Objects.equals(this.referralId, couponWithApplication.referralId) &&
        Objects.equals(this.recipientIntegrationId, couponWithApplication.recipientIntegrationId) &&
        Objects.equals(this.importId, couponWithApplication.importId) &&
        Objects.equals(this.reservation, couponWithApplication.reservation) &&
        Objects.equals(this.batchId, couponWithApplication.batchId) &&
        Objects.equals(this.isReservationMandatory, couponWithApplication.isReservationMandatory) &&
        Objects.equals(this.implicitlyReserved, couponWithApplication.implicitlyReserved) &&
        Objects.equals(this.applicationId, couponWithApplication.applicationId) &&
        Objects.equals(this.applicationName, couponWithApplication.applicationName)&&
        Objects.equals(this.additionalProperties, couponWithApplication.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, created, campaignId, value, usageLimit, discountLimit, reservationLimit, startDate, expiryDate, limits, usageCounter, discountCounter, discountRemainder, reservationCounter, attributes, referralId, recipientIntegrationId, importId, reservation, batchId, isReservationMandatory, implicitlyReserved, applicationId, applicationName, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "created", "campaignId", "usageCounter", "applicationId", "applicationName"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CouponWithApplication
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CouponWithApplication.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CouponWithApplication is not found in the empty JSON string", CouponWithApplication.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CouponWithApplication.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CouponWithApplication.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CouponWithApplication' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CouponWithApplication> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CouponWithApplication.class));

       return (TypeAdapter<T>) new TypeAdapter<CouponWithApplication>() {
           @Override
           public void write(JsonWriter out, CouponWithApplication value) throws IOException {
           ...
           @Override
           public CouponWithApplication read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CouponWithApplication instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CouponWithApplication given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CouponWithApplication
   * @throws IOException if the JSON string is invalid with respect to CouponWithApplication
   */
  public static CouponWithApplication fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CouponWithApplication.class);
  }

  /**
   * Convert an instance of CouponWithApplication to an JSON string
   *
   * @return JSON string
   */
