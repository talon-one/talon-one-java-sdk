...
public class NewLoyaltyProgram {
  ...
  @javax.annotation.Nullable
  private List<NewLoyaltyTier> tiers = new ArrayList<>();
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, description, subscribedApplications, defaultValidity, defaultPending, allowSubledger, usersPerCardLimit, sandbox, programJoinPolicy, tiersExpirationPolicy, tierCycleStartDate, tiersExpireIn, tiersDowngradePolicy, cardCodeSettings, returnPolicy, name, tiers, timezone, cardBased);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewLoyaltyProgram.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `NewLoyaltyProgram` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
