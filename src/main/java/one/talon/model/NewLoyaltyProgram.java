...
public class NewLoyaltyProgram {
  ...
  @javax.annotation.Nullable
  private List<NewLoyaltyTier> tiers;
  ...
  public NewLoyaltyProgram() {
  }

  public NewLoyaltyProgram title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public NewLoyaltyProgram description(@javax.annotation.Nullable String description) {
  ...
  public NewLoyaltyProgram subscribedApplications(@javax.annotation.Nullable List<Long> subscribedApplications) {
  ...
  public NewLoyaltyProgram defaultValidity(@javax.annotation.Nonnull String defaultValidity) {
  ...
  public void setDefaultValidity(@javax.annotation.Nonnull String defaultValidity) {
    this.defaultValidity = defaultValidity;
  }


  public NewLoyaltyProgram defaultPending(@javax.annotation.Nonnull String defaultPending) {
  ...
  public void setDefaultPending(@javax.annotation.Nonnull String defaultPending) {
    this.defaultPending = defaultPending;
  }


  public NewLoyaltyProgram allowSubledger(@javax.annotation.Nonnull Boolean allowSubledger) {
  ...
  public void setAllowSubledger(@javax.annotation.Nonnull Boolean allowSubledger) {
    this.allowSubledger = allowSubledger;
  }


  public NewLoyaltyProgram usersPerCardLimit(@javax.annotation.Nullable Long usersPerCardLimit) {
  ...
  public NewLoyaltyProgram sandbox(@javax.annotation.Nonnull Boolean sandbox) {
  ...
  public NewLoyaltyProgram programJoinPolicy(@javax.annotation.Nullable ProgramJoinPolicyEnum programJoinPolicy) {
  ...
  public NewLoyaltyProgram tiersExpirationPolicy(@javax.annotation.Nullable TiersExpirationPolicyEnum tiersExpirationPolicy) {
  ...
  public NewLoyaltyProgram tierCycleStartDate(@javax.annotation.Nullable OffsetDateTime tierCycleStartDate) {
  ...
  public NewLoyaltyProgram tiersExpireIn(@javax.annotation.Nullable String tiersExpireIn) {
  ...
  public NewLoyaltyProgram tiersDowngradePolicy(@javax.annotation.Nullable TiersDowngradePolicyEnum tiersDowngradePolicy) {
  ...
  public NewLoyaltyProgram cardCodeSettings(@javax.annotation.Nullable CodeGeneratorSettings cardCodeSettings) {
  ...
  public NewLoyaltyProgram returnPolicy(@javax.annotation.Nullable ReturnPolicyEnum returnPolicy) {
  ...
  public NewLoyaltyProgram name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public NewLoyaltyProgram tiers(@javax.annotation.Nullable List<NewLoyaltyTier> tiers) {
    this.tiers = tiers;
    return this;
  }
  ...
  public void setTiers(@javax.annotation.Nullable List<NewLoyaltyTier> tiers) {
    this.tiers = tiers;
  }


  public NewLoyaltyProgram timezone(@javax.annotation.Nonnull String timezone) {
  ...
  public NewLoyaltyProgram cardBased(@javax.annotation.Nonnull Boolean cardBased) {
   ...
   * @return the NewLoyaltyProgram instance itself
   */
  public NewLoyaltyProgram putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, newLoyaltyProgram.title) &&
        ...
        Objects.equals(this.programJoinPolicy, newLoyaltyProgram.programJoinPolicy) &&
        Objects.equals(this.tiersExpirationPolicy, newLoyaltyProgram.tiersExpirationPolicy) &&
        Objects.equals(this.tierCycleStartDate, newLoyaltyProgram.tierCycleStartDate) &&
        ...
        Objects.equals(this.cardCodeSettings, newLoyaltyProgram.cardCodeSettings) &&
        Objects.equals(this.returnPolicy, newLoyaltyProgram.returnPolicy) &&
        ...
        Objects.equals(this.additionalProperties, newLoyaltyProgram.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, subscribedApplications, defaultValidity, defaultPending, allowSubledger, usersPerCardLimit, sandbox, programJoinPolicy, tiersExpirationPolicy, tierCycleStartDate, tiersExpireIn, tiersDowngradePolicy, cardCodeSettings, returnPolicy, name, tiers, timezone, cardBased, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("title", "description", "subscribedApplications", "defaultValidity", "defaultPending", "allowSubledger", "usersPerCardLimit", "sandbox", "programJoinPolicy", "tiersExpirationPolicy", "tierCycleStartDate", "tiersExpireIn", "tiersDowngradePolicy", "cardCodeSettings", "returnPolicy", "name", "tiers", "timezone", "cardBased"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("title", "defaultValidity", "defaultPending", "allowSubledger", "sandbox", "name", "timezone", "cardBased"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewLoyaltyProgram
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewLoyaltyProgram.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NewLoyaltyProgram is not found in the empty JSON string", NewLoyaltyProgram.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewLoyaltyProgram.openapiRequiredFields) {
      ...
      if (!jsonObj.get("defaultValidity").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `defaultValidity` to be a primitive type in the JSON string but got `%s`", jsonObj.get("defaultValidity").toString()));
      }
      if (!jsonObj.get("defaultPending").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `defaultPending` to be a primitive type in the JSON string but got `%s`", jsonObj.get("defaultPending").toString()));
      }
      if ((jsonObj.get("programJoinPolicy") != null && !jsonObj.get("programJoinPolicy").isJsonNull()) && !jsonObj.get("programJoinPolicy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `programJoinPolicy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("programJoinPolicy").toString()));
      }
      ...
      if ((jsonObj.get("tiersExpirationPolicy") != null && !jsonObj.get("tiersExpirationPolicy").isJsonNull()) && !jsonObj.get("tiersExpirationPolicy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tiersExpirationPolicy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tiersExpirationPolicy").toString()));
      }
      ...
      if ((jsonObj.get("tiersExpireIn") != null && !jsonObj.get("tiersExpireIn").isJsonNull()) && !jsonObj.get("tiersExpireIn").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tiersExpireIn` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tiersExpireIn").toString()));
      }
      if ((jsonObj.get("tiersDowngradePolicy") != null && !jsonObj.get("tiersDowngradePolicy").isJsonNull()) && !jsonObj.get("tiersDowngradePolicy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tiersDowngradePolicy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tiersDowngradePolicy").toString()));
      }
      ...
      if ((jsonObj.get("returnPolicy") != null && !jsonObj.get("returnPolicy").isJsonNull()) && !jsonObj.get("returnPolicy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `returnPolicy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("returnPolicy").toString()));
      }
      ...
      if (jsonObj.get("tiers") != null && !jsonObj.get("tiers").isJsonNull()) {
        ...
        if (jsonArraytiers != null) {
          ...
          for (int i = 0; i < jsonArraytiers.size(); i++) {
            NewLoyaltyTier.validateJsonElement(jsonArraytiers.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewLoyaltyProgram.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewLoyaltyProgram' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewLoyaltyProgram> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewLoyaltyProgram.class));

       return (TypeAdapter<T>) new TypeAdapter<NewLoyaltyProgram>() {
           @Override
           public void write(JsonWriter out, NewLoyaltyProgram value) throws IOException {
           ...
           @Override
           public NewLoyaltyProgram read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             NewLoyaltyProgram instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of NewLoyaltyProgram given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewLoyaltyProgram
   * @throws IOException if the JSON string is invalid with respect to NewLoyaltyProgram
   */
  public static NewLoyaltyProgram fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewLoyaltyProgram.class);
  }

  /**
   * Convert an instance of NewLoyaltyProgram to an JSON string
   *
   * @return JSON string
   */
