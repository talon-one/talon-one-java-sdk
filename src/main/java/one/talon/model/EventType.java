...
public class EventType {
  ...
  public EventType id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public EventType created(@javax.annotation.Nonnull OffsetDateTime created) {
  ...
  public EventType title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created", "title", "name", "description"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "created", "title", "name"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in EventType is not found in the empty JSON string", EventType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EventType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
