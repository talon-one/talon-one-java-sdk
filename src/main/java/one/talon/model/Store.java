...
public class Store {
  ...
  static {
    ...
    openapiFields.add("linkedCampaignIds");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("linkedCampaignIds") != null && !jsonObj.get("linkedCampaignIds").isJsonNull() && !jsonObj.get("linkedCampaignIds").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `linkedCampaignIds` to be an array in the JSON string but got `%s`", jsonObj.get("linkedCampaignIds").toString()));
      }
  }
