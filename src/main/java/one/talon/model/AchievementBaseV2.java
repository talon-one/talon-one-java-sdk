...
public class AchievementBaseV2 {
  ...
  public AchievementBaseV2 name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AchievementBaseV2 title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public AchievementBaseV2 description(@javax.annotation.Nullable String description) {
  ...
  public AchievementBaseV2 target(@javax.annotation.Nullable BigDecimal target) {
    this.target = target;
    return this;
  }
  ...
  public AchievementBaseV2 period(@javax.annotation.Nullable String period) {
    this.period = period;
    return this;
  }
  ...
  public AchievementBaseV2 recurrencePolicy(@javax.annotation.Nullable RecurrencePolicyEnum recurrencePolicy) {
  ...
  public AchievementBaseV2 activationPolicy(@javax.annotation.Nullable ActivationPolicyEnum activationPolicy) {
  ...
  public AchievementBaseV2 fixedStartDate(@javax.annotation.Nullable OffsetDateTime fixedStartDate) {
  ...
  public AchievementBaseV2 endDate(@javax.annotation.Nullable OffsetDateTime endDate) {
  ...
  public AchievementBaseV2 allowRollbackAfterCompletion(@javax.annotation.Nullable Boolean allowRollbackAfterCompletion) {
  ...
  public AchievementBaseV2 addSubscribedApplicationsItem(Long subscribedApplicationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    AchievementBaseV2 achievementBaseV2 = (AchievementBaseV2) o;
    return Objects.equals(this.name, achievementBaseV2.name) &&
        Objects.equals(this.title, achievementBaseV2.title) &&
        Objects.equals(this.description, achievementBaseV2.description) &&
        Objects.equals(this.target, achievementBaseV2.target) &&
        Objects.equals(this.period, achievementBaseV2.period) &&
        Objects.equals(this.recurrencePolicy, achievementBaseV2.recurrencePolicy) &&
        Objects.equals(this.activationPolicy, achievementBaseV2.activationPolicy) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to AchievementBaseV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AchievementBaseV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AchievementBaseV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AchievementBaseV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AchievementBaseV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AchievementBaseV2.class));

       return (TypeAdapter<T>) new TypeAdapter<AchievementBaseV2>() {
           @Override
  ...
  /**
   * Create an instance of AchievementBaseV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AchievementBaseV2
   * @throws IOException if the JSON string is invalid with respect to AchievementBaseV2
   */
  public static AchievementBaseV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AchievementBaseV2.class);
  }

  /**
   * Convert an instance of AchievementBaseV2 to an JSON string
   *
   * @return JSON string
   */
