...
public class EffectCallApi {
  ...
  @javax.annotation.Nonnull
  private TriggerWebhookEffectProps props;

  public EffectCallApi() {
  }

  public EffectCallApi experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectCallApi campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectCallApi rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectCallApi ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectCallApi ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectCallApi effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectCallApi triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectCallApi triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectCallApi conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectCallApi evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectCallApi evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectCallApi campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectCallApi campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectCallApi selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectCallApi selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectCallApi adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectCallApi rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectCallApi props(@javax.annotation.Nonnull TriggerWebhookEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public TriggerWebhookEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull TriggerWebhookEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectCallApi instance itself
   */
  public EffectCallApi putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectCallApi effectCallApi = (EffectCallApi) o;
    return Objects.equals(this.experimentId, effectCallApi.experimentId) &&
        Objects.equals(this.campaignId, effectCallApi.campaignId) &&
        Objects.equals(this.rulesetId, effectCallApi.rulesetId) &&
        Objects.equals(this.ruleIndex, effectCallApi.ruleIndex) &&
        Objects.equals(this.ruleName, effectCallApi.ruleName) &&
        Objects.equals(this.effectType, effectCallApi.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectCallApi.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectCallApi.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectCallApi.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectCallApi.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectCallApi.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectCallApi.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectCallApi.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectCallApi.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectCallApi.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectCallApi.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectCallApi.rewardId) &&
        Objects.equals(this.props, effectCallApi.props)&&
        Objects.equals(this.additionalProperties, effectCallApi.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectCallApi
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectCallApi.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectCallApi is not found in the empty JSON string", EffectCallApi.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectCallApi.openapiRequiredFields) {
      ...
      TriggerWebhookEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectCallApi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectCallApi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectCallApi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectCallApi.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectCallApi>() {
           @Override
           public void write(JsonWriter out, EffectCallApi value) throws IOException {
           ...
           @Override
           public EffectCallApi read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectCallApi instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectCallApi given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectCallApi
   * @throws IOException if the JSON string is invalid with respect to EffectCallApi
   */
  public static EffectCallApi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectCallApi.class);
  }

  /**
   * Convert an instance of EffectCallApi to an JSON string
   *
   * @return JSON string
   */
