...
public class ReturnIntegrationRequest {
   ...
   * @return the ReturnIntegrationRequest instance itself
   */
  public ReturnIntegrationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._return, returnIntegrationRequest._return) &&
        ...
        Objects.equals(this.additionalProperties, returnIntegrationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_return, responseContent, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReturnIntegrationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReturnIntegrationRequest is not found in the empty JSON string", ReturnIntegrationRequest.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReturnIntegrationRequest>() {
           ...
           public ReturnIntegrationRequest read(JsonReader in) throws IOException {
             ...
             ReturnIntegrationRequest instance = thisAdapter.fromJsonTree(jsonObj);
