...
public class DeductLoyaltyPointsEffectProps {
   ...
   * @return the DeductLoyaltyPointsEffectProps instance itself
   */
  public DeductLoyaltyPointsEffectProps putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ruleTitle, deductLoyaltyPointsEffectProps.ruleTitle) &&
        ...
        Objects.equals(this.additionalProperties, deductLoyaltyPointsEffectProps.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ruleTitle, programId, subLedgerId, value, transactionUUID, name, cardIdentifier, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeductLoyaltyPointsEffectProps.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeductLoyaltyPointsEffectProps is not found in the empty JSON string", DeductLoyaltyPointsEffectProps.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DeductLoyaltyPointsEffectProps>() {
           ...
           public DeductLoyaltyPointsEffectProps read(JsonReader in) throws IOException {
             ...
             DeductLoyaltyPointsEffectProps instance = thisAdapter.fromJsonTree(jsonObj);
