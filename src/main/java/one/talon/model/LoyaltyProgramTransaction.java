...
public class LoyaltyProgramTransaction {
  ...
  public LoyaltyProgramTransaction validityDuration(@javax.annotation.Nullable String validityDuration) {
   ...
   * @return the LoyaltyProgramTransaction instance itself
   */
  public LoyaltyProgramTransaction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, loyaltyProgramTransaction.id) &&
        ...
        Objects.equals(this.additionalProperties, loyaltyProgramTransaction.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, transactionUUID, programId, campaignId, created, type, amount, name, startDate, expiryDate, customerProfileId, cardIdentifier, subledgerId, customerSessionId, importId, userId, userEmail, rulesetId, ruleName, flags, validityDuration, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "transactionUUID", "programId", "campaignId", "created", "type", "amount", "name", "startDate", "expiryDate", "customerProfileId", "cardIdentifier", "subledgerId", "customerSessionId", "importId", "userId", "userEmail", "rulesetId", "ruleName", "flags", "validityDuration"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltyProgramTransaction>() {
           ...
           public LoyaltyProgramTransaction read(JsonReader in) throws IOException {
             ...
             LoyaltyProgramTransaction instance = thisAdapter.fromJsonTree(jsonObj);
