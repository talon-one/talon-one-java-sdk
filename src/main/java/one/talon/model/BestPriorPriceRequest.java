...
public class BestPriorPriceRequest {
  ...
  static {
    ...
    openapiFields.add("timeframeEndDate");
    openapiFields.add("timeframe");
    openapiFields.add("strictEndDate");
    openapiFields.add("target");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("skus");
    openapiRequiredFields.add("timeframeEndDate");
    openapiRequiredFields.add("timeframe");
    openapiRequiredFields.add("strictEndDate");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BestPriorPriceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BestPriorPriceRequest is not found in the empty JSON string", BestPriorPriceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BestPriorPriceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BestPriorPriceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
