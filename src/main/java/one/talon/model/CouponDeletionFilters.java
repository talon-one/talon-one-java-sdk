...
public class CouponDeletionFilters {
  ...
  static {
    ...
    openapiFields.add("startsAfter");
    openapiFields.add("startsBefore");
    ...
    openapiFields.add("expiresBefore");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CouponDeletionFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CouponDeletionFilters is not found in the empty JSON string", CouponDeletionFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CouponDeletionFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CouponDeletionFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
