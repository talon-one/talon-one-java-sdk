...
public class CouponDeletionFilters {
   ...
   * @return the CouponDeletionFilters instance itself
   */
  public CouponDeletionFilters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdBefore, couponDeletionFilters.createdBefore) &&
        ...
        Objects.equals(this.additionalProperties, couponDeletionFilters.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdBefore, createdAfter, startsAfter, startsBefore, valid, usable, redeemed, recipientIntegrationId, exactMatch, value, batchId, referralId, expiresAfter, expiresBefore, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CouponDeletionFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CouponDeletionFilters is not found in the empty JSON string", CouponDeletionFilters.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("valid") != null && !jsonObj.get("valid").isJsonNull()) && !jsonObj.get("valid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `valid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("valid").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CouponDeletionFilters>() {
           ...
           public CouponDeletionFilters read(JsonReader in) throws IOException {
             ...
             CouponDeletionFilters instance = thisAdapter.fromJsonTree(jsonObj);
