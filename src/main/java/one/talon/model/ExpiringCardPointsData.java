...
public class ExpiringCardPointsData {
   ...
   * @return the ExpiringCardPointsData instance itself
   */
  public ExpiringCardPointsData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.expiryDate, expiringCardPointsData.expiryDate) &&
        ...
        Objects.equals(this.additionalProperties, expiringCardPointsData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(expiryDate, loyaltyProgramID, amountOfExpiringPoints, subledgerID, cardIdentifier, usersPerCardLimit, profiles, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ExpiringCardPointsData>() {
           ...
           public ExpiringCardPointsData read(JsonReader in) throws IOException {
             ...
             ExpiringCardPointsData instance = thisAdapter.fromJsonTree(jsonObj);
