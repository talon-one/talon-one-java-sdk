...
public class BaseLoyaltyProgram {
   ...
   * @return the BaseLoyaltyProgram instance itself
   */
  public BaseLoyaltyProgram putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, baseLoyaltyProgram.title) &&
        ...
        Objects.equals(this.additionalProperties, baseLoyaltyProgram.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, subscribedApplications, defaultValidity, defaultPending, allowSubledger, usersPerCardLimit, sandbox, programJoinPolicy, tiersExpirationPolicy, tierCycleStartDate, tiersExpireIn, tiersDowngradePolicy, cardCodeSettings, returnPolicy, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BaseLoyaltyProgram.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BaseLoyaltyProgram is not found in the empty JSON string", BaseLoyaltyProgram.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BaseLoyaltyProgram>() {
           ...
           public BaseLoyaltyProgram read(JsonReader in) throws IOException {
             ...
             BaseLoyaltyProgram instance = thisAdapter.fromJsonTree(jsonObj);
