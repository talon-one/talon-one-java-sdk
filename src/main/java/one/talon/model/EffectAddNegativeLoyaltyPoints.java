...
public class EffectAddNegativeLoyaltyPoints {
  ...
  public EffectAddNegativeLoyaltyPoints() {
  }

  public EffectAddNegativeLoyaltyPoints experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectAddNegativeLoyaltyPoints campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectAddNegativeLoyaltyPoints rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectAddNegativeLoyaltyPoints ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectAddNegativeLoyaltyPoints ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectAddNegativeLoyaltyPoints effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectAddNegativeLoyaltyPoints triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectAddNegativeLoyaltyPoints triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectAddNegativeLoyaltyPoints conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectAddNegativeLoyaltyPoints evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectAddNegativeLoyaltyPoints evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectAddNegativeLoyaltyPoints campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectAddNegativeLoyaltyPoints campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectAddNegativeLoyaltyPoints selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectAddNegativeLoyaltyPoints selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectAddNegativeLoyaltyPoints adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectAddNegativeLoyaltyPoints rewardId(@javax.annotation.Nullable Long rewardId) {
   ...
   * @return the EffectAddNegativeLoyaltyPoints instance itself
   */
  public EffectAddNegativeLoyaltyPoints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectAddNegativeLoyaltyPoints effectAddNegativeLoyaltyPoints = (EffectAddNegativeLoyaltyPoints) o;
    return Objects.equals(this.experimentId, effectAddNegativeLoyaltyPoints.experimentId) &&
        Objects.equals(this.campaignId, effectAddNegativeLoyaltyPoints.campaignId) &&
        Objects.equals(this.rulesetId, effectAddNegativeLoyaltyPoints.rulesetId) &&
        Objects.equals(this.ruleIndex, effectAddNegativeLoyaltyPoints.ruleIndex) &&
        Objects.equals(this.ruleName, effectAddNegativeLoyaltyPoints.ruleName) &&
        Objects.equals(this.effectType, effectAddNegativeLoyaltyPoints.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectAddNegativeLoyaltyPoints.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectAddNegativeLoyaltyPoints.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectAddNegativeLoyaltyPoints.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectAddNegativeLoyaltyPoints.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectAddNegativeLoyaltyPoints.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectAddNegativeLoyaltyPoints.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectAddNegativeLoyaltyPoints.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectAddNegativeLoyaltyPoints.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectAddNegativeLoyaltyPoints.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectAddNegativeLoyaltyPoints.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectAddNegativeLoyaltyPoints.rewardId)&&
        Objects.equals(this.additionalProperties, effectAddNegativeLoyaltyPoints.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectAddNegativeLoyaltyPoints {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectAddNegativeLoyaltyPoints
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectAddNegativeLoyaltyPoints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectAddNegativeLoyaltyPoints is not found in the empty JSON string", EffectAddNegativeLoyaltyPoints.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectAddNegativeLoyaltyPoints.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectAddNegativeLoyaltyPoints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectAddNegativeLoyaltyPoints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectAddNegativeLoyaltyPoints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectAddNegativeLoyaltyPoints.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectAddNegativeLoyaltyPoints>() {
           @Override
           public void write(JsonWriter out, EffectAddNegativeLoyaltyPoints value) throws IOException {
           ...
           @Override
           public EffectAddNegativeLoyaltyPoints read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectAddNegativeLoyaltyPoints instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectAddNegativeLoyaltyPoints given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectAddNegativeLoyaltyPoints
   * @throws IOException if the JSON string is invalid with respect to EffectAddNegativeLoyaltyPoints
   */
  public static EffectAddNegativeLoyaltyPoints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectAddNegativeLoyaltyPoints.class);
  }

  /**
   * Convert an instance of EffectAddNegativeLoyaltyPoints to an JSON string
   *
   * @return JSON string
   */
