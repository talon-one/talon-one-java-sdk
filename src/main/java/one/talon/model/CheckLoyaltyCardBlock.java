...
public class CheckLoyaltyCardBlock {
   ...
   * @return the CheckLoyaltyCardBlock instance itself
   */
  public CheckLoyaltyCardBlock putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CheckLoyaltyCardBlock checkLoyaltyCardBlock = (CheckLoyaltyCardBlock) o;
    return Objects.equals(this.id, checkLoyaltyCardBlock.id) &&
        Objects.equals(this.type, checkLoyaltyCardBlock.type) &&
        Objects.equals(this.tags, checkLoyaltyCardBlock.tags) &&
        Objects.equals(this.operator, checkLoyaltyCardBlock.operator) &&
        Objects.equals(this.onFailure, checkLoyaltyCardBlock.onFailure)&&
        Objects.equals(this.additionalProperties, checkLoyaltyCardBlock.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, tags, operator, onFailure, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CheckLoyaltyCardBlock
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckLoyaltyCardBlock.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CheckLoyaltyCardBlock is not found in the empty JSON string", CheckLoyaltyCardBlock.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CheckLoyaltyCardBlock.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckLoyaltyCardBlock.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckLoyaltyCardBlock' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckLoyaltyCardBlock> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckLoyaltyCardBlock.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckLoyaltyCardBlock>() {
           @Override
           public void write(JsonWriter out, CheckLoyaltyCardBlock value) throws IOException {
           ...
           @Override
           public CheckLoyaltyCardBlock read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CheckLoyaltyCardBlock instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CheckLoyaltyCardBlock given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CheckLoyaltyCardBlock
   * @throws IOException if the JSON string is invalid with respect to CheckLoyaltyCardBlock
   */
  public static CheckLoyaltyCardBlock fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckLoyaltyCardBlock.class);
  }

  /**
   * Convert an instance of CheckLoyaltyCardBlock to an JSON string
   *
   * @return JSON string
   */
