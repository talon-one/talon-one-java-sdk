...
public class EffectError {
  ...
  @javax.annotation.Nonnull
  private ErrorEffectProps props;

  public EffectError() {
  }

  public EffectError experimentId(@javax.annotation.Nullable Long experimentId) {
  ...
  public EffectError campaignId(@javax.annotation.Nonnull Long campaignId) {
  ...
  public EffectError rulesetId(@javax.annotation.Nonnull Long rulesetId) {
  ...
  public EffectError ruleIndex(@javax.annotation.Nonnull Long ruleIndex) {
  ...
  public EffectError ruleName(@javax.annotation.Nonnull String ruleName) {
  ...
  public EffectError effectType(@javax.annotation.Nonnull EffectTypeEnum effectType) {
  ...
  public EffectError triggeredByCoupon(@javax.annotation.Nullable Long triggeredByCoupon) {
  ...
  public EffectError triggeredForCatalogItem(@javax.annotation.Nullable Long triggeredForCatalogItem) {
  ...
  public EffectError conditionIndex(@javax.annotation.Nullable Long conditionIndex) {
  ...
  public EffectError evaluationGroupID(@javax.annotation.Nullable Long evaluationGroupID) {
  ...
  public EffectError evaluationGroupMode(@javax.annotation.Nullable String evaluationGroupMode) {
  ...
  public EffectError campaignRevisionId(@javax.annotation.Nullable Long campaignRevisionId) {
  ...
  public EffectError campaignRevisionVersionId(@javax.annotation.Nullable Long campaignRevisionVersionId) {
  ...
  public EffectError selectedPriceType(@javax.annotation.Nullable String selectedPriceType) {
  ...
  public EffectError selectedPrice(@javax.annotation.Nullable BigDecimal selectedPrice) {
  ...
  public EffectError adjustmentReferenceId(@javax.annotation.Nullable UUID adjustmentReferenceId) {
  ...
  public EffectError rewardId(@javax.annotation.Nullable Long rewardId) {
  ...
  public EffectError props(@javax.annotation.Nonnull ErrorEffectProps props) {
    this.props = props;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public ErrorEffectProps getProps() {
    return props;
  }

  public void setProps(@javax.annotation.Nonnull ErrorEffectProps props) {
    this.props = props;
  }
   ...
   * @return the EffectError instance itself
   */
  public EffectError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EffectError effectError = (EffectError) o;
    return Objects.equals(this.experimentId, effectError.experimentId) &&
        Objects.equals(this.campaignId, effectError.campaignId) &&
        Objects.equals(this.rulesetId, effectError.rulesetId) &&
        Objects.equals(this.ruleIndex, effectError.ruleIndex) &&
        Objects.equals(this.ruleName, effectError.ruleName) &&
        Objects.equals(this.effectType, effectError.effectType) &&
        Objects.equals(this.triggeredByCoupon, effectError.triggeredByCoupon) &&
        Objects.equals(this.triggeredForCatalogItem, effectError.triggeredForCatalogItem) &&
        Objects.equals(this.conditionIndex, effectError.conditionIndex) &&
        Objects.equals(this.evaluationGroupID, effectError.evaluationGroupID) &&
        Objects.equals(this.evaluationGroupMode, effectError.evaluationGroupMode) &&
        Objects.equals(this.campaignRevisionId, effectError.campaignRevisionId) &&
        Objects.equals(this.campaignRevisionVersionId, effectError.campaignRevisionVersionId) &&
        Objects.equals(this.selectedPriceType, effectError.selectedPriceType) &&
        Objects.equals(this.selectedPrice, effectError.selectedPrice) &&
        Objects.equals(this.adjustmentReferenceId, effectError.adjustmentReferenceId) &&
        Objects.equals(this.rewardId, effectError.rewardId) &&
        Objects.equals(this.props, effectError.props)&&
        Objects.equals(this.additionalProperties, effectError.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EffectError is not found in the empty JSON string", EffectError.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EffectError.openapiRequiredFields) {
      ...
      ErrorEffectProps.validateJsonElement(jsonObj.get("props"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectError.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectError>() {
           @Override
           public void write(JsonWriter out, EffectError value) throws IOException {
           ...
           @Override
           public EffectError read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EffectError instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EffectError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectError
   * @throws IOException if the JSON string is invalid with respect to EffectError
   */
  public static EffectError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectError.class);
  }

  /**
   * Convert an instance of EffectError to an JSON string
   *
   * @return JSON string
   */
