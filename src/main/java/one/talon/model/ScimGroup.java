...
public class ScimGroup {
  ...
  public ScimGroup id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
   ...
   * @return the ScimGroup instance itself
   */
  public ScimGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayName, scimGroup.displayName) &&
        ...
        Objects.equals(this.additionalProperties, scimGroup.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayName, members, id, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("displayName", "members", "id"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ScimGroup>() {
           ...
           public ScimGroup read(JsonReader in) throws IOException {
             ...
             ScimGroup instance = thisAdapter.fromJsonTree(jsonObj);
