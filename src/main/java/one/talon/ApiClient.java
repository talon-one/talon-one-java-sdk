...
import one.talon.auth.Authentication;
...
public class ApiClient {
    ...
    protected String basePath = "https://yourbaseurl.talon.one";
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/26.06.01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://yourbaseurl.talon.one)
    ...
    */
     ...
     * @throws one.talon.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws one.talon.ApiException If fail to serialize the given object
     */
     ...
     * @throws one.talon.ApiException If fail to read file content from response and write to disk
     ...
     * @throws one.talon.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws one.talon.ApiException If the response has an unsuccessful status code or
     ...
     * @throws one.talon.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws one.talon.ApiException If fails to update the parameters
     */
     ...
     * @throws one.talon.ApiException If fail to serialize the request body object into a string
     */
